...
namespace HatTrick.DbEx.Sql.Benchmark.dbExpression.DataService
{
	...
	using _dboDataService = HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService;
	using _secDataService = HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService;
    ...
    public partial class db : MsSqlDbRuntimeSqlDatabase
    {
        ...
        /// <para>
        /// To retrieve a <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboData.AccessAuditLog" />, use a type param of <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboData.AccessAuditLog" />
        /// </para>
        /// <para>
        ...
        /// <para>
        /// To retrieve a list of <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboData.AccessAuditLog" />(s), use a type param of <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboData.AccessAuditLog" />
        /// </para>
        /// <para>
        /// <see href="https://docs.microsoft.com/en-US/sql/t-sql/queries/select-transact-sql">Microsoft docs on SELECT</see>
        /// </para>
        ...
        public partial class sp : MsSqlStoredProcedureExpressionBuilder
        {
            ...
            public partial class dbo
            {
                ...
                /// </param>
                /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
                public static StoredProcedureContinuation SelectPerson_As_Dynamic_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
                    => expressionBuilderFactory.CreateStoredProcedureBuilder(configuration, new SelectPerson_As_Dynamic_With_Input_And_InputOutputStoredProcedure("dbo", schemas.Single(s => s.Identifier == "dbo"), P1, CreditLimit, outputParameters));
                ...
                /// </param>
                /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
                public static StoredProcedureContinuation SelectPerson_As_DynamicList_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
                    => expressionBuilderFactory.CreateStoredProcedureBuilder(configuration, new SelectPerson_As_DynamicList_With_Input_And_InputOutputStoredProcedure("dbo", schemas.Single(s => s.Identifier == "dbo"), P1, CreditLimit, outputParameters));
                ...
                /// </summary>
                /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
                public static StoredProcedureContinuation SelectPersonId_As_ScalarValue_With_Input_And_Default_Value()
                    => expressionBuilderFactory.CreateStoredProcedureBuilder(configuration, new SelectPersonId_As_ScalarValue_With_Input_And_Default_ValueStoredProcedure("dbo", schemas.Single(s => s.Identifier == "dbo")));
                ...
                /// </param>
                /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
                public static StoredProcedureContinuation SelectPersonId_As_ScalarValue_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
                    => expressionBuilderFactory.CreateStoredProcedureBuilder(configuration, new SelectPersonId_As_ScalarValue_With_Input_And_InputOutputStoredProcedure("dbo", schemas.Single(s => s.Identifier == "dbo"), P1, CreditLimit, outputParameters));
                ...
                /// </param>
                /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
                public static StoredProcedureContinuation SelectPersonId_As_ScalarValueList_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
                    => expressionBuilderFactory.CreateStoredProcedureBuilder(configuration, new SelectPersonId_As_ScalarValueList_With_Input_And_InputOutputStoredProcedure("dbo", schemas.Single(s => s.Identifier == "dbo"), P1, CreditLimit, outputParameters));
...
namespace HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService
{
    ...
    public partial class AccessAuditLogEntity : EntityExpression<AccessAuditLog>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.IdField"/> representing the "dbo.AccessAuditLog.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.IdField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.PersonIdField"/> representing the "dbo.AccessAuditLog.PersonId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.PersonIdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.AccessResultField"/> representing the "dbo.AccessAuditLog.AccessResult" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.AccessResultField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.DateCreatedField"/> representing the "dbo.AccessAuditLog.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity.DateCreatedField"/> can be 
    ...
    public partial class AddressEntity : EntityExpression<Address>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.IdField"/> representing the "dbo.Address.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.AddressTypeField"/> representing the "dbo.Address.AddressType" column in the database, 
        /// with a .NET type of <see cref="HatTrick.DbEx.Sql.Benchmark.AddressType"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.AddressTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyEnumElement{HatTrick.DbEx.Sql.Benchmark.AddressType}Element"/> or <see cref="HatTrick.DbEx.Sql.NullableEnumElement{HatTrick.DbEx.Sql.Benchmark.AddressType}Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.Line1Field"/> representing the "dbo.Address.Line1" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.Line1Field"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.Line2Field"/> representing the "dbo.Address.Line2" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.Line2Field"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.CityField"/> representing the "dbo.Address.City" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.CityField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.StateField"/> representing the "dbo.Address.State" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.StateField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.ZipField"/> representing the "dbo.Address.Zip" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.ZipField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.DateCreatedField"/> representing the "dbo.Address.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.DateUpdatedField"/> representing the "dbo.Address.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression()
        {
            return _inclusiveSelectExpressionSet ?? (_inclusiveSelectExpressionSet = new SelectExpressionSet(
                new Int32SelectExpression(Id)
                ,new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.AddressType>(AddressType)
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(AddressType) ? new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.AddressType>(AddressType).As(aliased) as NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.AddressType> : GetInclusiveSelectExpression().Expressions.Single(x => (x.Expression as IExpressionNameProvider).Name == nameof(AddressType));
        ...
        protected override InsertExpressionSet<Address> GetInclusiveInsertExpression(Address address)
        {
            return new InsertExpressionSet<Address>(address 
                ,new InsertExpression<HatTrick.DbEx.Sql.Benchmark.AddressType?>(address.AddressType, AddressType)
        ...
        protected override void HydrateEntity(ISqlFieldReader reader, Address address)
        {
            ...
            address.AddressType = reader.ReadField().GetValue<HatTrick.DbEx.Sql.Benchmark.AddressType?>();
        ...
        public partial class AddressTypeField : NullableEnumFieldExpression<Address, HatTrick.DbEx.Sql.Benchmark.AddressType>
        {
            #region constructors
            ...
            #region as
            public override NullableEnumElement<HatTrick.DbEx.Sql.Benchmark.AddressType> As(string alias)
            {
                return new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.AddressType>(this).As(alias);
            }
            #endregion

            #region set
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.AddressType value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.AddressType>(value, this));
            public AssignmentExpression Set(EnumElement<HatTrick.DbEx.Sql.Benchmark.AddressType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.AddressType? value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.AddressType?>(value, this));
            public AssignmentExpression Set(NullableEnumElement<HatTrick.DbEx.Sql.Benchmark.AddressType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(DBNull value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.AddressType>(value, this));
            #endregion
        }
        #endregion
    ...
    public partial class PersonEntity : EntityExpression<Person>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.IdField"/> representing the "dbo.Person.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.FirstNameField"/> representing the "dbo.Person.FirstName" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.FirstNameField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.LastNameField"/> representing the "dbo.Person.LastName" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.LastNameField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.BirthDateField"/> representing the "dbo.Person.BirthDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.BirthDateField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.GenderTypeField"/> representing the "dbo.Person.GenderType" column in the database, 
        /// with a .NET type of <see cref="HatTrick.DbEx.Sql.Benchmark.GenderType"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.GenderTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyEnumElement{HatTrick.DbEx.Sql.Benchmark.GenderType}Element"/> or <see cref="HatTrick.DbEx.Sql.EnumElement{HatTrick.DbEx.Sql.Benchmark.GenderType}Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.CreditLimitField"/> representing the "dbo.Person.CreditLimit" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.CreditLimitField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.YearOfLastCreditLimitReviewField"/> representing the "dbo.Person.YearOfLastCreditLimitReview" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.YearOfLastCreditLimitReviewField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.NullableInt32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.RegistrationDateField"/> representing the "dbo.Person.RegistrationDate" column in the database, 
        /// with a .NET type of <see cref="DateTimeOffset"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.RegistrationDateField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.LastLoginDateField"/> representing the "dbo.Person.LastLoginDate" column in the database, 
        /// with a .NET type of <see cref="DateTimeOffset"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.LastLoginDateField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.DateCreatedField"/> representing the "dbo.Person.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.DateUpdatedField"/> representing the "dbo.Person.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression()
        {
            return _inclusiveSelectExpressionSet ?? (_inclusiveSelectExpressionSet = new SelectExpressionSet(
                ...
                ,new EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.GenderType>(GenderType)
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(GenderType) ? new EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.GenderType>(GenderType).As(aliased) as EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.GenderType> : GetInclusiveSelectExpression().Expressions.Single(x => (x.Expression as IExpressionNameProvider).Name == nameof(GenderType));
        ...
        protected override InsertExpressionSet<Person> GetInclusiveInsertExpression(Person person)
        {
            return new InsertExpressionSet<Person>(person 
                ...
                ,new InsertExpression<HatTrick.DbEx.Sql.Benchmark.GenderType>(person.GenderType, GenderType)
        ...
        protected override void HydrateEntity(ISqlFieldReader reader, Person person)
        {
            ...
            person.GenderType = reader.ReadField().GetValue<HatTrick.DbEx.Sql.Benchmark.GenderType>();
        ...
        public partial class GenderTypeField : EnumFieldExpression<Person, HatTrick.DbEx.Sql.Benchmark.GenderType>
        {
            #region constructors
            ...
            #region as
            public override EnumElement<HatTrick.DbEx.Sql.Benchmark.GenderType> As(string alias)
            {
                return new EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.GenderType>(this).As(alias);
            }
            #endregion

            #region set
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.GenderType value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.GenderType>(value, this));
            public AssignmentExpression Set(EnumElement<HatTrick.DbEx.Sql.Benchmark.GenderType> value) => new AssignmentExpression(this, value);
            #endregion
        }
        #endregion
    ...
    public partial class PersonAddressEntity : EntityExpression<PersonAddress>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.IdField"/> representing the "dbo.Person_Address.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.PersonIdField"/> representing the "dbo.Person_Address.PersonId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.PersonIdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.AddressIdField"/> representing the "dbo.Person_Address.AddressId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.AddressIdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.DateCreatedField"/> representing the "dbo.Person_Address.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public partial class ProductEntity : EntityExpression<Product>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.IdField"/> representing the "dbo.Product.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ProductCategoryTypeField"/> representing the "dbo.Product.ProductCategoryType" column in the database, 
        /// with a .NET type of <see cref="HatTrick.DbEx.Sql.Benchmark.ProductCategoryType"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ProductCategoryTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyEnumElement{HatTrick.DbEx.Sql.Benchmark.ProductCategoryType}Element"/> or <see cref="HatTrick.DbEx.Sql.NullableEnumElement{HatTrick.DbEx.Sql.Benchmark.ProductCategoryType}Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.NameField"/> representing the "dbo.Product.Name" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.NameField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DescriptionField"/> representing the "dbo.Product.Description" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DescriptionField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ListPriceField"/> representing the "dbo.Product.ListPrice" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ListPriceField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.PriceField"/> representing the "dbo.Product.Price" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.PriceField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDoubleElement"/> or <see cref="HatTrick.DbEx.Sql.DoubleElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.QuantityField"/> representing the "dbo.Product.Quantity" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.QuantityField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ImageField"/> representing the "dbo.Product.Image" column in the database, 
        /// with a .NET type of <see cref="byte"/>[].  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ImageField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.HeightField"/> representing the "dbo.Product.Height" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.HeightField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.WidthField"/> representing the "dbo.Product.Width" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.WidthField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDecimalElement"/> or <see cref="HatTrick.DbEx.Sql.NullableDecimalElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DepthField"/> representing the "dbo.Product.Depth" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DepthField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDecimalElement"/> or <see cref="HatTrick.DbEx.Sql.NullableDecimalElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.WeightField"/> representing the "dbo.Product.Weight" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.WeightField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDecimalElement"/> or <see cref="HatTrick.DbEx.Sql.NullableDecimalElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ShippingWeightField"/> representing the "dbo.Product.ShippingWeight" column in the database, 
        /// with a .NET type of <see cref="decimal"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ShippingWeightField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ValidStartTimeOfDayForPurchaseField"/> representing the "dbo.Product.ValidStartTimeOfDayForPurchase" column in the database, 
        /// with a .NET type of <see cref="TimeSpan"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ValidStartTimeOfDayForPurchaseField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ValidEndTimeOfDayForPurchaseField"/> representing the "dbo.Product.ValidEndTimeOfDayForPurchase" column in the database, 
        /// with a .NET type of <see cref="TimeSpan"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.ValidEndTimeOfDayForPurchaseField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyTimeSpanElement"/> or <see cref="HatTrick.DbEx.Sql.NullableTimeSpanElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DateCreatedField"/> representing the "dbo.Product.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DateUpdatedField"/> representing the "dbo.Product.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression()
        {
            return _inclusiveSelectExpressionSet ?? (_inclusiveSelectExpressionSet = new SelectExpressionSet(
                new Int32SelectExpression(Id)
                ,new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType>(ProductCategoryType)
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(ProductCategoryType) ? new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType>(ProductCategoryType).As(aliased) as NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType> : GetInclusiveSelectExpression().Expressions.Single(x => (x.Expression as IExpressionNameProvider).Name == nameof(ProductCategoryType));
        ...
        protected override InsertExpressionSet<Product> GetInclusiveInsertExpression(Product product)
        {
            return new InsertExpressionSet<Product>(product 
                ,new InsertExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType?>(product.ProductCategoryType, ProductCategoryType)
        ...
        protected override void HydrateEntity(ISqlFieldReader reader, Product product)
        {
            ...
            product.ProductCategoryType = reader.ReadField().GetValue<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType?>();
        ...
        public partial class ProductCategoryTypeField : NullableEnumFieldExpression<Product, HatTrick.DbEx.Sql.Benchmark.ProductCategoryType>
        {
            #region constructors
            ...
            #region as
            public override NullableEnumElement<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType> As(string alias)
            {
                return new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType>(this).As(alias);
            }
            #endregion

            #region set
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.ProductCategoryType value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType>(value, this));
            public AssignmentExpression Set(EnumElement<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.ProductCategoryType? value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType?>(value, this));
            public AssignmentExpression Set(NullableEnumElement<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(DBNull value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.ProductCategoryType>(value, this));
            #endregion
        }
        #endregion
    ...
    public partial class PurchaseEntity : EntityExpression<Purchase>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.IdField"/> representing the "dbo.Purchase.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PersonIdField"/> representing the "dbo.Purchase.PersonId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PersonIdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.OrderNumberField"/> representing the "dbo.Purchase.OrderNumber" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.OrderNumberField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.TotalPurchaseQuantityField"/> representing the "dbo.Purchase.TotalPurchaseQuantity" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.TotalPurchaseQuantityField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.TotalPurchaseAmountField"/> representing the "dbo.Purchase.TotalPurchaseAmount" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.TotalPurchaseAmountField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDoubleElement"/> or <see cref="HatTrick.DbEx.Sql.DoubleElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PurchaseDateField"/> representing the "dbo.Purchase.PurchaseDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PurchaseDateField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.ShipDateField"/> representing the "dbo.Purchase.ShipDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.ShipDateField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.NullableDateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.ExpectedDeliveryDateField"/> representing the "dbo.Purchase.ExpectedDeliveryDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.ExpectedDeliveryDateField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.NullableDateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.TrackingIdentifierField"/> representing the "dbo.Purchase.TrackingIdentifier" column in the database, 
        /// with a .NET type of <see cref="Guid"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.TrackingIdentifierField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PaymentMethodTypeField"/> representing the "dbo.Purchase.PaymentMethodType" column in the database, 
        /// with a .NET type of <see cref="HatTrick.DbEx.Sql.Benchmark.PaymentMethodType"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PaymentMethodTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyEnumElement{HatTrick.DbEx.Sql.Benchmark.PaymentMethodType}Element"/> or <see cref="HatTrick.DbEx.Sql.EnumElement{HatTrick.DbEx.Sql.Benchmark.PaymentMethodType}Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PaymentSourceTypeField"/> representing the "dbo.Purchase.PaymentSourceType" column in the database, 
        /// with a .NET type of <see cref="HatTrick.DbEx.Sql.Benchmark.PaymentSourceType"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.PaymentSourceTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyEnumElement{HatTrick.DbEx.Sql.Benchmark.PaymentSourceType}Element"/> or <see cref="HatTrick.DbEx.Sql.NullableEnumElement{HatTrick.DbEx.Sql.Benchmark.PaymentSourceType}Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.DateCreatedField"/> representing the "dbo.Purchase.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.DateUpdatedField"/> representing the "dbo.Purchase.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression()
        {
            return _inclusiveSelectExpressionSet ?? (_inclusiveSelectExpressionSet = new SelectExpressionSet(
                ...
                ,new EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>(PaymentMethodType)
                ,new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType>(PaymentSourceType)
                ,new DateTimeSelectExpression(DateCreated)
                ,new DateTimeSelectExpression(DateUpdated)
            ));
        }
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(PaymentMethodType) ? new EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>(PaymentMethodType).As(aliased) as EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType> : GetInclusiveSelectExpression().Expressions.Single(x => (x.Expression as IExpressionNameProvider).Name == nameof(PaymentMethodType));

            aliased = alias(nameof(PaymentSourceType));
            set &= aliased != nameof(PaymentSourceType) ? new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType>(PaymentSourceType).As(aliased) as NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType> : GetInclusiveSelectExpression().Expressions.Single(x => (x.Expression as IExpressionNameProvider).Name == nameof(PaymentSourceType));
        ...
        protected override InsertExpressionSet<Purchase> GetInclusiveInsertExpression(Purchase purchase)
        {
            return new InsertExpressionSet<Purchase>(purchase 
                ...
                ,new InsertExpression<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>(purchase.PaymentMethodType, PaymentMethodType)
                ,new InsertExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType?>(purchase.PaymentSourceType, PaymentSourceType)
            );
        }
        ...
        protected override void HydrateEntity(ISqlFieldReader reader, Purchase purchase)
        {
            ...
            purchase.PaymentMethodType = reader.ReadField().GetValue<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>();
            purchase.PaymentSourceType = reader.ReadField().GetValue<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType?>();
        ...
        public partial class PaymentMethodTypeField : EnumFieldExpression<Purchase, HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>
        {
            #region constructors
            ...
            #region as
            public override EnumElement<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType> As(string alias)
            {
                return new EnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>(this).As(alias);
            }
            #endregion

            #region set
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.PaymentMethodType value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType>(value, this));
            public AssignmentExpression Set(EnumElement<HatTrick.DbEx.Sql.Benchmark.PaymentMethodType> value) => new AssignmentExpression(this, value);
            #endregion
        }
        #endregion

        #region payment source type field expression
        public partial class PaymentSourceTypeField : NullableEnumFieldExpression<Purchase, HatTrick.DbEx.Sql.Benchmark.PaymentSourceType>
        {
            #region constructors
            ...
            #region as
            public override NullableEnumElement<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType> As(string alias)
            {
                return new NullableEnumSelectExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType>(this).As(alias);
            }
            #endregion

            #region set
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.PaymentSourceType value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType>(value, this));
            public AssignmentExpression Set(EnumElement<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(HatTrick.DbEx.Sql.Benchmark.PaymentSourceType? value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType?>(value, this));
            public AssignmentExpression Set(NullableEnumElement<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(DBNull value) => new AssignmentExpression(this, new LiteralExpression<HatTrick.DbEx.Sql.Benchmark.PaymentSourceType>(value, this));
            #endregion
        }
        #endregion
    ...
    public partial class PurchaseLineEntity : EntityExpression<PurchaseLine>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.IdField"/> representing the "dbo.PurchaseLine.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.PurchaseIdField"/> representing the "dbo.PurchaseLine.PurchaseId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.PurchaseIdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.ProductIdField"/> representing the "dbo.PurchaseLine.ProductId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.ProductIdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.PurchasePriceField"/> representing the "dbo.PurchaseLine.PurchasePrice" column in the database, 
        /// with a .NET type of <see cref="decimal"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.PurchasePriceField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDecimalElement"/> or <see cref="HatTrick.DbEx.Sql.DecimalElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.QuantityField"/> representing the "dbo.PurchaseLine.Quantity" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.QuantityField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.DateCreatedField"/> representing the "dbo.PurchaseLine.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.DateUpdatedField"/> representing the "dbo.PurchaseLine.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public partial class PersonTotalPurchasesViewEntity : EntityExpression<PersonTotalPurchasesView>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity.IdField"/> representing the "dbo.PersonTotalPurchasesView.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity.TotalAmountField"/> representing the "dbo.PersonTotalPurchasesView.TotalAmount" column in the database, 
        /// with a .NET type of <see cref="double"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity.TotalAmountField"/> can be 
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity.TotalCountField"/> representing the "dbo.PersonTotalPurchasesView.TotalCount" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity.TotalCountField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.NullableInt32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
...
#pragma warning restore CA1052 // Static holder types should be Static or NotInheritable
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AccessAuditLogEntity"/> representing the "dbo.AccessAuditLog" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.AddressEntity"/> representing the "dbo.Address" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonEntity"/> representing the "dbo.Person" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonAddressEntity"/> representing the "dbo.Person_Address" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.ProductEntity"/> representing the "dbo.Product" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseEntity"/> representing the "dbo.Purchase" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PurchaseLineEntity"/> representing the "dbo.PurchaseLine" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.dboDataService.PersonTotalPurchasesViewEntity"/> representing the "dbo.PersonTotalPurchasesView" view in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
...
{
	using HatTrick.DbEx.Sql.Benchmark.dbExpression.secData;
	using System.Data;
    ...
    public partial class PersonEntity : EntityExpression<Person>
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.IdField"/> representing the "sec.Person.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyInt32Element"/> or <see cref="HatTrick.DbEx.Sql.Int32Element"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.SocialSecurityNumberField"/> representing the "sec.Person.SSN" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.SocialSecurityNumberField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyStringElement"/> or <see cref="HatTrick.DbEx.Sql.StringElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.DateCreatedField"/> representing the "sec.Person.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.DateUpdatedField"/> representing the "sec.Person.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyDateTimeElement"/> or <see cref="HatTrick.DbEx.Sql.DateTimeElement"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
...
#pragma warning restore CA1052 // Static holder types should be Static or NotInheritable
    {
        ...
        #region interface
        /// <summary>A <see cref="HatTrick.DbEx.Sql.Benchmark.dbExpression.secDataService.PersonEntity"/> representing the "sec.Person" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>Person</description>
