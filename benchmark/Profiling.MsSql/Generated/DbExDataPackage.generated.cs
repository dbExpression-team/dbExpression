...
namespace Profiling.MsSql.dboData
{
    ...
    public partial class Address : IDbEntity
    {
        #region interface
        public virtual int Id { get; set; }
        public virtual Profiling.MsSql.AddressType? AddressType { get; set; }
    ...
    public partial class Product : IDbEntity
    {
        #region interface
        public virtual int Id { get; set; }
        public virtual Profiling.MsSql.ProductCategoryType? ProductCategoryType { get; set; }
    ...
    public partial class Purchase : IDbEntity
    {
        ...
        public virtual Profiling.MsSql.PaymentSourceType? PaymentSourceType { get; set; }
        public virtual DateTime DateCreated { get; set; }
        public virtual DateTime DateUpdated { get; set; }
        #endregion
