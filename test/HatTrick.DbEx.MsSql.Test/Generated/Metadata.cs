namespace DbEx.DataService
{
    ...
    public class MsSqlDbExTest : RuntimeEnvironmentSqlDatabase
    {
        public MsSqlDbExTest() : base(new db(), new SqlDatabaseMetadataProvider(new MsSqlDbExTestSqlDatabaseMetadata("MsSqlDbExTest", "MsSqlDbExTest"))) 
        { 
    ...
    public class MsSqlDbExTestSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        public MsSqlDbExTestSqlDatabaseMetadata(string identifier, string name)
        {
            Identifier = identifier;
            Name = name;
            Schemas.Add("dbo", new dboSchemaMetadata(this, $"{identifier}.dbo", "dbo"));
            Schemas.Add("sec", new secSchemaMetadata(this, $"{identifier}.sec", "sec"));
        }
        #endregion
    }
}
