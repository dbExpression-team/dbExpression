...
{
    public class v2016MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2016MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2016MsSqlDb"));
        ...
        public v2016MsSqlDbSqlDatabaseMetadata(string name)
        {
