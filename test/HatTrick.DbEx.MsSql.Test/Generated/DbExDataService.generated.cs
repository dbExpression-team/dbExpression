    ...
    public abstract partial class MsSqlDbRuntimeSqlDatabase : IRuntimeSqlDatabase, IExpressionListProvider<SchemaExpression>
    {
        ...
        public partial class sp : MsSqlStoredProcedureExpressionBuilder
        {
            ...
            public partial class dbo
            {
                ...
                /// </summary>
                /// <param name="foo">The value to use for creating the database parameter @P1.
                /// <para>Database Properties:
                /// <list type="table">
                /// <item>
                /// <term>name</term><description>@P1</description>
                ...
                /// </para>
                /// </param>
                /// <param name="bar">The value to use for creating the database parameter @P2.
                /// <para>Database Properties:
                /// <list type="table">
                /// <item>
                /// <term>name</term><description>@P2</description>
                ...
                /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
                public static StoredProcedureContinuation UpdatePersonCreditLimitWithOutputParametersAndReturnPerson(int? foo,int? bar, Action<ISqlOutputParameterList> outputParameters)
                    => expressionBuilderFactory.CreateStoredProcedureBuilder(configuration, new UpdatePersonCreditLimitWithOutputParametersAndReturnPersonStoredProcedure("dbo", schemas.Single(s => s.Identifier == "dbo"), foo, bar, outputParameters));
    ...
    public partial class UpdatePersonCreditLimitWithOutputParametersAndReturnPersonStoredProcedure : StoredProcedureExpression
    {
        public UpdatePersonCreditLimitWithOutputParametersAndReturnPersonStoredProcedure(
            ...
            ,Action<ISqlOutputParameterList> outputParameters
                ...
                ,new List<ParameterExpression> 
                { 
                    new ParameterExpression<int?>($"{identifier}.UpdatePersonCreditLimitWithOutputParametersAndReturnPerson.@P1", "foo", foo, ParameterDirection.Input)
                    ,new ParameterExpression<int?>($"{identifier}.UpdatePersonCreditLimitWithOutputParametersAndReturnPerson.@P2", "bar", bar, ParameterDirection.Input)
