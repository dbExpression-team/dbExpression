...
namespace DataService.EntityExpression.dbo
{
    ...
    public partial class AddressEntity : EntityExpression<Address>
    {
		...
		public NullableEnumFieldExpression<Address, AddressType> AddressType { get { return Fields[_addressTypeFieldName].Value as NullableEnumFieldExpression<Address, AddressType>; } }
    ...
    public partial class PersonEntity : EntityExpression<Person>
    {
		...
		public NullableInt32FieldExpression<Person> YearOfLastCreditLimitReview { get { return Fields[_yearOfLastCreditLimitReviewFieldName].Value as NullableInt32FieldExpression<Person>; } }
        ...
        private PersonEntity(SchemaExpression schema, ISqlEntityMetadata metadata, string alias) : base(schema, metadata, alias)
        {
			...
			Fields.Add(_creditLimitFieldName, new Lazy<FieldExpression>(() => new NullableInt32FieldExpression<Person>(this, metadata.Fields[_creditLimitFieldName] ?? throw new DbExpressionConfigurationException($"Configuration for entity '{metadata.Name}' does not contain field metadata for '{_creditLimitFieldName}'"), x => x.CreditLimit)));
			Fields.Add(_yearOfLastCreditLimitReviewFieldName, new Lazy<FieldExpression>(() => new NullableInt32FieldExpression<Person>(this, metadata.Fields[_yearOfLastCreditLimitReviewFieldName] ?? throw new DbExpressionConfigurationException($"Configuration for entity '{metadata.Name}' does not contain field metadata for '{_yearOfLastCreditLimitReviewFieldName}'"), x => x.YearOfLastCreditLimitReview)));
        ...
        protected override void HydrateEntity(Person person, ISqlFieldReader reader, IValueMapper mapper)
        {
			...
			person.CreditLimit = mapper.Map<int?>(CreditLimit, reader.ReadField());
			person.YearOfLastCreditLimitReview = mapper.Map<int?>(YearOfLastCreditLimitReview, reader.ReadField());
    ...
    public partial class PurchaseEntity : EntityExpression<Purchase>
    {
        ...
        private PurchaseEntity(SchemaExpression schema, ISqlEntityMetadata metadata, string alias) : base(schema, metadata, alias)
        {
			...
			Fields.Add(_expectedDeliveryDateFieldName, new Lazy<FieldExpression>(() => new NullableDateTimeFieldExpression<Purchase>(this, metadata.Fields[_expectedDeliveryDateFieldName] ?? throw new DbExpressionConfigurationException($"Configuration for entity '{metadata.Name}' does not contain field metadata for '{_expectedDeliveryDateFieldName}'"), x => x.ExpectedDeliveryDate)));
			Fields.Add(_trackingIdentifierFieldName, new Lazy<FieldExpression>(() => new NullableGuidFieldExpression<Purchase>(this, metadata.Fields[_trackingIdentifierFieldName] ?? throw new DbExpressionConfigurationException($"Configuration for entity '{metadata.Name}' does not contain field metadata for '{_trackingIdentifierFieldName}'"), x => x.TrackingIdentifier)));
...
namespace DataService.EntityExpression.sec
{
    ...
    public partial class PersonEntity : EntityExpression<Person>
    {
        ...
        {
			person.Id = mapper.Map<int>(Id, reader.ReadField());
			person.SSN = mapper.Map<string>(SSN, reader.ReadField());
			person.DateCreated = mapper.Map<DateTime>(DateCreated, reader.ReadField());
			person.DateUpdated = mapper.Map<DateTime>(DateUpdated, reader.ReadField());
        }
		#endregion
