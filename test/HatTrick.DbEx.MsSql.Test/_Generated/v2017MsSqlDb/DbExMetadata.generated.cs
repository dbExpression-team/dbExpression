...
{
    public class v2017MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2017MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2017MsSqlDb"));
        ...
        public v2017MsSqlDbSqlDatabaseMetadata(string name)
        {
