...
{
    public class v2008MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2008MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2008MsSqlDb"));
        ...
        public v2008MsSqlDbSqlDatabaseMetadata(string name)
        {
