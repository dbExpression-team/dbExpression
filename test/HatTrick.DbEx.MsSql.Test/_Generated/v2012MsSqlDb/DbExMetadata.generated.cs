...
{
    public class v2012MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2012MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2012MsSqlDb"));
        ...
        public v2012MsSqlDbSqlDatabaseMetadata(string name)
        {
