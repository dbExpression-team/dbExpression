...
{
    public class SelectExpressionBuilderTests : ExpressionBuilderTests
    {
        [Fact]
        public void Does_select_for_single_field_result_in_valid_expression()
        {
            //given

            //when
            var exp = db.Select(sec.Person.Id)
               .From(sec.Person);
