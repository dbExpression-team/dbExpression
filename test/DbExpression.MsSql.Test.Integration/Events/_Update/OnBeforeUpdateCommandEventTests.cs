...
namespace DbExpression.MsSql.Test.Integration.Events
{
    public class OnBeforeUpdateCommandEventTests : ResetDatabaseNotRequired
    {
        ...
        public Task Does_before_update_command_event_fire_when_async_action_configured_with_sync_execute_while_selecting_entity()
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(async _ => { actionExecuted = true; await Task.CompletedTask; }));
        ...
        public Task Does_before_update_command_event_fire_when_async_action_and_passing_predicate_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            bool actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(async _ => { actionExecuted = true; await Task.CompletedTask; }, p => true));
        ...
        public Task Does_before_update_command_event_not_fire_when_async_action_and_failing_predicate_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            bool actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(async _ => { actionExecuted = true; await Task.CompletedTask; }, p => false));
