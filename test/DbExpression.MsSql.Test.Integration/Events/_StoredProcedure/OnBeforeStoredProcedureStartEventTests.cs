...
namespace DbExpression.MsSql.Test.Integration.Events
{
    public class OnBeforeStoredProcedureStartEventTests : ResetDatabaseNotRequired
    {
        ...
        public void Does_before_stored_procedure_start_event_fire_when_sync_action_configured_with_sync_execute_while_stored_procedureing_entity()
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeStoredProcedureStart(_ => actionExecuted = true));
        ...
        public void Does_before_stored_procedure_start_event_fire_expected_number_of_times_when_sync_action_configured_with_sync_execute_while_stored_procedureing_entity(int expected)
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeStoredProcedureStart(_ => actionExecutedCount++));
        ...
        public void Does_before_stored_procedure_start_event_fire_when_sync_action_and_passing_predicate_configured_with_sync_execute_while_stored_procedureing_entity()
        {
            //given
            var actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeStoredProcedureStart(_ => actionExecuted = true, p => true));
        ...
        [Fact]
        public void Does_before_stored_procedure_start_event_not_fire_when_sync_action_and_failing_predicate_configured_with_sync_execute_while_stored_procedureing_entity()
        {
            //given
            var actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeStoredProcedureStart(_ => actionExecuted = true, p => false));
        ...
        [Fact]
        public void Does_before_stored_procedure_start_event_throw_exception_when_fired_with_sync_action_configured_with_sync_execute_while_stored_procedureing_entity()
        {
            //given
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeStoredProcedureStart(_ => throw new NotImplementedException()));
        ...
        [Fact]
        public void Does_before_stored_procedure_start_event_throw_exception_when_fired_with_sync_action_and_predicate_throwing_exception_configured_with_sync_execute_while_stored_procedureing_entity()
        {
            //given
            bool actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeStoredProcedureStart(_ => actionExecuted = true, _ => throw new NotImplementedException()));
