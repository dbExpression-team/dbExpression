...
namespace DbExpression.MsSql.Test.Integration
{
    ...
    public partial class DatePartAndMaximumTests : ResetDatabaseNotRequired
    {
        [Theory]
        [InlineData(2019)]
        public void Does_selecting_maximum_of_year_datepart_of_purchase_date_succeed(int expected)
        {
            //given
        ...
        [Theory]
        [InlineData(2019)]
        public void Does_selecting_maximum_of_year_datepart_of_ship_date_succeed(int expected)
        {
            //given
            var (db, serviceProvider) = Configure<v2019MsSqlDb>();
