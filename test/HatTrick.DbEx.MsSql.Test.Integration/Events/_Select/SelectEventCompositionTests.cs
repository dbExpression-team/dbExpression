...
namespace HatTrick.DbEx.MsSql.Test.Integration.Events
{
    public class SelectEventCompositionTests : ResetDatabaseNotRequired
    {
        ...
        public void Do_all_pipeline_events_fire_when_selecting(int version, int expected = 10)
        {
            //given
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public void Do_all_pipeline_events_fire_when_selecting_and_event_confiugurations_are_repeated(int version, int expected = 20)
        {
            //given
            var executionCount = 0;
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version,
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public void Do_all_pipeline_events_fire_in_order_when_selecting(int version, string expected = "9876543210")
        {
            //given
            var execution = "";
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version,
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public void Do_all_pipeline_events_fire_when_selecting_and_predicate_is_met(int version, int expected = 10)
        {
            //given
            var executionCount = 0;
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version,
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Do_all_pipeline_events_fire_when_selecting_async(int version, int expected = 10)
        {
            //given
            var executionCount = 0;
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version,
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Do_all_pipeline_events_fire_when_selecting_async_and_event_configurations_are_repeated(int version, int expected = 20)
        {
            //given
            var executionCount = 0;
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version,
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Do_all_pipeline_events_fire_in_order_when_selecting_async(int version, string expected = "9876543210")
        {
            //given
            var execution = "";
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version,
