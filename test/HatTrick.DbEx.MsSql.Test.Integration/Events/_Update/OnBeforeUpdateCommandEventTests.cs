...
namespace HatTrick.DbEx.MsSql.Test.Integration.Events
{
    public class OnBeforeUpdateCommandEventTests : ResetDatabaseNotRequired
    {
        ...
        public void Does_before_update_command_event_fire_when_sync_action_configured_with_sync_execute_while_selecting_entity()
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => actionExecuted = true));
        ...
        public void Does_before_update_command_event_fire_expected_number_of_times_when_sync_action_configured_with_sync_execute_while_selecting_entity(int expected)
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => actionExecutedCount++));
        ...
        public void Does_before_update_command_event_fire_when_sync_action_and_passing_predicate_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            var actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => actionExecuted = true, p => true));
        ...
        public void Does_before_update_command_event_not_fire_when_sync_action_and_failing_predicate_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            var actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => actionExecuted = true, p => false));
        ...
        public Task Does_before_update_command_event_fire_when_async_action_configured_with_sync_execute_while_selecting_entity()
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(async _ => { actionExecuted = true; await Task.Delay(1); }));
        ...
        public Task Does_before_update_command_event_fire_when_async_action_and_passing_predicate_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            bool actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(async _ => { actionExecuted = true; await Task.Delay(1); }, p => true));
        ...
        public Task Does_before_update_command_event_not_fire_when_async_action_and_failing_predicate_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            bool actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(async _ => { actionExecuted = true; await Task.Delay(1); }, p => false));
        ...
        [Fact]
        public void Does_before_update_command_event_throw_exception_when_fired_with_sync_action_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => throw new NotImplementedException()));
        ...
        [Fact]
        public void Does_before_update_command_event_throw_exception_when_fired_with_sync_action_and_predicate_throwing_exception_configured_with_sync_execute_while_selecting_entity()
        {
            //given
            bool actionExecuted = false;
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => actionExecuted = true, _ => throw new NotImplementedException()));
        ...
        public async Task Can_before_update_command_event_fired_with_cancellation_of_token_source_with_async_execute_cancel_successfully()
        {
            ...
            var (db, serviceProvider) = Configure<v2019MsSqlDb>(configure => configure.Events.OnBeforeUpdateCommand(_ => source.Cancel()));
