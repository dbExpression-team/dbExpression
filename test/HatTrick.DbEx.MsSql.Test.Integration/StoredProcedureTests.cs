...
namespace HatTrick.DbEx.MsSql.Test.Integration
{
    ...
    public partial class StoredProcedureTests : ExecutorTestBase
    {
        ...
        public void Can_execute_stored_procedure_with_input_parameter_and_command_timeout_and_return_list_of_person(int version, int id = 0, int expectedCommandTimeout = 45, int expected = 50)
        {
            ...
            var (db, serviceProvider) = ConfigureForMsSqlVersion<MsSqlDb>(version, c => c.Events.OnAfterSqlStatementExecution(context => commandTimeout = context.DbCommand.CommandTimeout));
