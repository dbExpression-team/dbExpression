...
{
    public class ValueConvertersTests : ExecutorTestBase
    {
        [Theory]
        ...
        public void Can_insert_using_nullable_enum_converter(int version, PaymentSourceType expected = PaymentSourceType.Web)
        {
            ...
            var (db, serviceProvider) = ConfigureForMsSqlVersion<MsSqlDb>(version, database => database.Conversions.ForTypes(x =>
