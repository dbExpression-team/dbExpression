...
namespace HatTrick.DbEx.MsSql.Test.Integration
{
    ...
    public partial class DatePartAndMaximumTests : ResetDatabaseNotRequired
    {
        ...
        public void Does_selecting_maximum_of_year_datepart_of_purchase_date_succeed(int version, int expected = 2019)
        {
            //given
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public void Does_selecting_maximum_of_year_datepart_of_ship_date_succeed(int version, int expected = 2019)
        {
            //given
            var (db, serviceProvider) = Configure<MsSqlDb>().ForMsSqlVersion(version);
