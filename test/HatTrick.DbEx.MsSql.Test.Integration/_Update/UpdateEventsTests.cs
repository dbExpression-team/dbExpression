...
namespace HatTrick.DbEx.MsSql.Test.Integration
{
    ...
    public partial class UpdateEventsTests : ExecutorTestBase
    {
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Person.FirstName, expected)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Product.Name, expected)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(nameof(dbo.Person.BirthDate), dbex.Null, true)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(nameof(dbo.Person.BirthDate), dbex.Null)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Person.GenderType, expected, true)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Person.GenderType, GenderType.Male)));
        ...
        public async Task Can_set_nullable_enum_field_value_to_an_enum_before_update_assembly_event_when_override_is_true(int version) //this causes exception prior to test run: ", AddressType? expected = AddressType.Mailing)"
        {
            ...
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Address.AddressType, expected, true)));
        ...
        public async Task Can_set_nullable_enum_field_value_to_an_enum_before_update_assembly_event_when_override_is_false_have_no_affect(int version) //this causes exception prior to test run: ", AddressType? expected = AddressType.Mailing)"
        {
            ...
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Address.AddressType, AddressType.Billing)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Address.AddressType, dbex.Null, true)));
        ...
        {
            //given
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(dbo.Address.AddressType, dbex.Null)));
        ...
        public async Task Can_set_field_value_by_name_for_a_field_that_is_design_time_configured_to_not_allow_update(int version)
        {
            ...
            var (db, serviceProvider) = ConfigureForMsSqlVersion(version, configure => configure.Events.OnBeforeUpdateSqlStatementAssembly(context => context.SetFieldValue(nameof(dbo.Person.DateCreated), expected)));
