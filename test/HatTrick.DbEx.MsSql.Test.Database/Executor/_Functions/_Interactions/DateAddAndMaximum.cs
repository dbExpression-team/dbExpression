...
namespace HatTrick.DbEx.MsSql.Test.Database.Executor
{
    ...
    public partial class DateAddAndMaximum : ExecutorTestBase
    {
        ...
        public void Does_selecting_maximum_of_dateadd_of_purchase_date_succeed(int version, int expected = 2018)
        {
            //given
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public void Does_selecting_maximum_of_dateadd_of_ship_date_succeed(int version, int expected = 2018)
        {
            //given
            ConfigureForMsSqlVersion(version);
