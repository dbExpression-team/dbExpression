...
namespace HatTrick.DbEx.MsSql.Test.Database.Executor
{
    ...
    public partial class SelectMany
    {
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Can_an_overriden_property_type_return_the_correct_data_type_when_selecting_values(int version, int expectedCount = 9)
        {
            //given
            ConfigureForMsSqlVersion(version);
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Can_an_overriden_property_type_and_aliased_return_the_correct_data_type_when_selecting_values(int version, int expectedCount = 9)
        {
            //given
            ConfigureForMsSqlVersion(version);
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Can_select_dynamic_list_of_an_overriden_property_type_return_the_correct_data_type_when_selecting_values(int version, int expectedCount = 9)
        {
            //given
            ConfigureForMsSqlVersion(version);
        ...
        [Theory]
        [MsSqlVersions.AllVersions]
        public async Task Can_select_dynamic_list_of_an_overriden_property_type_and_aliased_return_the_correct_data_type_when_selecting_values(int version, int expectedCount = 9)
        {
            //given
            ConfigureForMsSqlVersion(version);
