...
{
    public class v2019MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2019MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2019MsSqlDb"));
        ...
        public v2019MsSqlDbSqlDatabaseMetadata(string name)
        {
