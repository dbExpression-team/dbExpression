...
{
    public class v2022MsSqlDb_staticSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2022MsSqlDb_staticSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2022MsSqlDb_static"));
        ...
        public v2022MsSqlDb_staticSqlDatabaseMetadata(string name)
        {
