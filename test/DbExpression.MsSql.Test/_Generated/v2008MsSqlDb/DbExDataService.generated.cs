...
using DbExpression.MsSql.Builder.v2008;
...
namespace v2008DbEx.DataService
{
	using v2008DbEx.dboDataService;
	using v2008DbEx.secDataService;
	using v2008DbEx.unit_testDataService;
	using _dboDataService = v2008DbEx.dboDataService;
	using _secDataService = v2008DbEx.secDataService;
	using _unit_testDataService = v2008DbEx.unit_testDataService;
...
#pragma warning disable CS8981 // The type name only contains lower-cased ascii characters
    ...
    {
        #region internals
        private static v2008MsSqlDb? _v2008mssqldb;
        #endregion

        #region interface
        public static MsSqlFunctionExpressionBuilder fx => Getv2008MsSqlDb().fx;
        public static v2008MsSqlDb.v2008MsSqlDbStoredProcedures sp => Getv2008MsSqlDb().sp;
        #endregion

        #region methods
        internal static void UseDatabase(v2008MsSqlDb v2008mssqldb)
            => _v2008mssqldb = v2008mssqldb ?? throw new ArgumentNullException(nameof(v2008mssqldb));
        
        internal static void DiscardDatabase()
            => _v2008mssqldb = null;

        private static v2008MsSqlDb Getv2008MsSqlDb()
            =>  _v2008mssqldb ?? DbExpressionConfigurationException.ThrowServiceResolutionWithReturn<v2008MsSqlDb>();        
        
        #region select one
        /// <summary>
        /// Start constructing a sql SELECT query expression for a single entity.
        /// <para>
        /// To retrieve a <see cref="v2008DbEx.dboData.AccessAuditLog" />, use a type param of <see cref="v2008DbEx.dboData.AccessAuditLog" />
        /// </para>
        /// <para>
        /// <see href="https://dbexpression.com/docs/core-concepts/basics/select-statement">read the docs on SELECT</see>
        /// </para>
        /// </summary>
        /// <returns><see cref="SelectEntity{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        public static SelectEntity<v2008MsSqlDb, TEntity> SelectOne<TEntity>()
            where TEntity : class, IDbEntity, new()
            => Getv2008MsSqlDb().SelectOne<TEntity>();
        ...
        /// </param>
        /// <returns><see cref="Sql.SelectValue{v2008MsSqlDb, TEnum}"/>, a fluent builder for constructing a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        /// <typeparam name="TEnum">The type of the Enum to select.</typeparam>
        public static SelectValue<v2008MsSqlDb, TEnum> SelectOne<TEnum>(AnyElement<TEnum> element)
            where TEnum : struct, Enum, IComparable
            => Getv2008MsSqlDb().SelectOne<TEnum>(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TEnum}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="TEnum">The type of the Enum to select.</typeparam>
        public static SelectValue<v2008MsSqlDb, TEnum?> SelectOne<TEnum>(AnyElement<TEnum?> element)
            where TEnum : struct, Enum, IComparable
            => Getv2008MsSqlDb().SelectOne<TEnum>(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, object}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, object?> SelectOne(ObjectElement element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, object?> SelectOne(NullableObjectElement element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        public static SelectObject<v2008MsSqlDb, T> SelectOne<T>(ObjectElement<T> element)
            where T : class?
            => Getv2008MsSqlDb().SelectOne<T>(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the value to select.</typeparam>
        public static SelectValue<v2008MsSqlDb, T> SelectOne<T>(AliasedElement<T> element)
            => Getv2008MsSqlDb().SelectOne<T>(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Boolean}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, bool> SelectOne(AnyElement<bool> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Byte}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, byte> SelectOne(AnyElement<byte> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Byte[]}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, byte[]> SelectOne(ByteArrayElement element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Byte[]}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, byte[]?> SelectOne(NullableByteArrayElement element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, DateTime}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, DateTime> SelectOne(AnyElement<DateTime> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, DateTime}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, DateTime?> SelectOne(AnyElement<DateTime?> field)
            => Getv2008MsSqlDb().SelectOne(field);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, DateTimeOffset}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, DateTimeOffset> SelectOne(AnyElement<DateTimeOffset> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Decimal}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, decimal> SelectOne(AnyElement<decimal> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Double}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, double> SelectOne(AnyElement<double> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Guid}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, Guid> SelectOne(AnyElement<Guid> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Int16}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, short> SelectOne(AnyElement<short> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Int32}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, int> SelectOne(AnyElement<int> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Int64}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, long> SelectOne(AnyElement<long> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, Single}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, float> SelectOne(AnyElement<float> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, String}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, string> SelectOne(StringElement element) 
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, string?> SelectOne(NullableStringElement element) 
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TimeSpan}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2008MsSqlDb, TimeSpan> SelectOne(AnyElement<TimeSpan> element)
            => Getv2008MsSqlDb().SelectOne(element);
        ...
        /// <returns><see cref="SelectDynamic{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamic<v2008MsSqlDb> SelectOne(AnyElement element1, AnyElement element2, params AnyElement[] elements)
            => Getv2008MsSqlDb().SelectOne(element1, element2, elements);
        ...
        /// <returns><see cref="SelectDynamic{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamic<v2008MsSqlDb> SelectOne(IEnumerable<AnyElement> elements)
            => Getv2008MsSqlDb().SelectOne(elements);
        ...
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamic<v2008MsSqlDb> SelectOne(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements)
            => Getv2008MsSqlDb().SelectOne((elements ?? throw new ArgumentNullException(nameof(elements))).Concat(additionalElements));
        #endregion
        ...
        /// <para>
        /// To retrieve a list of <see cref="v2008DbEx.dboData.AccessAuditLog" />(s), use a type param of <see cref="v2008DbEx.dboData.AccessAuditLog" />
        /// </para>
        /// <para>
        /// <see href="https://dbexpression.com/docs/core-concepts/basics/select-statement">read the docs on SELECT</see>
        /// </para>
        /// </summary>
        /// <returns><see cref="SelectEntities{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        public static SelectEntities<v2008MsSqlDb, TEntity> SelectMany<TEntity>()
           where TEntity : class, IDbEntity, new()
           => Getv2008MsSqlDb().SelectMany<TEntity>();
        ...
        ///, for example "dbo.Person.GenderType"
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TEnum}"/>, a fluent builder for constructing a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        public static SelectValues<v2008MsSqlDb, TEnum> SelectMany<TEnum>(AnyElement<TEnum> element)
            where TEnum : struct, Enum, IComparable
            => Getv2008MsSqlDb().SelectMany<TEnum>(element);
        ...
        ///, for example "dbo.Address.AddressType"
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TEnum}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, TEnum?> SelectMany<TEnum>(AnyElement<TEnum?> element)
            where TEnum : struct, Enum, IComparable
            => Getv2008MsSqlDb().SelectMany<TEnum>(element);
        ...
        /// <param name="element">An expression of type <see cref="ObjectElement" />
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, object}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, object>? SelectMany(ObjectElement element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, object?> SelectMany(NullableObjectElement element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        /// <returns><see cref="SelectValues{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        public static SelectObjects<v2008MsSqlDb, T> SelectMany<T>(ObjectElement<T> element)
            where T : class?
            => Getv2008MsSqlDb().SelectMany<T>(element);
        ...
        /// <returns><see cref="SelectValues{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the value to select.</typeparam>
        public static SelectValues<v2008MsSqlDb, T> SelectMany<T>(AliasedElement<T> element)
            => Getv2008MsSqlDb().SelectMany<T>(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Boolean" or "db.fx.IsNull(unit_test.ExpressionElementType.Boolean, false)
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Boolean}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, bool> SelectMany(AnyElement<bool> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Byte" or "db.fx.IsNull(unit_test.ExpressionElementType.Byte, byte.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Byte}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, byte> SelectMany(AnyElement<byte> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Byte[]}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, byte[]> SelectMany(ByteArrayElement element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Byte[]}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, byte[]?> SelectMany(NullableByteArrayElement element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.AccessAuditLog.DateCreated", "db.fx.DateAdd(DateParts.Year, 1, dbo.AccessAuditLog.DateCreated) or "db.fx.IsNull(dbo.AccessAuditLog.DateCreated, DateTime.Now)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, DateTime}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, DateTime> SelectMany(AnyElement<DateTime> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Person.RegistrationDate", "db.fx.DateAdd(DateParts.Year, 1, dbo.Person.RegistrationDate)" or "db.fx.IsNull(dbo.Person.RegistrationDate, DateTimeOffset.Now)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, DateTimeOffset}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, DateTimeOffset> SelectMany(AnyElement<DateTimeOffset> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Product.ShippingWeight" or "db.fx.IsNull(dbo.Product.ShippingWeight, decimal.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Decimal}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, decimal> SelectMany(AnyElement<decimal> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Product.ListPrice" or "db.fx.IsNull(dbo.Product.ListPrice, double.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Double}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, double> SelectMany(AnyElement<double> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Guid" or "db.fx.IsNull(unit_test.ExpressionElementType.Guid, Guid.Empty)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Guid}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, Guid> SelectMany(AnyElement<Guid> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Int16" or "db.fx.IsNull(unit_test.ExpressionElementType.Int16, short.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Int16}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, short> SelectMany(AnyElement<short> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Int32}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, int> SelectMany(AnyElement<int> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Int64" or "db.fx.IsNull(unit_test.ExpressionElementType.Int64, long.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Int64}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, long> SelectMany(AnyElement<long> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Single" or "db.fx.IsNull(unit_test.ExpressionElementType.Single, float.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, Single}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, float> SelectMany(AnyElement<float> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Address.Line1" or "db.fx.Concat("Value: ", dbo.Address.Line1)"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, string> SelectMany(StringElement element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, string?> SelectMany(NullableStringElement element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.TimeSpan", "db.fx.IsNull(unit_test.ExpressionElementType.TimeSpan, TimeSpan.MinValue)" or "unit_test.ExpressionElementType.TimeSpan + DateTime.Now"
        ///</param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TimeSpan}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2008MsSqlDb, TimeSpan> SelectMany(AnyElement<TimeSpan> element)
            => Getv2008MsSqlDb().SelectMany(element);
        ...
        /// <param name="elements">Any expression</param>
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamics<v2008MsSqlDb> SelectMany(AnyElement element1, AnyElement element2, params AnyElement[] elements)
            => Getv2008MsSqlDb().SelectMany(element1, element2, elements);
        ...
        /// <param name="elements">A list of any expression</param>
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamics<v2008MsSqlDb> SelectMany(IEnumerable<AnyElement> elements)
            => Getv2008MsSqlDb().SelectMany(elements);
        ...
        /// <param name="additionalElements">Any additional fields to select as part of the SELECT query expression.</param>
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamics<v2008MsSqlDb> SelectMany(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements)
            => Getv2008MsSqlDb().SelectMany((elements ?? throw new ArgumentNullException(nameof(elements))).Concat(additionalElements));
        #endregion
        ...
        /// <returns><see cref="UpdateEntities{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql UPDATE statement.</returns>
        public static UpdateEntities<v2008MsSqlDb> Update(EntityFieldAssignment assignment, params EntityFieldAssignment[] assignments)
            => Getv2008MsSqlDb().Update(assignment, assignments);
        ...
        ///</param>
        /// <returns><see cref="UpdateEntities{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql UPDATE statement.</returns>
        public static UpdateEntities<v2008MsSqlDb> Update(IEnumerable<EntityFieldAssignment> assignments)
            => Getv2008MsSqlDb().Update(assignments);   
        #endregion
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="DeleteEntities{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql DELETE statement.</returns>
        public static DeleteEntities<v2008MsSqlDb> Delete()
            => Getv2008MsSqlDb().Delete();
        #endregion
        ...
        /// </param>
        /// <returns><see cref="InsertEntity{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entity to insert.</typeparam>
        public static InsertEntity<v2008MsSqlDb, TEntity> Insert<TEntity>(TEntity entity)
            where TEntity : class, IDbEntity
            => Getv2008MsSqlDb().Insert<TEntity>(entity);
        ...
        /// </param>
        /// <returns><see cref="InsertEntities{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entities to insert.</typeparam>
        public static InsertEntities<v2008MsSqlDb, TEntity> InsertMany<TEntity>(TEntity entity, params TEntity[] entities)
            where TEntity : class, IDbEntity
            => Getv2008MsSqlDb().InsertMany<TEntity>(entity, entities);
        ...
        /// <returns><see cref="InsertEntities{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entities to insert.</typeparam>
        public static InsertEntities<v2008MsSqlDb, TEntity> InsertMany<TEntity>(IEnumerable<TEntity> entities)
            where TEntity : class, IDbEntity
            => Getv2008MsSqlDb().InsertMany<TEntity>(entities);
        #endregion
...
#endif
    public sealed partial class v2008MsSqlDb : ISqlDatabaseRuntime,
        Database,
        SelectOneInitiation<v2008MsSqlDb>, 
        SelectManyInitiation<v2008MsSqlDb>,
        UpdateEntitiesInitiation<v2008MsSqlDb>,
        DeleteEntitiesInitiation<v2008MsSqlDb>,
        InsertEntitiesInitiation<v2008MsSqlDb>
    {
        #region internals
        ...
        private static readonly SqlDatabaseMetadataProvider _metadata = new SqlDatabaseMetadataProvider(new v2008MsSqlDbSqlDatabaseMetadata("v2008MsSqlDb"));
        private readonly IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> _queryExpressionBuilderFactory;
        private readonly IDbConnectionFactory _connectionFactory;
        private readonly MsSqlFunctionExpressionBuilder _fx;
        private v2008MsSqlDbStoredProcedures? _sp;
        #endregion

        #region interface
        public static string PlatformVersion => "2008";
        ISqlDatabaseMetadataProvider ISqlDatabaseRuntime.MetadataProvider => _metadata;
        Type IDatabaseEntityTypeProvider.EntityType => typeof(v2008MsSqlDb);
        string IExpressionNameProvider.Name => "v2008MsSqlDb";
        ...
        public v2008MsSqlDbStoredProcedures sp => _sp ?? (_sp = new v2008MsSqlDbStoredProcedures(_queryExpressionBuilderFactory, _schemas));
        #endregion
        ...
        public v2008MsSqlDb(
            IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> queryExpressionBuilderFactory,
        ...
        /// <returns><see cref="SelectEntity{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        public SelectEntity<v2008MsSqlDb, TEntity> SelectOne<TEntity>()
            where TEntity : class, IDbEntity, new()
        ...
        /// <returns><see cref="Sql.SelectValue{v2008MsSqlDb, TEnum}"/>, a fluent builder for constructing a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        /// <typeparam name="TEnum">The type of the Enum to select.</typeparam>
        public SelectValue<v2008MsSqlDb, TEnum> SelectOne<TEnum>(AnyElement<TEnum> element)
            where TEnum : struct, Enum, IComparable
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, object}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, object?> SelectOne(ObjectElement element)
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, object}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, object?> SelectOne(NullableObjectElement element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// <returns><see cref="SelectValues{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        public SelectObject<v2008MsSqlDb, T> SelectOne<T>(ObjectElement<T> element)
            where T : class?
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, T> SelectOne<T>(AliasedElement<T> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder<T>(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Boolean" or "db.fx.IsNull(unit_test.ExpressionElementType.Boolean, false)
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, bool> SelectOne(AnyElement<bool> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, byte> SelectOne(AnyElement<byte> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, byte[]> SelectOne(ByteArrayElement element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, byte[]?> SelectOne(NullableByteArrayElement element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, DateTime> SelectOne(AnyElement<DateTime> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, DateTime?> SelectOne(AnyElement<DateTime?> field)
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, DateTimeOffset> SelectOne(AnyElement<DateTimeOffset> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, decimal> SelectOne(AnyElement<decimal> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, double> SelectOne(AnyElement<double> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, Guid> SelectOne(AnyElement<Guid> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, short> SelectOne(AnyElement<short> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, int> SelectOne(AnyElement<int> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, long> SelectOne(AnyElement<long> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, float> SelectOne(AnyElement<float> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, String}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, string> SelectOne(StringElement element) 
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, string?> SelectOne(NullableStringElement element) 
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValue<v2008MsSqlDb, TimeSpan> SelectOne(AnyElement<TimeSpan> element)
            => _queryExpressionBuilderFactory.CreateSelectValueBuilder(element);
        ...
        /// <param name="elements">Any expression</param>
        /// <returns><see cref="SelectDynamic{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectDynamic<v2008MsSqlDb> SelectOne(AnyElement element1, AnyElement element2, params AnyElement[] elements)
        ...
        /// <param name="elements">A list of any expression</param>
        /// <returns><see cref="SelectDynamic{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectDynamic<v2008MsSqlDb> SelectOne(IEnumerable<AnyElement> elements)
        ...
        /// <param name="additionalElements">Any additional fields to select as part of the SELECT query expression.</param>
        /// <returns><see cref="SelectDynamic{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectDynamic<v2008MsSqlDb> SelectOne(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements)
        ...
        /// <returns><see cref="SelectEntities{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        public SelectEntities<v2008MsSqlDb, TEntity> SelectMany<TEntity>()
           where TEntity : class, IDbEntity, new()
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TEnum}"/>, a fluent builder for constructing a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        public SelectValues<v2008MsSqlDb, TEnum> SelectMany<TEnum>(AnyElement<TEnum> element)
            where TEnum : struct, Enum, IComparable
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, object}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, object>? SelectMany(ObjectElement element)
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, object?> SelectMany(NullableObjectElement element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// <returns><see cref="SelectValues{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        public SelectObjects<v2008MsSqlDb, T> SelectMany<T>(ObjectElement<T> element)
            where T : class?
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, T> SelectMany<T>(AliasedElement<T> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder<T>(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Boolean" or "db.fx.IsNull(unit_test.ExpressionElementType.Boolean, false)
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, bool> SelectMany(AnyElement<bool> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, byte> SelectMany(AnyElement<byte> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, byte[]> SelectMany(ByteArrayElement element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, byte[]?> SelectMany(NullableByteArrayElement element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, DateTime> SelectMany(AnyElement<DateTime> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, DateTimeOffset> SelectMany(AnyElement<DateTimeOffset> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, decimal> SelectMany(AnyElement<decimal> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, double> SelectMany(AnyElement<double> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, Guid> SelectMany(AnyElement<Guid> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, short> SelectMany(AnyElement<short> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, int> SelectMany(AnyElement<int> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, long> SelectMany(AnyElement<long> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, float> SelectMany(AnyElement<float> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, string> SelectMany(StringElement element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, string?> SelectMany(NullableStringElement element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2008MsSqlDb, TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectValues<v2008MsSqlDb, TimeSpan> SelectMany(AnyElement<TimeSpan> element)
            => _queryExpressionBuilderFactory.CreateSelectValuesBuilder(element);
        ...
        /// <param name="elements">Any expression</param>
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectDynamics<v2008MsSqlDb> SelectMany(AnyElement element1, AnyElement element2, params AnyElement[] elements)
        ...
        /// <param name="elements">A list of any expression</param>
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectDynamics<v2008MsSqlDb> SelectMany(IEnumerable<AnyElement> elements)
        ...
        /// <param name="additionalElements">Any additional fields to select as part of the SELECT query expression.</param>
        /// <returns><see cref="SelectDynamics{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public SelectDynamics<v2008MsSqlDb> SelectMany(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements)
        ...
        /// <param name="assignments">An additional list of <see cref="EntityFieldAssignment" />(s) assigning database fields/columns new values.  </param>
        /// <returns><see cref="UpdateEntities{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql UPDATE statement.</returns>
        public UpdateEntities<v2008MsSqlDb> Update(EntityFieldAssignment assignment, params EntityFieldAssignment[] assignments)
        ...
        /// </param>
        /// <returns><see cref="UpdateEntities{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql UPDATE statement.</returns>
        public UpdateEntities<v2008MsSqlDb> Update(IEnumerable<EntityFieldAssignment> assignments)
        ...
        /// </summary>
        /// <returns><see cref="DeleteEntities{ v2008MsSqlDb }"/>, a fluent builder for constructing a sql DELETE statement.</returns>
        public DeleteEntities<v2008MsSqlDb> Delete()
        ...
        /// <returns><see cref="InsertEntity{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entity to insert.</typeparam>
        public InsertEntity<v2008MsSqlDb, TEntity> Insert<TEntity>(TEntity entity)
            where TEntity : class, IDbEntity
        ...
        /// <returns><see cref="InsertEntities{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entities to insert.</typeparam>
        public InsertEntities<v2008MsSqlDb, TEntity> InsertMany<TEntity>(TEntity entity, params TEntity[] entities)
            where TEntity : class, IDbEntity
        ...
        /// <returns><see cref="InsertEntities{v2008MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entities to insert.</typeparam>
        public InsertEntities<v2008MsSqlDb, TEntity> InsertMany<TEntity>(IEnumerable<TEntity> entities)
            where TEntity : class, IDbEntity
        ...
        #region sp
        public sealed partial class v2008MsSqlDbStoredProcedures
        {
            #region internals
            ...
            #region constructors
            public v2008MsSqlDbStoredProcedures(IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> factory, IEnumerable<SchemaExpression> schemas)
            {
                if (factory is null)
        ...
        {
            #region internals
            private readonly IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> _factory;
            private readonly SchemaExpression _dbo;
            #endregion

            #region constructors
            public dboStoredProcedures(IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> factory, SchemaExpression schema)
            {
            ...
            public StoredProcedureContinuation<v2008MsSqlDb, GetMaxCreditLimitLessThanStoredProcedure> GetMaxCreditLimitLessThan(int? CreditLimit)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, GetPersonByIdStoredProcedure> GetPersonById(int? Id)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, GetPersonsWithCreditLimitLessThanStoredProcedure> GetPersonsWithCreditLimitLessThan(int? CreditLimit)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPerson_As_Dynamic_With_InputStoredProcedure> SelectPerson_As_Dynamic_With_Input(int? P1)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPerson_As_Dynamic_With_Input_And_InputOutputStoredProcedure> SelectPerson_As_Dynamic_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPerson_As_Dynamic_With_Input_And_OutputStoredProcedure> SelectPerson_As_Dynamic_With_Input_And_Output(int? P1, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPerson_As_DynamicList_With_InputStoredProcedure> SelectPerson_As_DynamicList_With_Input(int? P1)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPerson_As_DynamicList_With_Input_And_InputOutputStoredProcedure> SelectPerson_As_DynamicList_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// <param name="outputParameters">The delegate to manage the output parameters returned from execution of the stored procedure.</param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPerson_As_DynamicList_With_Input_And_OutputStoredProcedure> SelectPerson_As_DynamicList_With_Input_And_Output(int? P1, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValue_With_InputStoredProcedure> SelectPersonId_As_ScalarValue_With_Input(int? P1)
            ...
            /// </summary>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValue_With_Input_And_Default_ValueStoredProcedure> SelectPersonId_As_ScalarValue_With_Input_And_Default_Value()
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValue_With_Input_And_InputOutputStoredProcedure> SelectPersonId_As_ScalarValue_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// <param name="outputParameters">The delegate to manage the output parameters returned from execution of the stored procedure.</param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValue_With_Input_And_OutputStoredProcedure> SelectPersonId_As_ScalarValue_With_Input_And_Output(int? P1, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValueList_With_InputStoredProcedure> SelectPersonId_As_ScalarValueList_With_Input(int? P1)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValueList_With_Input_And_InputOutputStoredProcedure> SelectPersonId_As_ScalarValueList_With_Input_And_InputOutput(int? P1,int? CreditLimit, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// <param name="outputParameters">The delegate to manage the output parameters returned from execution of the stored procedure.</param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SelectPersonId_As_ScalarValueList_With_Input_And_OutputStoredProcedure> SelectPersonId_As_ScalarValueList_With_Input_And_Output(int? P1, Action<ISqlOutputParameterList> outputParameters)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, SetCreditLimitForPersonStoredProcedure> SetCreditLimitForPerson(int? Id,int? CreditLimit)
            ...
            /// </param>
            /// <returns><see cref="StoredProcedureContinuation"/>, a fluent builder for constructing a stored procedure query expression.</returns>
            public StoredProcedureContinuation<v2008MsSqlDb, UpdatePersonCreditLimit_With_InputsStoredProcedure> UpdatePersonCreditLimit_With_Inputs(int? P1,int? CreditLimit)
        ...
        public sealed partial class secStoredProcedures
        {
            ...
            #region constructors
            public secStoredProcedures(IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> factory, SchemaExpression schema)
            {
                _factory = factory ?? throw new ArgumentNullException(nameof(factory));
        ...
        public sealed partial class unit_testStoredProcedures
        {
            ...
            #region constructors
            public unit_testStoredProcedures(IMsSqlQueryExpressionBuilderFactory<v2008MsSqlDb> factory, SchemaExpression schema)
            {
                _factory = factory ?? throw new ArgumentNullException(nameof(factory));
...
namespace v2008DbEx.dboDataService
{
    ...
    public sealed partial class AccessAuditLogEntity : EntityExpression<AccessAuditLog>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.IdField"/> representing the "dbo.AccessAuditLog.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.IdField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.PersonIdField"/> representing the "dbo.AccessAuditLog.PersonId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.PersonIdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.AccessResultField"/> representing the "dbo.AccessAuditLog.AccessResult" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.AccessResultField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.DateCreatedField"/> representing the "dbo.AccessAuditLog.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity.DateCreatedField"/> can be 
    ...
    public sealed partial class AddressEntity : EntityExpression<Address>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.IdField"/> representing the "dbo.Address.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.AddressTypeField"/> representing the "dbo.Address.AddressType" column in the database, 
        /// with a .NET type of <see cref="DbEx.Data.AddressType"/>?.  The <see cref="v2008DbEx.dboDataService.AddressEntity.AddressTypeField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.Line1Field"/> representing the "dbo.Address.Line1" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.Line1Field"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.Line2Field"/> representing the "dbo.Address.Line2" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.dboDataService.AddressEntity.Line2Field"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.CityField"/> representing the "dbo.Address.City" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.CityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.StateField"/> representing the "dbo.Address.State" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.StateField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.ZipField"/> representing the "dbo.Address.Zip" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.ZipField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.DateCreatedField"/> representing the "dbo.Address.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity.DateUpdatedField"/> representing the "dbo.Address.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.AddressEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class PersonEntity : EntityExpression<Person>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.IdField"/> representing the "dbo.Person.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.FirstNameField"/> representing the "dbo.Person.FirstName" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.FirstNameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.LastNameField"/> representing the "dbo.Person.LastName" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.LastNameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.BirthDateField"/> representing the "dbo.Person.BirthDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="v2008DbEx.dboDataService.PersonEntity.BirthDateField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.GenderTypeField"/> representing the "dbo.Person.GenderType" column in the database, 
        /// with a .NET type of <see cref="DbEx.Data.GenderType"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.GenderTypeField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.CreditLimitField"/> representing the "dbo.Person.CreditLimit" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="v2008DbEx.dboDataService.PersonEntity.CreditLimitField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.YearOfLastCreditLimitReviewField"/> representing the "dbo.Person.YearOfLastCreditLimitReview" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="v2008DbEx.dboDataService.PersonEntity.YearOfLastCreditLimitReviewField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.RegistrationDateField"/> representing the "dbo.Person.RegistrationDate" column in the database, 
        /// with a .NET type of <see cref="DateTimeOffset"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.RegistrationDateField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.LastLoginDateField"/> representing the "dbo.Person.LastLoginDate" column in the database, 
        /// with a .NET type of <see cref="DateTimeOffset"/>?.  The <see cref="v2008DbEx.dboDataService.PersonEntity.LastLoginDateField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTimeOffset?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.DateCreatedField"/> representing the "dbo.Person.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity.DateUpdatedField"/> representing the "dbo.Person.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PersonEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class PersonAddressEntity : EntityExpression<PersonAddress>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonAddressEntity.IdField"/> representing the "dbo.Person_Address.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PersonAddressEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonAddressEntity.PersonIdField"/> representing the "dbo.Person_Address.PersonId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PersonAddressEntity.PersonIdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonAddressEntity.AddressIdField"/> representing the "dbo.Person_Address.AddressId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PersonAddressEntity.AddressIdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonAddressEntity.DateCreatedField"/> representing the "dbo.Person_Address.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PersonAddressEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class ProductEntity : EntityExpression<Product>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.IdField"/> representing the "dbo.Product.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.ProductCategoryTypeField"/> representing the "dbo.Product.ProductCategoryType" column in the database, 
        /// with a .NET type of <see cref="DbEx.Data.ProductCategoryType"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.ProductCategoryTypeField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.NameField"/> representing the "dbo.Product.Name" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.NameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.DescriptionField"/> representing the "dbo.Product.Description" column in the database, 
        /// with a .NET type of <see cref="DbExpression.MsSql.Test.ProductDescription"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.DescriptionField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.ListPriceField"/> representing the "dbo.Product.ListPrice" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.ListPriceField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.PriceField"/> representing the "dbo.Product.Price" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.PriceField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{double}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.QuantityField"/> representing the "dbo.Product.Quantity" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.QuantityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.ImageField"/> representing the "dbo.Product.Image" column in the database, 
        /// with a .NET type of <see cref="byte"/>[].  The <see cref="v2008DbEx.dboDataService.ProductEntity.ImageField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.HeightField"/> representing the "dbo.Product.Height" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.HeightField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.WidthField"/> representing the "dbo.Product.Width" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.WidthField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.DepthField"/> representing the "dbo.Product.Depth" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.DepthField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.WeightField"/> representing the "dbo.Product.Weight" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.WeightField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.ShippingWeightField"/> representing the "dbo.Product.ShippingWeight" column in the database, 
        /// with a .NET type of <see cref="decimal"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.ShippingWeightField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.ValidStartTimeOfDayForPurchaseField"/> representing the "dbo.Product.ValidStartTimeOfDayForPurchase" column in the database, 
        /// with a .NET type of <see cref="TimeSpan"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.ValidStartTimeOfDayForPurchaseField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.ValidEndTimeOfDayForPurchaseField"/> representing the "dbo.Product.ValidEndTimeOfDayForPurchase" column in the database, 
        /// with a .NET type of <see cref="TimeSpan"/>?.  The <see cref="v2008DbEx.dboDataService.ProductEntity.ValidEndTimeOfDayForPurchaseField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{TimeSpan?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.DateCreatedField"/> representing the "dbo.Product.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity.DateUpdatedField"/> representing the "dbo.Product.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.ProductEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class PurchaseEntity : EntityExpression<Purchase>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.IdField"/> representing the "dbo.Purchase.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.PersonIdField"/> representing the "dbo.Purchase.PersonId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.PersonIdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.OrderNumberField"/> representing the "dbo.Purchase.OrderNumber" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.OrderNumberField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.TotalPurchaseQuantityField"/> representing the "dbo.Purchase.TotalPurchaseQuantity" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.TotalPurchaseQuantityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.TotalPurchaseAmountField"/> representing the "dbo.Purchase.TotalPurchaseAmount" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.TotalPurchaseAmountField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{double}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.PurchaseDateField"/> representing the "dbo.Purchase.PurchaseDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.PurchaseDateField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.ShipDateField"/> representing the "dbo.Purchase.ShipDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.ShipDateField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.ExpectedDeliveryDateField"/> representing the "dbo.Purchase.ExpectedDeliveryDate" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.ExpectedDeliveryDateField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.TrackingIdentifierField"/> representing the "dbo.Purchase.TrackingIdentifier" column in the database, 
        /// with a .NET type of <see cref="Guid"/>?.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.TrackingIdentifierField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.PaymentMethodTypeField"/> representing the "dbo.Purchase.PaymentMethodType" column in the database, 
        /// with a .NET type of <see cref="DbEx.Data.PaymentMethodType"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.PaymentMethodTypeField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.PaymentSourceTypeField"/> representing the "dbo.Purchase.PaymentSourceType" column in the database, 
        /// with a .NET type of <see cref="DbEx.Data.PaymentSourceType"/>?.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.PaymentSourceTypeField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.DateCreatedField"/> representing the "dbo.Purchase.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity.DateUpdatedField"/> representing the "dbo.Purchase.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class PurchaseLineEntity : EntityExpression<PurchaseLine>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.IdField"/> representing the "dbo.PurchaseLine.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.PurchaseIdField"/> representing the "dbo.PurchaseLine.PurchaseId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.PurchaseIdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.ProductIdField"/> representing the "dbo.PurchaseLine.ProductId" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.ProductIdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.PurchasePriceField"/> representing the "dbo.PurchaseLine.PurchasePrice" column in the database, 
        /// with a .NET type of <see cref="decimal"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.PurchasePriceField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.QuantityField"/> representing the "dbo.PurchaseLine.Quantity" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.QuantityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.DateCreatedField"/> representing the "dbo.PurchaseLine.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.DateUpdatedField"/> representing the "dbo.PurchaseLine.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.dboDataService.PurchaseLineEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class PersonTotalPurchasesViewEntity : EntityExpression<PersonTotalPurchasesView>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity.IdField"/> representing the "dbo.PersonTotalPurchasesView.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity.TotalAmountField"/> representing the "dbo.PersonTotalPurchasesView.TotalAmount" column in the database, 
        /// with a .NET type of <see cref="double"/>?.  The <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity.TotalAmountField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{double?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity.TotalCountField"/> representing the "dbo.PersonTotalPurchasesView.TotalCount" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity.TotalCountField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
...
#pragma warning restore CS8981 // The type name only contains lower-cased ascii characters. Such names may become reserved for the language.
    {
        ...
        #region interface
        /// <summary>A <see cref="v2008DbEx.dboDataService.AccessAuditLogEntity"/> representing the "dbo.AccessAuditLog" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.AddressEntity"/> representing the "dbo.Address" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonEntity"/> representing the "dbo.Person" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonAddressEntity"/> representing the "dbo.Person_Address" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.ProductEntity"/> representing the "dbo.Product" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseEntity"/> representing the "dbo.Purchase" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PurchaseLineEntity"/> representing the "dbo.PurchaseLine" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.dboDataService.PersonTotalPurchasesViewEntity"/> representing the "dbo.PersonTotalPurchasesView" view in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
...
namespace v2008DbEx.secDataService
{
	using v2008DbEx.secData;
	using System.Data;
    ...
    public sealed partial class PersonEntity : EntityExpression<Person>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.secDataService.PersonEntity.IdField"/> representing the "sec.Person.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.secDataService.PersonEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.secDataService.PersonEntity.SocialSecurityNumberField"/> representing the "sec.Person.SSN" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.secDataService.PersonEntity.SocialSecurityNumberField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.secDataService.PersonEntity.DateCreatedField"/> representing the "sec.Person.DateCreated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.secDataService.PersonEntity.DateCreatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.secDataService.PersonEntity.DateUpdatedField"/> representing the "sec.Person.DateUpdated" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.secDataService.PersonEntity.DateUpdatedField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
...
#pragma warning restore CS8981 // The type name only contains lower-cased ascii characters. Such names may become reserved for the language.
    {
        ...
        #region interface
        /// <summary>A <see cref="v2008DbEx.secDataService.PersonEntity"/> representing the "sec.Person" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>Person</description>
...
namespace v2008DbEx.unit_testDataService
{
	using v2008DbEx.unit_testData;
	using System.Data;
    ...
    public sealed partial class aliasEntity : EntityExpression<alias>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.identifierField"/> representing the "unit_test.alias.identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity._identifierField"/> representing the "unit_test.alias._identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity._identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.__identifierField"/> representing the "unit_test.alias.__identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.__identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.nameField"/> representing the "unit_test.alias.name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity._nameField"/> representing the "unit_test.alias._name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity._nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.__nameField"/> representing the "unit_test.alias.__name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.__nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.schemaField"/> representing the "unit_test.alias.schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity._schemaField"/> representing the "unit_test.alias._schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity._schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.__schemaField"/> representing the "unit_test.alias.__schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.__schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity._aliasField"/> representing the "unit_test.alias._alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity._aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.__aliasField"/> representing the "unit_test.alias.__alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.__aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.entityField"/> representing the "unit_test.alias.entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity._entityField"/> representing the "unit_test.alias._entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity._entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity.__entityField"/> representing the "unit_test.alias.__entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.aliasEntity.__entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class entityEntity : EntityExpression<entity>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.identifierField"/> representing the "unit_test.entity.identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity._identifierField"/> representing the "unit_test.entity._identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity._identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.__identifierField"/> representing the "unit_test.entity.__identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.__identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.nameField"/> representing the "unit_test.entity.name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity._nameField"/> representing the "unit_test.entity._name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity._nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.__nameField"/> representing the "unit_test.entity.__name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.__nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.schemaField"/> representing the "unit_test.entity.schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity._schemaField"/> representing the "unit_test.entity._schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity._schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.__schemaField"/> representing the "unit_test.entity.__schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.__schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.aliasField"/> representing the "unit_test.entity.alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity._aliasField"/> representing the "unit_test.entity._alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity._aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.__aliasField"/> representing the "unit_test.entity.__alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.__aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity._entityField"/> representing the "unit_test.entity._entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity._entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity.__entityField"/> representing the "unit_test.entity.__entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.entityEntity.__entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class ExpressionElementTypeEntity : EntityExpression<ExpressionElementType>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.IdField"/> representing the "unit_test.ExpressionElementType.Id" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.IdField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.BooleanField"/> representing the "unit_test.ExpressionElementType.Boolean" column in the database, 
        /// with a .NET type of <see cref="bool"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.BooleanField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableBooleanField"/> representing the "unit_test.ExpressionElementType.NullableBoolean" column in the database, 
        /// with a .NET type of <see cref="bool"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableBooleanField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{bool?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.ByteField"/> representing the "unit_test.ExpressionElementType.Byte" column in the database, 
        /// with a .NET type of <see cref="byte"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.ByteField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{byte}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableByteField"/> representing the "unit_test.ExpressionElementType.NullableByte" column in the database, 
        /// with a .NET type of <see cref="byte"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableByteField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{byte?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.ByteArrayField"/> representing the "unit_test.ExpressionElementType.ByteArray" column in the database, 
        /// with a .NET type of <see cref="byte"/>[].  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.ByteArrayField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{byte[]}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableByteArrayField"/> representing the "unit_test.ExpressionElementType.NullableByteArray" column in the database, 
        /// with a .NET type of <see cref="byte"/>[].  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableByteArrayField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{byte[]?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DateTimeField"/> representing the "unit_test.ExpressionElementType.DateTime" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DateTimeField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDateTimeField"/> representing the "unit_test.ExpressionElementType.NullableDateTime" column in the database, 
        /// with a .NET type of <see cref="DateTime"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDateTimeField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTime?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DateTimeOffsetField"/> representing the "unit_test.ExpressionElementType.DateTimeOffset" column in the database, 
        /// with a .NET type of <see cref="DateTimeOffset"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DateTimeOffsetField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTimeOffset}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDateTimeOffsetField"/> representing the "unit_test.ExpressionElementType.NullableDateTimeOffset" column in the database, 
        /// with a .NET type of <see cref="DateTimeOffset"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDateTimeOffsetField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{DateTimeOffset?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DecimalField"/> representing the "unit_test.ExpressionElementType.Decimal" column in the database, 
        /// with a .NET type of <see cref="decimal"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DecimalField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDecimalField"/> representing the "unit_test.ExpressionElementType.NullableDecimal" column in the database, 
        /// with a .NET type of <see cref="decimal"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDecimalField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{decimal?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DoubleField"/> representing the "unit_test.ExpressionElementType.Double" column in the database, 
        /// with a .NET type of <see cref="double"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.DoubleField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{double}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDoubleField"/> representing the "unit_test.ExpressionElementType.NullableDouble" column in the database, 
        /// with a .NET type of <see cref="double"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableDoubleField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{double?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.GuidField"/> representing the "unit_test.ExpressionElementType.Guid" column in the database, 
        /// with a .NET type of <see cref="Guid"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.GuidField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{Guid}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableGuidField"/> representing the "unit_test.ExpressionElementType.NullableGuid" column in the database, 
        /// with a .NET type of <see cref="Guid"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableGuidField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{Guid?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.Int16Field"/> representing the "unit_test.ExpressionElementType.Int16" column in the database, 
        /// with a .NET type of <see cref="short"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.Int16Field"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableInt16Field"/> representing the "unit_test.ExpressionElementType.NullableInt16" column in the database, 
        /// with a .NET type of <see cref="short"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableInt16Field"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{short?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.Int32Field"/> representing the "unit_test.ExpressionElementType.Int32" column in the database, 
        /// with a .NET type of <see cref="int"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.Int32Field"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableInt32Field"/> representing the "unit_test.ExpressionElementType.NullableInt32" column in the database, 
        /// with a .NET type of <see cref="int"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableInt32Field"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{int?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.Int64Field"/> representing the "unit_test.ExpressionElementType.Int64" column in the database, 
        /// with a .NET type of <see cref="long"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.Int64Field"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableInt64Field"/> representing the "unit_test.ExpressionElementType.NullableInt64" column in the database, 
        /// with a .NET type of <see cref="long"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableInt64Field"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{long?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.SingleField"/> representing the "unit_test.ExpressionElementType.Single" column in the database, 
        /// with a .NET type of <see cref="float"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.SingleField"/> can be 
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableSingleField"/> representing the "unit_test.ExpressionElementType.NullableSingle" column in the database, 
        /// with a .NET type of <see cref="float"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableSingleField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{float?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.StringField"/> representing the "unit_test.ExpressionElementType.String" column in the database, 
        /// with a .NET type of <see cref="string"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.StringField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableStringField"/> representing the "unit_test.ExpressionElementType.NullableString" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableStringField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.TimeSpanField"/> representing the "unit_test.ExpressionElementType.TimeSpan" column in the database, 
        /// with a .NET type of <see cref="TimeSpan"/>.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.TimeSpanField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{TimeSpan}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableTimeSpanField"/> representing the "unit_test.ExpressionElementType.NullableTimeSpan" column in the database, 
        /// with a .NET type of <see cref="TimeSpan"/>?.  The <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity.NullableTimeSpanField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{TimeSpan?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class identifierEntity : EntityExpression<identifier>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity._identifierField"/> representing the "unit_test.identifier._identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity._identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.__identifierField"/> representing the "unit_test.identifier.__identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.__identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.nameField"/> representing the "unit_test.identifier.name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity._nameField"/> representing the "unit_test.identifier._name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity._nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.__nameField"/> representing the "unit_test.identifier.__name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.__nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.schemaField"/> representing the "unit_test.identifier.schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity._schemaField"/> representing the "unit_test.identifier._schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity._schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.__schemaField"/> representing the "unit_test.identifier.__schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.__schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.aliasField"/> representing the "unit_test.identifier.alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity._aliasField"/> representing the "unit_test.identifier._alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity._aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.__aliasField"/> representing the "unit_test.identifier.__alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.__aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.entityField"/> representing the "unit_test.identifier.entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity._entityField"/> representing the "unit_test.identifier._entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity._entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity.__entityField"/> representing the "unit_test.identifier.__entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.identifierEntity.__entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class nameEntity : EntityExpression<name>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.identifierField"/> representing the "unit_test.name.identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity._identifierField"/> representing the "unit_test.name._identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity._identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.__identifierField"/> representing the "unit_test.name.__identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.__identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity._nameField"/> representing the "unit_test.name._name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity._nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.__nameField"/> representing the "unit_test.name.__name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.__nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.schemaField"/> representing the "unit_test.name.schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity._schemaField"/> representing the "unit_test.name._schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity._schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.__schemaField"/> representing the "unit_test.name.__schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.__schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.aliasField"/> representing the "unit_test.name.alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity._aliasField"/> representing the "unit_test.name._alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity._aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.__aliasField"/> representing the "unit_test.name.__alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.__aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.entityField"/> representing the "unit_test.name.entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity._entityField"/> representing the "unit_test.name._entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity._entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity.__entityField"/> representing the "unit_test.name.__entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.nameEntity.__entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
    ...
    public sealed partial class schemaEntity : EntityExpression<schema>
    {
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.identifierField"/> representing the "unit_test.schema.identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity._identifierField"/> representing the "unit_test.schema._identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity._identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.__identifierField"/> representing the "unit_test.schema.__identifier" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.__identifierField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.nameField"/> representing the "unit_test.schema.name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity._nameField"/> representing the "unit_test.schema._name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity._nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.__nameField"/> representing the "unit_test.schema.__name" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.__nameField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity._schemaField"/> representing the "unit_test.schema._schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity._schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.__schemaField"/> representing the "unit_test.schema.__schema" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.__schemaField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.aliasField"/> representing the "unit_test.schema.alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity._aliasField"/> representing the "unit_test.schema._alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity._aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.__aliasField"/> representing the "unit_test.schema.__alias" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.__aliasField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.entityField"/> representing the "unit_test.schema.entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity._entityField"/> representing the "unit_test.schema._entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity._entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity.__entityField"/> representing the "unit_test.schema.__entity" column in the database, 
        /// with a .NET type of <see cref="string"/>?.  The <see cref="v2008DbEx.unit_testDataService.schemaEntity.__entityField"/> can be 
        /// used with any operation accepting a <see cref="DbExpression.Sql.AnyElement{string?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
...
#pragma warning restore CS8981 // The type name only contains lower-cased ascii characters. Such names may become reserved for the language.
    {
        ...
        #region interface
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.aliasEntity"/> representing the "unit_test.alias" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>alias</description>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.entityEntity"/> representing the "unit_test.entity" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>entity</description>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.ExpressionElementTypeEntity"/> representing the "unit_test.ExpressionElementType" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.identifierEntity"/> representing the "unit_test.identifier" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>identifier</description>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.nameEntity"/> representing the "unit_test.name" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>name</description>
        ...
        /// <summary>A <see cref="v2008DbEx.unit_testDataService.schemaEntity"/> representing the "unit_test.schema" table in the database.
        /// <para>Properties:
        /// <list type="table">
        /// <item>
        /// <term>name</term><description>schema</description>
