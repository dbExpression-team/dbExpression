...
{
    public class v2022MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2022MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2022MsSqlDb"));
        ...
        public v2022MsSqlDbSqlDatabaseMetadata(string name)
        {
