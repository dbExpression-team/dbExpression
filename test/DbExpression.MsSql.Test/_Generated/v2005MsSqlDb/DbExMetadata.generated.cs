...
{
    public class v2005MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2005MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2005MsSqlDb"));
        ...
        public v2005MsSqlDbSqlDatabaseMetadata(string name)
        {
