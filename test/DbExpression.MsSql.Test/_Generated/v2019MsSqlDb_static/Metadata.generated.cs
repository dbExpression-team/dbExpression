...
{
    public class v2019MsSqlDb_staticSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2019MsSqlDb_staticSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2019MsSqlDb_static"));
        ...
        public v2019MsSqlDb_staticSqlDatabaseMetadata(string name)
        {
