...
#pragma warning disable CS8981 // The type name only contains lower-cased ascii characters
    ...
    {
        #region internals
        private static v2017MsSqlDb? _v2017mssqldb;
        #endregion

        #region interface
        public static MsSqlFunctionExpressionBuilder fx => Getv2017MsSqlDb().fx;
        public static v2017MsSqlDb.v2017MsSqlDbStoredProcedures sp => Getv2017MsSqlDb().sp;
        #endregion

        #region methods
        internal static void UseDatabase(v2017MsSqlDb v2017mssqldb)
            => _v2017mssqldb = v2017mssqldb ?? throw new ArgumentNullException(nameof(v2017mssqldb));
        
        internal static void DiscardDatabase()
            => _v2017mssqldb = null;

        private static v2017MsSqlDb Getv2017MsSqlDb()
            =>  _v2017mssqldb ?? DbExpressionConfigurationException.ThrowServiceResolutionWithReturn<v2017MsSqlDb>();        
        ...
        public static SelectEntity<v2017MsSqlDb, TEntity> SelectOne<TEntity>()
            where TEntity : class, IDbEntity, new()
            => Getv2017MsSqlDb().SelectOne<TEntity>();
        ...
        public static SelectValue<v2017MsSqlDb, TEnum> SelectOne<TEnum>(AnyElement<TEnum> element)
            where TEnum : struct, Enum, IComparable
            => Getv2017MsSqlDb().SelectOne<TEnum>(element);
        ...
        public static SelectValue<v2017MsSqlDb, object?> SelectOne(ObjectElement element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, object?> SelectOne(NullableObjectElement element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        public static SelectObject<v2017MsSqlDb, T> SelectOne<T>(ObjectElement<T> element)
            where T : class?
            => Getv2017MsSqlDb().SelectOne<T>(element);
        ...
        public static SelectValue<v2017MsSqlDb, T> SelectOne<T>(AliasedElement<T> element)
            => Getv2017MsSqlDb().SelectOne<T>(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Boolean}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, bool> SelectOne(AnyElement<bool> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Byte}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, byte> SelectOne(AnyElement<byte> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Byte[]}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, byte[]> SelectOne(ByteArrayElement element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Byte[]}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, byte[]?> SelectOne(NullableByteArrayElement element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, DateTime}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, DateTime> SelectOne(AnyElement<DateTime> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, DateTime}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, DateTime?> SelectOne(AnyElement<DateTime?> field)
            => Getv2017MsSqlDb().SelectOne(field);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, DateTimeOffset}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, DateTimeOffset> SelectOne(AnyElement<DateTimeOffset> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Decimal}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, decimal> SelectOne(AnyElement<decimal> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Double}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, double> SelectOne(AnyElement<double> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Guid}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, Guid> SelectOne(AnyElement<Guid> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Int16}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, short> SelectOne(AnyElement<short> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Int32}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, int> SelectOne(AnyElement<int> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Int64}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, long> SelectOne(AnyElement<long> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, Single}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, float> SelectOne(AnyElement<float> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        public static SelectValue<v2017MsSqlDb, string> SelectOne(StringElement element) 
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, string?> SelectOne(NullableStringElement element) 
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{v2017MsSqlDb, TimeSpan}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValue<v2017MsSqlDb, TimeSpan> SelectOne(AnyElement<TimeSpan> element)
            => Getv2017MsSqlDb().SelectOne(element);
        ...
        public static SelectDynamic<v2017MsSqlDb> SelectOne(AnyElement element1, AnyElement element2, params AnyElement[] elements)
            => Getv2017MsSqlDb().SelectOne(element1, element2, elements);
        ...
        /// <returns><see cref="SelectDynamic{ v2017MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamic<v2017MsSqlDb> SelectOne(IEnumerable<AnyElement> elements)
            => Getv2017MsSqlDb().SelectOne(elements);
        ...
        public static SelectDynamic<v2017MsSqlDb> SelectOne(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements)
            => Getv2017MsSqlDb().SelectOne((elements ?? throw new ArgumentNullException(nameof(elements))).Concat(additionalElements));
        #endregion
        ...
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        public static SelectEntities<v2017MsSqlDb, TEntity> SelectMany<TEntity>()
           where TEntity : class, IDbEntity, new()
           => Getv2017MsSqlDb().SelectMany<TEntity>();
        ...
        public static SelectValues<v2017MsSqlDb, TEnum> SelectMany<TEnum>(AnyElement<TEnum> element)
            where TEnum : struct, Enum, IComparable
            => Getv2017MsSqlDb().SelectMany<TEnum>(element);
        ...
        public static SelectValues<v2017MsSqlDb, object>? SelectMany(ObjectElement element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, object?> SelectMany(NullableObjectElement element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        /// <returns><see cref="SelectValues{v2017MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        public static SelectObjects<v2017MsSqlDb, T> SelectMany<T>(ObjectElement<T> element)
            where T : class?
            => Getv2017MsSqlDb().SelectMany<T>(element);
        ...
        /// <returns><see cref="SelectValues{v2017MsSqlDb, T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the value to select.</typeparam>
        public static SelectValues<v2017MsSqlDb, T> SelectMany<T>(AliasedElement<T> element)
            => Getv2017MsSqlDb().SelectMany<T>(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Boolean" or "db.fx.IsNull(unit_test.ExpressionElementType.Boolean, false)
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Boolean}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, bool> SelectMany(AnyElement<bool> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Byte" or "db.fx.IsNull(unit_test.ExpressionElementType.Byte, byte.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Byte}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, byte> SelectMany(AnyElement<byte> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Byte[]}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, byte[]> SelectMany(ByteArrayElement element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Byte[]}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, byte[]?> SelectMany(NullableByteArrayElement element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.AccessAuditLog.DateCreated", "db.fx.DateAdd(DateParts.Year, 1, dbo.AccessAuditLog.DateCreated) or "db.fx.IsNull(dbo.AccessAuditLog.DateCreated, DateTime.Now)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, DateTime}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, DateTime> SelectMany(AnyElement<DateTime> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Person.RegistrationDate", "db.fx.DateAdd(DateParts.Year, 1, dbo.Person.RegistrationDate)" or "db.fx.IsNull(dbo.Person.RegistrationDate, DateTimeOffset.Now)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, DateTimeOffset}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, DateTimeOffset> SelectMany(AnyElement<DateTimeOffset> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Product.ShippingWeight" or "db.fx.IsNull(dbo.Product.ShippingWeight, decimal.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Decimal}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, decimal> SelectMany(AnyElement<decimal> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "dbo.Product.ListPrice" or "db.fx.IsNull(dbo.Product.ListPrice, double.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Double}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, double> SelectMany(AnyElement<double> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Guid" or "db.fx.IsNull(unit_test.ExpressionElementType.Guid, Guid.Empty)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Guid}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, Guid> SelectMany(AnyElement<Guid> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Int16" or "db.fx.IsNull(unit_test.ExpressionElementType.Int16, short.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Int16}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, short> SelectMany(AnyElement<short> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Int32}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, int> SelectMany(AnyElement<int> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Int64" or "db.fx.IsNull(unit_test.ExpressionElementType.Int64, long.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Int64}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, long> SelectMany(AnyElement<long> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.Single" or "db.fx.IsNull(unit_test.ExpressionElementType.Single, float.MinValue)"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, Single}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, float> SelectMany(AnyElement<float> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        public static SelectValues<v2017MsSqlDb, string> SelectMany(StringElement element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, string?> SelectMany(NullableStringElement element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        ///, for example "unit_test.ExpressionElementType.TimeSpan", "db.fx.IsNull(unit_test.ExpressionElementType.TimeSpan, TimeSpan.MinValue)" or "unit_test.ExpressionElementType.TimeSpan + DateTime.Now"
        ///</param>
        /// <returns><see cref="SelectValues{v2017MsSqlDb, TimeSpan}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectValues<v2017MsSqlDb, TimeSpan> SelectMany(AnyElement<TimeSpan> element)
            => Getv2017MsSqlDb().SelectMany(element);
        ...
        /// <param name="elements">Any expression</param>
        /// <returns><see cref="SelectDynamics{ v2017MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamics<v2017MsSqlDb> SelectMany(AnyElement element1, AnyElement element2, params AnyElement[] elements)
            => Getv2017MsSqlDb().SelectMany(element1, element2, elements);
        ...
        /// <param name="elements">A list of any expression</param>
        /// <returns><see cref="SelectDynamics{ v2017MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamics<v2017MsSqlDb> SelectMany(IEnumerable<AnyElement> elements)
            => Getv2017MsSqlDb().SelectMany(elements);
        ...
        /// <param name="additionalElements">Any additional fields to select as part of the SELECT query expression.</param>
        /// <returns><see cref="SelectDynamics{ v2017MsSqlDb }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        public static SelectDynamics<v2017MsSqlDb> SelectMany(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements)
            => Getv2017MsSqlDb().SelectMany((elements ?? throw new ArgumentNullException(nameof(elements))).Concat(additionalElements));
        #endregion
        ...
        public static UpdateEntities<v2017MsSqlDb> Update(EntityFieldAssignment assignment, params EntityFieldAssignment[] assignments)
            => Getv2017MsSqlDb().Update(assignment, assignments);
        ...
        ///</param>
        /// <returns><see cref="UpdateEntities{ v2017MsSqlDb }"/>, a fluent builder for constructing a sql UPDATE statement.</returns>
        public static UpdateEntities<v2017MsSqlDb> Update(IEnumerable<EntityFieldAssignment> assignments)
            => Getv2017MsSqlDb().Update(assignments);   
        #endregion
        ...
        public static DeleteEntities<v2017MsSqlDb> Delete()
            => Getv2017MsSqlDb().Delete();
        #endregion
        ...
        public static InsertEntity<v2017MsSqlDb, TEntity> Insert<TEntity>(TEntity entity)
            where TEntity : class, IDbEntity
            => Getv2017MsSqlDb().Insert<TEntity>(entity);
        ...
        public static InsertEntities<v2017MsSqlDb, TEntity> InsertMany<TEntity>(TEntity entity, params TEntity[] entities)
            where TEntity : class, IDbEntity
            => Getv2017MsSqlDb().InsertMany<TEntity>(entity, entities);
        ...
        /// <returns><see cref="InsertEntities{v2017MsSqlDb, TEntity}"/>, a fluent builder for constructing a sql INSERT statement.</returns>
        /// <typeparam name="TEntity">The entity type of the entities to insert.</typeparam>
        public static InsertEntities<v2017MsSqlDb, TEntity> InsertMany<TEntity>(IEnumerable<TEntity> entities)
            where TEntity : class, IDbEntity
            => Getv2017MsSqlDb().InsertMany<TEntity>(entities);
        #endregion
