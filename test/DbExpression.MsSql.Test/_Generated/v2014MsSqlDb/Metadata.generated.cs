...
{
    public class v2014MsSqlDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        #region constructors
        static v2014MsSqlDbSqlDatabaseMetadata()
        {
            _metadata.Add(0, new SqlDatabaseMetadata(name:"v2014MsSqlDb"));
        ...
        public v2014MsSqlDbSqlDatabaseMetadata(string name)
        {
