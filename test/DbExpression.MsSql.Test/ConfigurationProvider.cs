...
namespace DbExpression.MsSql.Test
{
    ...
    {
        private static readonly string ConnectionStringKey = "dbexpression_mssql_test";
        ...
        public class NetFrameworkConfigurationShim : IConfiguration
        {
            ...
            {
                public string dbexpression_mssql_test { get; set; }
                public string? this[string key] { get => dbexpression_mssql_test; set { } }

                public ConnectionStringsSection()
                {
                    dbexpression_mssql_test = Environment.GetEnvironmentVariable(ConnectionStringKey) ?? string.Empty;
                }

                public string Key { get; } = ConnectionStringKey;
                public string Path { get; } = "";
                public string? Value { get => dbexpression_mssql_test; set { } }
