...
{
    public class NullableLengthFunctionExpressionCodeGenerator : CodeGenerator<FunctionTemplateModel>
    {
        ...
        public override void Generate(string templatePath, string outputSubdirectory)
            => Generate(templatePath, outputSubdirectory, $"Nullable{TypeBuilder.Get<long>()}{functionName}FunctionExpression.generated.cs", CreateModel("DbExpression.Sql.Expression", TypeBuilder.Get<long>()));
    }
}
