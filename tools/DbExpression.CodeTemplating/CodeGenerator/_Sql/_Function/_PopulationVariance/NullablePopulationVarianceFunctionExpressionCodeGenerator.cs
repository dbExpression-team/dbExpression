...
{
    public class NullablePopulationVarianceFunctionExpressionCodeGenerator : CodeGenerator<FunctionTemplateModel>
    {
        private const string functionName = "PopulationVariance";
