using DbExpression.CodeTemplating.CodeGenerator;
using DbExpression.CodeTemplating.Model;

using Generator = DbExpression.CodeTemplating.CodeGenerator.CodeGenerator;

namespace DbExpression.CodeTemplating
{
    class Program
    {
        private const string templateDirectory = @"Templates\Sql\Expression";
        private const string sqlSrcDirectory = @"src\DbExpression.Sql\Expression";
        private const string msSqlSrcDirectory = @"src\DbExpression.MsSql\Expression";
