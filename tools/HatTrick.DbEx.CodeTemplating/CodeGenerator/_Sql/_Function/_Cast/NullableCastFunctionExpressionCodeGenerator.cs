...
{
    public class NullableCastFunctionExpressionCodeGenerator : CodeGenerator<FunctionTemplateModel>
    {
        ...
        {
            foreach (var @type in TypeBuilder.CreateBuilder().AddAllTypes().Except(typeof(string), typeof(object)).ToList())
