...
{
    public class MinimumFunctionExpressionCodeGenerator : CodeGenerator<FunctionTemplateModel>
    {
        private const string functionName = "Minimum";
        ...
        {
            foreach (var @type in TypeBuilder.CreateBuilder().AddAllTypes().Except(typeof(bool), typeof(object)).ToList())
