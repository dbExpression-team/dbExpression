...
{
    public class NullableDatePartFunctionExpressionCodeGenerator : CodeGenerator<FunctionTemplateModel>
    {
        ...
        public override void Generate(string templatePath, string outputSubdirectory)
            => Generate(templatePath, outputSubdirectory, $"Nullable{TypeBuilder.Get<int>()}{functionName}FunctionExpression.generated.cs", CreateModel("HatTrick.DbEx.Sql.Expression", TypeBuilder.Get<int>()));
    }
}
