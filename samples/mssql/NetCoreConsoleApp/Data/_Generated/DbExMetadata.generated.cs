...
namespace SimpleConsole.DataService
{
    public class SimpleConsoleDbSqlDatabaseMetadata : ISqlDatabaseMetadata
    {
        ...
        static SimpleConsoleDbSqlDatabaseMetadata()
        {
            ...
            _metadata.Add(98, new StoredProcedureMetadata("SelectPersonId_As_ScalarValue_With_Input_And_InputOutput"));
            _metadata.Add(99, new MsSqlParameterMetadata("@P1", SqlDbType.Int));
            _metadata.Add(100, new MsSqlParameterMetadata("@CreditLimit", SqlDbType.Int));
            _metadata.Add(101, new StoredProcedureMetadata("SelectPersonId_As_ScalarValue_With_Input_And_Output"));
            _metadata.Add(102, new MsSqlParameterMetadata("@P1", SqlDbType.Int));
            _metadata.Add(103, new MsSqlParameterMetadata("@Count", SqlDbType.Int));
            _metadata.Add(104, new StoredProcedureMetadata("SelectPersonId_As_ScalarValueList_With_Input"));
            _metadata.Add(105, new MsSqlParameterMetadata("@P1", SqlDbType.Int));
            _metadata.Add(106, new StoredProcedureMetadata("SelectPersonId_As_ScalarValueList_With_Input_And_InputOutput"));
            _metadata.Add(107, new MsSqlParameterMetadata("@P1", SqlDbType.Int));
            _metadata.Add(108, new MsSqlParameterMetadata("@CreditLimit", SqlDbType.Int));
            _metadata.Add(109, new StoredProcedureMetadata("SelectPersonId_As_ScalarValueList_With_Input_And_Output"));
            _metadata.Add(110, new MsSqlParameterMetadata("@P1", SqlDbType.Int));
            _metadata.Add(111, new MsSqlParameterMetadata("@Count", SqlDbType.Int));
            _metadata.Add(112, new StoredProcedureMetadata("UpdatePersonCreditLimit_With_Inputs"));
            _metadata.Add(113, new MsSqlParameterMetadata("@P1", SqlDbType.Int));
            _metadata.Add(114, new MsSqlParameterMetadata("@CreditLimit", SqlDbType.Int));
            #endregion
            #endregion

            #region sec schema
            _metadata.Add(115, new SqlSchemaMetadata("sec"));
            
            #region sec entities
            #region sec.Person
            _metadata.Add(116, new SqlTableMetadata("Person"));
            _metadata.Add(117, new MsSqlColumnMetadata("Id", SqlDbType.Int));
            _metadata.Add(118, new MsSqlColumnMetadata("SSN", SqlDbType.Char, 11));
            _metadata.Add(119, new MsSqlColumnMetadata("DateCreated", SqlDbType.DateTime));
            _metadata.Add(120, new MsSqlColumnMetadata("DateUpdated", SqlDbType.DateTime));
            #endregion
