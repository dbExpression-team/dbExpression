...
namespace HTL.DbEx.MsSql.Expression
{
    ...
    //{
    //    MsSqlBuilder<Y> From<Y>(DBExpressionEntity<Y> from) where Y : class, new();
    //}
    //#endregion
    ...
    //{
    //    MsSqlBuilder<T> From<T>(DBExpressionEntity<T> from) where T : class, new();
    //}
    //#endregion
    ...
    //{
    //    MsSqlBuilder<T> Into<T>(DBExpressionEntity<T> from) where Y : class, new();
    //}
    //#endregion
    ...
    //    #region from
    //    public MsSqlBuilder<T> From<T>(DBExpressionEntity<T> from) where T : class, new()
    //    {
    //        var builder = new MsSqlBuilder<T>(ConnectionSettings, from);
    ...
    //    #region from
    //    public new MsSqlBuilder<T> From<T>(DBExpressionEntity<T> from) where T : class, new()
    //    {
    //        var builder =  new MsSqlBuilder<T>(base.ConnectionSettings, from);
    ...
    //    #region into
    //    public MsSqlBuilder<T> Into<T>(DBExpressionEntity<T> from) where T : class, new()
    //    {
    //        var builder = new MsSqlBuilder<T>(base.ConnectionSettings, from);
    //        builder.Expression = base.ExpressionSet;
