...
{
    public class MsSqlQueryExpressionBuilderFactory : IQueryExpressionBuilderFactory
    {
        #region internals
        ...
        #region methods
        public IQueryExpressionBuilder CreateQueryExpressionBuilder()
            => new MsSqlQueryExpressionBuilder(queryExpressionFactory, executionPipelineFactory);
        #endregion
    }
}