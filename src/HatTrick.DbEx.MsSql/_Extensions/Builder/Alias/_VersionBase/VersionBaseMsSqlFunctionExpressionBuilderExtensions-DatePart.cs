...
namespace HatTrick.DbEx.MsSql.Builder.Alias
{
    public static partial class VersionBaseMsSqlFunctionExpressionBuilderExtensions
    {
        ...
        public static NullableInt32DatePartFunctionExpression DatePart(this VersionBaseMsSqlFunctionExpressionBuilder _, DateParts datePart, (string TableName, string FieldName) element)
