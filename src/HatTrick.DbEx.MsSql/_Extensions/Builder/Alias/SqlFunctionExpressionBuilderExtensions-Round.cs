...
namespace HatTrick.DbEx.MsSql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <returns><see cref="NullableObjectRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Decimal}"/>?.</returns>
        public static NullableObjectRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, (string TableName, string FieldName) expression, int length, NullableAnyNumericElement function)
        ...
        /// <param name="function">A <see cref="NullableAnyNumericElement" /> (one of <see cref="AnyElement{byte}" />?, <see cref="AnyElement{short}" />?, <see cref="AnyElement{int}" />?, or <see cref="AnyElement{long}" />?) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDecimalRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Decimal}"/>?.</returns>
        public static NullableDecimalRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, (string TableName, string FieldName) expression, int? length, NullableAnyNumericElement function)
            => new(new AliasExpression<decimal?>(expression), new LiteralExpression<int?>(length), function);
        ...
        /// <returns><see cref="NullableDecimalRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{decimal}"/>?.</returns>
        public static NullableDecimalRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, (string TableName, string FieldName) expression, int length, AnyNumericElement function)
            => new(new AliasExpression<decimal?>(expression), new LiteralExpression<int>(length), function);
        #endregion
        ...
        /// <param name="function">A <see cref="NullableAnyNumericElement" /> (one of <see cref="AnyElement{byte}" />?, <see cref="AnyElement{short}" />?, <see cref="AnyElement{int}" />?, or <see cref="AnyElement{long}" />?) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDecimalRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{decimal}"/>?.</returns>
        public static NullableDecimalRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<decimal?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
        ...
        /// <returns><see cref="NullableDecimalRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{decimal}"/>?.</returns>
        public static NullableDecimalRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<decimal?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDecimalRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{decimal}"/>?.</returns>
        public static NullableDecimalRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<decimal?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">A <see cref="AnyNumericElement" /> (one of <see cref="AnyElement{byte}" />, <see cref="AnyElement{short}" />, <see cref="AnyElement{int}" />, or <see cref="AnyElement{long}" />) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDecimalRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{decimal}"/>?.</returns>
        public static NullableDecimalRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<decimal?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
        ...
        /// <param name="function">A <see cref="NullableAnyNumericElement" /> (one of <see cref="AnyElement{byte}" />?, <see cref="AnyElement{short}" />?, <see cref="AnyElement{int}" />?, or <see cref="AnyElement{long}" />?) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDoubleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{double}"/>?.</returns>
        public static NullableDoubleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<double?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDoubleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{double}"/>?.</returns>
        public static NullableDoubleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<double?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDoubleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{double}"/>?.</returns>
        public static NullableDoubleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<double?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">A <see cref="AnyNumericElement" /> (one of <see cref="AnyElement{byte}" />, <see cref="AnyElement{short}" />, <see cref="AnyElement{int}" />, or <see cref="AnyElement{long}" />) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableDoubleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{double}"/>?.</returns>
        public static NullableDoubleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<double?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
        ...
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<byte?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<byte?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<byte?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<byte?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
        ...
        /// <param name="function">A <see cref="NullableAnyNumericElement" /> (one of <see cref="AnyElement{byte}" />?, <see cref="AnyElement{short}" />?, <see cref="AnyElement{int}" />?, or <see cref="AnyElement{long}" />?) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<short?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<short?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<short?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">A <see cref="AnyNumericElement" /> (one of <see cref="AnyElement{byte}" />, <see cref="AnyElement{short}" />, <see cref="AnyElement{int}" />, or <see cref="AnyElement{long}" />) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<short?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
        ...
        /// <param name="function">A <see cref="NullableAnyNumericElement" /> (one of <see cref="AnyElement{byte}" />?, <see cref="AnyElement{short}" />?, <see cref="AnyElement{int}" />?, or <see cref="AnyElement{long}" />?) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<int?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<int?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<int?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">A <see cref="AnyNumericElement" /> (one of <see cref="AnyElement{byte}" />, <see cref="AnyElement{short}" />, <see cref="AnyElement{int}" />, or <see cref="AnyElement{long}" />) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt32RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{int}"/>?.</returns>
        public static NullableInt32RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<int?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
        ...
        public static NullableInt64RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<long?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt64RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{long}"/>?.</returns>
        public static NullableInt64RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<long?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt64RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{long}"/>?.</returns>
        public static NullableInt64RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<long?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">A <see cref="AnyNumericElement" /> (one of <see cref="AnyElement{byte}" />, <see cref="AnyElement{short}" />, <see cref="AnyElement{int}" />, or <see cref="AnyElement{long}" />) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableInt64RoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{long}"/>?.</returns>
        public static NullableInt64RoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<long?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
        ...
        public static NullableSingleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<float?> expression, (string TableName, string FieldName) length, NullableAnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableSingleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{float}"/>?.</returns>
        public static NullableSingleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<float?> expression, NullableAnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">An alias of an expression indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableSingleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{float}"/>?.</returns>
        public static NullableSingleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<float?> expression, AnyNumericElement length, (string TableName, string FieldName) function)
            => new(expression, length, new AliasExpression<int?>(function));
        ...
        /// <param name="function">A <see cref="AnyNumericElement" /> (one of <see cref="AnyElement{byte}" />, <see cref="AnyElement{short}" />, <see cref="AnyElement{int}" />, or <see cref="AnyElement{long}" />) indicating the type of operation to perform.</param>
        /// <returns><see cref="NullableSingleRoundFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{float}"/>?.</returns>
        public static NullableSingleRoundFunctionExpression Round(this FirstGenerationMsSqlFunctionExpressionBuilder _, AnyElement<float?> expression, (string TableName, string FieldName) length, AnyNumericElement function)
            => new(expression, new AliasExpression<int?>(length), function);
        #endregion
    }
}