...
namespace HTL.DbEx.Sql.Assembler
{
    public class WhereClauseAssembler :
        ISqlPartAssembler<DBWhereExpressionSet>
    {
        ...
        {
            return expressionPart is DBWhereExpressionSet ?
                Assemble((DBWhereExpressionSet)expressionPart, builder, overrides)
                :
                Assemble((DBWhereExpression)expressionPart, builder, overrides);
        }

        public string Assemble(DBWhereExpressionSet expressionPart, ISqlStatementBuilder builder, AssemblerOverrides overrides)
        {
        ...
        public string Assemble(DBWhereExpression expressionPart, ISqlStatementBuilder builder, AssemblerOverrides overrides)
        {
