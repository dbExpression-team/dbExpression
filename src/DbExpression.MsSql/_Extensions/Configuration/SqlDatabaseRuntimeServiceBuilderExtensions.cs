...
//
// The latest platformVersion of this file can be found at https://github.com/dbexpression-team/dbexpression
#endregion

using DbExpression.MsSql.Assembler;
using DbExpression.MsSql.Builder;
using DbExpression.MsSql.Connection;
using DbExpression.MsSql.Types;
...
using MsSqlServices = DbExpression.MsSql.Configuration.SqlDatabaseRuntimeServiceBuilderExtensions;
    ...
    public static partial class SqlDatabaseRuntimeServiceBuilderExtensions
    {
            ...
            where TDatabase : class, ISqlDatabaseRuntime
        {
            ...
            builder.Register<TDatabase>().AddMsSqlCommon<TDatabase, Builder.v2005.MsSqlFunctionExpressionBuilder>(b =>
            {
                ...
                b.SqlStatements.Assembly.ElementAppender.ForElementTypes(x => x
                    .ForElementType<InsertQueryExpression>().Use<DbExpression.MsSql.Assembler.v2005.MsSqlInsertQueryExpressionAppender>()
                    .ForElementType<SelectQueryExpression>().Use<DbExpression.MsSql.Assembler.v2005.MsSqlSelectQueryExpressionAppender>()
                );
            });
        }
        #endregion
            ...
            where TDatabase : class, ISqlDatabaseRuntime
        {
            ...
            builder.Register<TDatabase>().AddMsSqlCommon<TDatabase, Builder.v2008.MsSqlFunctionExpressionBuilder>(b =>
            {
                configureRuntime.Invoke(b);
                b.SqlStatements.Assembly.ElementAppender.ForElementTypes(x => x
                    .ForElementType<SelectQueryExpression>().Use<DbExpression.MsSql.Assembler.v2008.MsSqlSelectQueryExpressionAppender>()
                );
            });
        }
        #endregion
