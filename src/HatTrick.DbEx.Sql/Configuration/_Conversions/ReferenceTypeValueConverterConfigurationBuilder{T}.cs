...
{
    public class ReferenceTypeValueConverterConfigurationBuilder<T> : IReferenceTypeValueConverterConfigurationBuilder<T>
        where T : class
    {
        #region internals
        ...
        #region constructors
        public ReferenceTypeValueConverterConfigurationBuilder(IValueConverterFactoryContinuationConfigurationBuilder caller, ValueConverterFactory factory)
        {
