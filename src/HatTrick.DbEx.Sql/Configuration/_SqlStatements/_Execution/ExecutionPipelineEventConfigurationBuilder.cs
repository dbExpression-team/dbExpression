...
namespace HatTrick.DbEx.Sql.Configuration
{
    public class ExecutionPipelineEventConfigurationBuilder : IExecutionPipelineEventConfigurationBuilder
    {
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeAssembly.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeAssembly.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
        ...
        public IExecutionPipelineEventConfigurationBuilder OnBeforeSqlStatementAssembly(Func<BeforeAssemblyPipelineExecutionContext, Task> action, Predicate<BeforeAssemblyPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.BeforeAssembly.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterAssembly.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterAssembly.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnAfterSqlStatementAssembly(Func<AfterAssemblyPipelineExecutionContext, Task> action, Predicate<AfterAssemblyPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.AfterAssembly.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeInsert.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeInsert.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnBeforeInsertQueryExecution(Func<BeforeInsertPipelineExecutionContext, Task> action, Predicate<BeforeInsertPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.BeforeInsert.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterInsert.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterInsert.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnAfterInsertQueryExecution(Func<AfterInsertPipelineExecutionContext, Task> action, Predicate<AfterInsertPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.AfterInsert.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeUpdate.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeUpdate.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnBeforeUpdateQueryExecution(Func<BeforeUpdatePipelineExecutionContext, Task> action, Predicate<BeforeUpdatePipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.BeforeUpdate.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterUpdate.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterUpdate.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnAfterUpdateQueryExecution(Func<AfterUpdatePipelineExecutionContext, Task> action, Predicate<AfterUpdatePipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.AfterUpdate.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeDelete.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeDelete.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnBeforeDeleteQueryExecution(Func<BeforeDeletePipelineExecutionContext, Task> action, Predicate<BeforeDeletePipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.BeforeDelete.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterDelete.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterDelete.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnAfterDeleteQueryExecution(Func<AfterDeletePipelineExecutionContext, Task> action, Predicate<AfterDeletePipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.AfterDelete.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeSelect.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeSelect.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnBeforeSelectQueryExecution(Func<BeforeSelectPipelineExecutionContext, Task> action, Predicate<BeforeSelectPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.BeforeSelect.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterSelect.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterSelect.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnAfterSelectQueryExecution(Func<AfterSelectPipelineExecutionContext, Task> action, Predicate<AfterSelectPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.AfterSelect.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeExecution.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.BeforeExecution.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnBeforeSqlStatementExecution(Func<BeforeExecutionPipelineExecutionContext, Task> action, Predicate<BeforeExecutionPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.BeforeExecution.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterExecution.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."));
            return this;
        }
        ...
        {
            configuration.ExecutionPipelineFactory.AfterExecution.AddToEnd(action ?? throw new ArgumentNullException($"{nameof(action)} is required."), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
        ...
        public IExecutionPipelineEventConfigurationBuilder OnAfterSqlStatementExecution(Func<AfterExecutionPipelineExecutionContext, Task> action, Predicate<AfterExecutionPipelineExecutionContext> predicate)
        {
            if (action is null)
                throw new ArgumentNullException($"{nameof(action)} is required.");
            configuration.ExecutionPipelineFactory.AfterExecution.AddToEnd((c, ct) => action(c), predicate ?? throw new ArgumentNullException($"{nameof(predicate)} is required."));
            return this;
        }
