...
namespace HatTrick.DbEx.Sql.Configuration
{
    public class SqlConnectionFactoryConfigurationBuilder : ISqlConnectionFactoryConfigurationBuilder
    {
        ...
        #region constructors
        public SqlConnectionFactoryConfigurationBuilder(ISqlStatementExecutionGroupingConfigurationBuilders caller, SqlDatabaseRuntimeConfiguration configuration)
        {
