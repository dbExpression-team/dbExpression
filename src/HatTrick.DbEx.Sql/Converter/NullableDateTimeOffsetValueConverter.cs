...
{
    public class NullableDateTimeOffsetValueConverter : NullableValueConverter<DateTimeOffset>, IValueConverter<DateTimeOffset?>
    {
        public override (Type Type, object? ConvertedValue) ConvertToDatabase(object? value)
        {
            if (value is null)
                return (typeof(DateTimeOffset?), value);
        ...
        DateTimeOffset? IValueConverter<DateTimeOffset?>.ConvertFromDatabase(object? value)
        {
            if (value is null)
                return null;
