...
{
    public class NullableEnumValueConverter<TEnum> : NullableEnumValueConverter, IValueConverter<TEnum?>
    {
        public NullableEnumValueConverter() : base(Nullable.GetUnderlyingType(typeof(TEnum))!)
        {
        }
