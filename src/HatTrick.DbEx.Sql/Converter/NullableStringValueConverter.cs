...
{
    public class NullableStringValueConverter : NullableValueConverter<string>
    {
        public override object? ConvertFromDatabase(object? value)
        {
            ...
            {
                return DbExpressionConversionException.ThrowValueConversionFailedWithReturn<object?>(value, value?.GetType(), typeof(string), e);
            }
        }
