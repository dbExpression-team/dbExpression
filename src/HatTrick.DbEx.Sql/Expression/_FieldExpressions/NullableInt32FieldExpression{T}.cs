...
{
    [Serializable]
    public class NullableInt32FieldExpression<TEntity> : NullableFieldExpression<TEntity, int>,
    ...
    {
        public NullableInt32FieldExpression(EntityExpression entity, ISqlFieldMetadata metadata, Expression<Func<TEntity, int?>> mapExpression) : base(entity, metadata, mapExpression)
        {
        }

        protected NullableInt32FieldExpression(EntityExpression entity, ISqlFieldMetadata metadata, Lazy<Action<TEntity, int?>> mapExpression, string alias) : base(entity, metadata, mapExpression, alias)
        {
