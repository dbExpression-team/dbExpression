...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region constructors
        public NullableInt32FieldExpression(string identifier, string name, Table entity) : base(identifier, name, entity)
        {
        ...
        public override bool Equals(object? obj)
            => obj is NullableInt32FieldExpression<TEntity> exp && Equals(exp);
