...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region constructors
        public SingleFieldExpression(string identifier, string name, Table entity) : base(identifier, name, entity)
        {
        ...
        public override bool Equals(object? obj)
            => obj is SingleFieldExpression<TEntity> exp && Equals(exp);
