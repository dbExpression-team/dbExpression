...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region in value set
        public override FilterExpression In(params DateTime[] value) => value != null ? new FilterExpression<DateTime>(new DateTimeExpressionMediator(this), new DateTimeExpressionMediator(new LiteralExpression<DateTime[]>(value)), FilterExpressionOperator.In) : null;
        #endregion
