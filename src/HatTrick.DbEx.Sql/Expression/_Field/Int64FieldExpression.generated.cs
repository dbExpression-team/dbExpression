...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region in value set
        public override FilterExpression In(params long[] value) => value != null ? new FilterExpression<long>(new Int64ExpressionMediator(this), new Int64ExpressionMediator(new LiteralExpression<long[]>(value)), FilterExpressionOperator.In) : null;
        #endregion
