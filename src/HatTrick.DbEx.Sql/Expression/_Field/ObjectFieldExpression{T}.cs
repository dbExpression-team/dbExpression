...
namespace HatTrick.DbEx.Sql.Expression
{
        ...
        where T: class
    {
        ...
        public static FilterExpressionSet operator ==(ObjectFieldExpression<T> a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression(b.TableName, b.FieldName), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(ObjectFieldExpression<T> a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression(b.TableName, b.FieldName), FilterExpressionOperator.NotEqual));
        #endregion
        #endregion
    }
}
