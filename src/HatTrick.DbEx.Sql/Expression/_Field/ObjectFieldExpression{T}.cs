...
namespace HatTrick.DbEx.Sql.Expression
{
        ...
        where T: class?
    {
        ...
        #region DBNull
        public static FilterExpression operator ==(ObjectFieldExpression<T> a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<object?>(b, a), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(ObjectFieldExpression<T> a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<object?>(b, a), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(DBNull a, ObjectFieldExpression<T> b) => new FilterExpression<bool?>(new LiteralExpression<object?>(a, b), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(DBNull a, ObjectFieldExpression<T> b) => new FilterExpression<bool?>(new LiteralExpression<object?>(a, b), b, FilterExpressionOperator.NotEqual);
        #endregion
