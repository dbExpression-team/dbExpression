...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class Int32FieldExpression
    {
        ...
        #region alias
        public static FilterExpression<bool> operator ==(Int32FieldExpression a, AliasExpression b) => new FilterExpression<bool>(new Int32ExpressionMediator(a), new ExpressionMediator(b), FilterExpressionOperator.Equal);
        public static FilterExpression<bool> operator !=(Int32FieldExpression a, AliasExpression b) => new FilterExpression<bool>(new Int32ExpressionMediator(a), new ExpressionMediator(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression<bool> operator <(Int32FieldExpression a, AliasExpression b) => new FilterExpression<bool>(new Int32ExpressionMediator(a), new ExpressionMediator(b), FilterExpressionOperator.LessThan);
        public static FilterExpression<bool> operator <=(Int32FieldExpression a, AliasExpression b) => new FilterExpression<bool>(new Int32ExpressionMediator(a), new ExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual);
        public static FilterExpression<bool> operator >(Int32FieldExpression a, AliasExpression b) => new FilterExpression<bool>(new Int32ExpressionMediator(a), new ExpressionMediator(b), FilterExpressionOperator.GreaterThan);
        public static FilterExpression<bool> operator >=(Int32FieldExpression a, AliasExpression b) => new FilterExpression<bool>(new Int32ExpressionMediator(a), new ExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual);
        #endregion
        #endregion
    }
}
