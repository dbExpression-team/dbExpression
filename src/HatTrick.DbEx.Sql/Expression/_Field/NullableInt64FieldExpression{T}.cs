...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region constructors
        public NullableInt64FieldExpression(string identifier, string name, Table entity) : base(identifier, name, entity)
        {
        ...
        public override bool Equals(object? obj)
            => obj is NullableInt64FieldExpression<TEntity> exp && Equals(exp);
