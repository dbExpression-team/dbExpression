...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    public partial class NullableInt32FieldExpression
    {
        ...
        #region DBNull
        public static FilterExpression operator ==(NullableInt32FieldExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<int?>(b, a), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(NullableInt32FieldExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<int?>(b, a), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(DBNull a, NullableInt32FieldExpression b) => new FilterExpression<bool?>(new LiteralExpression<int?>(a, b), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(DBNull a, NullableInt32FieldExpression b) => new FilterExpression<bool?>(new LiteralExpression<int?>(a, b), b, FilterExpressionOperator.NotEqual);
        #endregion
