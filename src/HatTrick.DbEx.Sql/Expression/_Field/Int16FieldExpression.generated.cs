...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class Int16FieldExpression
    {
        ...
        #region DBNull
        public static FilterExpression operator ==(Int16FieldExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<short?>(b, a), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(Int16FieldExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<short?>(b, a), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(DBNull a, Int16FieldExpression b) => new FilterExpression<bool?>(new LiteralExpression<short?>(a, b), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(DBNull a, Int16FieldExpression b) => new FilterExpression<bool?>(new LiteralExpression<short?>(a, b), b, FilterExpressionOperator.NotEqual);
        #endregion
