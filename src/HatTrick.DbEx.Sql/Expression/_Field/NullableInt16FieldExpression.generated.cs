...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    public partial class NullableInt16FieldExpression
    {
        ...
        #region null
        public static FilterExpression operator ==(NullableInt16FieldExpression a, NullElement b) => new FilterExpression<bool?>(a, new LiteralExpression<short?>(b, a), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(NullableInt16FieldExpression a, NullElement b) => new FilterExpression<bool?>(a, new LiteralExpression<short?>(b, a), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(NullElement a, NullableInt16FieldExpression b) => new FilterExpression<bool?>(new LiteralExpression<short?>(a, b), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(NullElement a, NullableInt16FieldExpression b) => new FilterExpression<bool?>(new LiteralExpression<short?>(a, b), b, FilterExpressionOperator.NotEqual);
        #endregion
