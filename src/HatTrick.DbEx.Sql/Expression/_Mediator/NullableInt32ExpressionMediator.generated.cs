...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableInt32ExpressionMediator
    {
        ...
        #region int
        public static FilterExpressionSet operator ==(NullableInt32ExpressionMediator a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32ExpressionMediator a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32ExpressionMediator a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32ExpressionMediator a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32ExpressionMediator a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32ExpressionMediator a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(int a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(int a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(int a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(int a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(int a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(int a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), b, FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableInt32ExpressionMediator a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32ExpressionMediator a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32ExpressionMediator a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32ExpressionMediator a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32ExpressionMediator a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32ExpressionMediator a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(int? a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(int? a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(int? a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(int? a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(int? a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(int? a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), b, FilterExpressionOperator.GreaterThanOrEqual));
        #endregion

        #region fields
        public static FilterExpressionSet operator ==(NullableInt32ExpressionMediator a, Int32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32ExpressionMediator a, Int32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32ExpressionMediator a, Int32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32ExpressionMediator a, Int32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32ExpressionMediator a, Int32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32ExpressionMediator a, Int32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableInt32ExpressionMediator a, NullableInt32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32ExpressionMediator a, NullableInt32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32ExpressionMediator a, NullableInt32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32ExpressionMediator a, NullableInt32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32ExpressionMediator a, NullableInt32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32ExpressionMediator a, NullableInt32FieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        ...
        public static FilterExpressionSet operator ==(NullableInt32ExpressionMediator a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(a), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32ExpressionMediator a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(a), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32ExpressionMediator a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(a), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32ExpressionMediator a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(a), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32ExpressionMediator a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(a), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32ExpressionMediator a, NullableInt32ExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(a), b, FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        #endregion
    }
}
