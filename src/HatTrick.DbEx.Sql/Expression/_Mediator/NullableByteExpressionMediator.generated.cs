...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableByteExpressionMediator
    {
        ...
        #region byte
        public static FilterExpressionSet operator ==(NullableByteExpressionMediator a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteExpressionMediator a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteExpressionMediator a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteExpressionMediator a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteExpressionMediator a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteExpressionMediator a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(byte a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(byte a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(byte a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(byte a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(byte a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(byte a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), b, FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableByteExpressionMediator a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteExpressionMediator a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteExpressionMediator a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteExpressionMediator a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteExpressionMediator a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteExpressionMediator a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(byte? a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(byte? a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(byte? a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(byte? a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(byte? a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(byte? a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), b, FilterExpressionOperator.GreaterThanOrEqual));
        #endregion

        #region fields
        public static FilterExpressionSet operator ==(NullableByteExpressionMediator a, ByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteExpressionMediator a, ByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteExpressionMediator a, ByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteExpressionMediator a, ByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteExpressionMediator a, ByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteExpressionMediator a, ByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableByteExpressionMediator a, NullableByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteExpressionMediator a, NullableByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteExpressionMediator a, NullableByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteExpressionMediator a, NullableByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteExpressionMediator a, NullableByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteExpressionMediator a, NullableByteFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        ...
        public static FilterExpressionSet operator ==(NullableByteExpressionMediator a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(a), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteExpressionMediator a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(a), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteExpressionMediator a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(a), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteExpressionMediator a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(a), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteExpressionMediator a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(a), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteExpressionMediator a, NullableByteExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(a), b, FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        #endregion
    }
}
