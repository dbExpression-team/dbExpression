...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableDecimalExpressionMediator
    {
        ...
        #region decimal
        public static FilterExpressionSet operator ==(NullableDecimalExpressionMediator a, decimal b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new DecimalExpressionMediator(new LiteralExpression<decimal>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableDecimalExpressionMediator a, decimal b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new DecimalExpressionMediator(new LiteralExpression<decimal>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableDecimalExpressionMediator a, decimal b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new DecimalExpressionMediator(new LiteralExpression<decimal>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableDecimalExpressionMediator a, decimal b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new DecimalExpressionMediator(new LiteralExpression<decimal>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableDecimalExpressionMediator a, decimal b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new DecimalExpressionMediator(new LiteralExpression<decimal>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableDecimalExpressionMediator a, decimal b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new DecimalExpressionMediator(new LiteralExpression<decimal>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(decimal a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(new LiteralExpression<decimal>(a)), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(decimal a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(new LiteralExpression<decimal>(a)), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(decimal a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(new LiteralExpression<decimal>(a)), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(decimal a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(new LiteralExpression<decimal>(a)), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(decimal a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(new LiteralExpression<decimal>(a)), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(decimal a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(new LiteralExpression<decimal>(a)), b, FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableDecimalExpressionMediator a, decimal? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableDecimalExpressionMediator a, decimal? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableDecimalExpressionMediator a, decimal? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableDecimalExpressionMediator a, decimal? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableDecimalExpressionMediator a, decimal? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableDecimalExpressionMediator a, decimal? b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(decimal? a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(a)), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(decimal? a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(a)), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(decimal? a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(a)), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(decimal? a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(a)), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(decimal? a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(a)), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(decimal? a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableDecimalExpressionMediator(new LiteralExpression<decimal?>(a)), b, FilterExpressionOperator.GreaterThanOrEqual));
        #endregion

        #region fields
        public static FilterExpressionSet operator ==(NullableDecimalExpressionMediator a, DecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableDecimalExpressionMediator a, DecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableDecimalExpressionMediator a, DecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableDecimalExpressionMediator a, DecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableDecimalExpressionMediator a, DecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableDecimalExpressionMediator a, DecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableDecimalExpressionMediator a, NullableDecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableDecimalExpressionMediator a, NullableDecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableDecimalExpressionMediator a, NullableDecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableDecimalExpressionMediator a, NullableDecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableDecimalExpressionMediator a, NullableDecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableDecimalExpressionMediator a, NullableDecimalFieldExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(a, new NullableDecimalExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        ...
        public static FilterExpressionSet operator ==(NullableDecimalExpressionMediator a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(a), b, FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableDecimalExpressionMediator a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(a), b, FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableDecimalExpressionMediator a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(a), b, FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableDecimalExpressionMediator a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(a), b, FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableDecimalExpressionMediator a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(a), b, FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableDecimalExpressionMediator a, NullableDecimalExpressionMediator b) => new FilterExpressionSet(new FilterExpression<bool?>(new DecimalExpressionMediator(a), b, FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        #endregion
    }
}
