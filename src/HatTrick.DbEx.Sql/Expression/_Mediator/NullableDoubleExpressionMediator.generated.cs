...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableDoubleExpressionMediator
    {
        ...
        #region fields
        public static FilterExpression<bool?> operator ==(NullableDoubleExpressionMediator a, DoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.Equal);
        public static FilterExpression<bool?> operator !=(NullableDoubleExpressionMediator a, DoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression<bool?> operator <(NullableDoubleExpressionMediator a, DoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.LessThan);
        public static FilterExpression<bool?> operator <=(NullableDoubleExpressionMediator a, DoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual);
        public static FilterExpression<bool?> operator >(NullableDoubleExpressionMediator a, DoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.GreaterThan);
        public static FilterExpression<bool?> operator >=(NullableDoubleExpressionMediator a, DoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual);

        public static FilterExpression<bool?> operator ==(NullableDoubleExpressionMediator a, NullableDoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.Equal);
        public static FilterExpression<bool?> operator !=(NullableDoubleExpressionMediator a, NullableDoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression<bool?> operator <(NullableDoubleExpressionMediator a, NullableDoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.LessThan);
        public static FilterExpression<bool?> operator <=(NullableDoubleExpressionMediator a, NullableDoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual);
        public static FilterExpression<bool?> operator >(NullableDoubleExpressionMediator a, NullableDoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.GreaterThan);
        public static FilterExpression<bool?> operator >=(NullableDoubleExpressionMediator a, NullableDoubleFieldExpression b) => new FilterExpression<bool?>(a, new NullableDoubleExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual);
        #endregion
        ...
        #region alias
        public static FilterExpression<bool?> operator ==(NullableDoubleExpressionMediator a, AliasExpression b) => new FilterExpression<bool?>(a, new ExpressionMediator(b), FilterExpressionOperator.Equal);
        public static FilterExpression<bool?> operator !=(NullableDoubleExpressionMediator a, AliasExpression b) => new FilterExpression<bool?>(a, new ExpressionMediator(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression<bool?> operator <(NullableDoubleExpressionMediator a, AliasExpression b) => new FilterExpression<bool?>(a, new ExpressionMediator(b), FilterExpressionOperator.LessThan);
        public static FilterExpression<bool?> operator <=(NullableDoubleExpressionMediator a, AliasExpression b) => new FilterExpression<bool?>(a, new ExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual);
        public static FilterExpression<bool?> operator >(NullableDoubleExpressionMediator a, AliasExpression b) => new FilterExpression<bool?>(a, new ExpressionMediator(b), FilterExpressionOperator.GreaterThan);
        public static FilterExpression<bool?> operator >=(NullableDoubleExpressionMediator a, AliasExpression b) => new FilterExpression<bool?>(a, new ExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual);
        #endregion
        #endregion
    }
}
