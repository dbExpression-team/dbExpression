...
{
    public abstract class NullableExpFunctionExpression<TValue, TNullableValue> : ExpFunctionExpression,
        IExpressionElement<TValue, TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableExpFunctionExpression(IExpressionElement expression)
