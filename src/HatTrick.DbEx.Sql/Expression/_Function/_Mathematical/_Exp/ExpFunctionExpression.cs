...
{
    public abstract class ExpFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<ExpFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected ExpFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(ExpFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is ExpFunctionExpression exp && Equals(exp);
