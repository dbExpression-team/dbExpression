...
{
    public abstract class ACosFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<ACosFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected ACosFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region to string
        public override string? ToString() => $"ACOS({expression})";
        #endregion

        #region equals
        public bool Equals(ACosFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is ACosFunctionExpression exp && Equals(exp);
