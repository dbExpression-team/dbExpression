...
{
    public abstract class NullableACosFunctionExpression<TValue, TNullableValue> : ACosFunctionExpression,
        IExpressionElement<TValue, TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableACosFunctionExpression(IExpressionElement expression)
