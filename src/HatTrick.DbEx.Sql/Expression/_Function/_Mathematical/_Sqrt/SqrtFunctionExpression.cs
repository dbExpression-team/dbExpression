...
{
    public abstract class SqrtFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<SqrtFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected SqrtFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(SqrtFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is SqrtFunctionExpression exp && Equals(exp);
