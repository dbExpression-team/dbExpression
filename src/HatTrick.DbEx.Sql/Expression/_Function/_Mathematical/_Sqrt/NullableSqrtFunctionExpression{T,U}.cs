...
{
    public abstract class NullableSqrtFunctionExpression<TValue, TNullableValue> : SqrtFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableSqrtFunctionExpression(IExpressionElement expression)
