...
{
    public abstract class SquareFunctionExpression<TValue> : SquareFunctionExpression,
        IExpressionElement<TValue>,
        AnyElement<TValue>
    {
        #region constructors
        protected SquareFunctionExpression(IExpressionElement expression) : base(expression, typeof(TValue))
        {
