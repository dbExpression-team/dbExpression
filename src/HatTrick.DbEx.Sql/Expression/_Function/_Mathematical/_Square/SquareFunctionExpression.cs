...
{
    public abstract class SquareFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<SquareFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected SquareFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region to string
        public override string? ToString() => $"SQUARE({expression})";
        #endregion

        #region equals
        public bool Equals(SquareFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is SquareFunctionExpression exp && Equals(exp);
