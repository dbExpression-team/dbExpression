...
{
    public abstract class NullableSquareFunctionExpression<TValue, TNullableValue> : SquareFunctionExpression,
        IExpressionElement<TValue, TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableSquareFunctionExpression(IExpressionElement expression)
