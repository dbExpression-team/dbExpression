...
{
    public abstract class TanFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<TanFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected TanFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(TanFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is TanFunctionExpression exp && Equals(exp);
