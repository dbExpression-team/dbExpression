...
{
    public abstract class NullableTanFunctionExpression<TValue, TNullableValue> : TanFunctionExpression,
        IExpressionElement<TValue, TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableTanFunctionExpression(IExpressionElement expression)
