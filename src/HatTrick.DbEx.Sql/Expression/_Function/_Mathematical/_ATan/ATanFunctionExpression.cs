...
{
    public abstract class ATanFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<ATanFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected ATanFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region to string
        public override string? ToString() => $"ATAN({expression})";
        #endregion

        #region equals
        public bool Equals(ATanFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is ATanFunctionExpression exp && Equals(exp);
