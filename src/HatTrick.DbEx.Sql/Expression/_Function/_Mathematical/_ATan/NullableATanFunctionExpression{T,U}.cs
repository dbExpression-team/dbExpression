...
{
    public abstract class NullableATanFunctionExpression<TValue, TNullableValue> : ATanFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableATanFunctionExpression(IExpressionElement expression)
