...
{
    public abstract class NullableSinFunctionExpression<TValue, TNullableValue> : SinFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableSinFunctionExpression(IExpressionElement expression)
