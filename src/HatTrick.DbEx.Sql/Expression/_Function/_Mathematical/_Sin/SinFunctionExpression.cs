...
{
    public abstract class SinFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<SinFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected SinFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(SinFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is SinFunctionExpression exp && Equals(exp);
