...
{
    public abstract class CosFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<CosFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected CosFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(CosFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is CosFunctionExpression exp && Equals(exp);
