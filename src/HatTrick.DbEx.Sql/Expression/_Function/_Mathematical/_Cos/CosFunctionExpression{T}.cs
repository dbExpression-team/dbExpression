...
{
    public abstract class CosFunctionExpression<TValue> : CosFunctionExpression,
        IExpressionElement<TValue>,
        AnyElement<TValue>
    {
        #region constructors
        protected CosFunctionExpression(IExpressionElement expression) : base(expression, typeof(TValue))
        {
