...
{
    public abstract class TrimFunctionExpression : DataTypeFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<TrimFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected TrimFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
