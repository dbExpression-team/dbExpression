...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableInt32CoalesceFunctionExpression
    {
        ...
        #region TValue
        #region int
        public static FilterExpressionSet operator ==(NullableInt32CoalesceFunctionExpression a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32CoalesceFunctionExpression a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32CoalesceFunctionExpression a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32CoalesceFunctionExpression a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32CoalesceFunctionExpression a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32CoalesceFunctionExpression a, int b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new Int32ExpressionMediator(new LiteralExpression<int>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(int a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(int a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(int a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(int a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(int a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(int a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new Int32ExpressionMediator(new LiteralExpression<int>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableInt32CoalesceFunctionExpression a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableInt32CoalesceFunctionExpression a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableInt32CoalesceFunctionExpression a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableInt32CoalesceFunctionExpression a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableInt32CoalesceFunctionExpression a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableInt32CoalesceFunctionExpression a, int? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(a), new NullableInt32ExpressionMediator(new LiteralExpression<int?>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(int? a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(int? a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(int? a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(int? a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(int? a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(int? a, NullableInt32CoalesceFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableInt32ExpressionMediator(new LiteralExpression<int?>(a)), new NullableInt32ExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        #endregion
