...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class ByteAbsFunctionExpression
    {
        ...
        public static FilterExpressionSet operator ==(ByteAbsFunctionExpression a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression<byte>(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(ByteAbsFunctionExpression a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression<byte>(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(ByteAbsFunctionExpression a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression<byte>(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator >(ByteAbsFunctionExpression a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression<byte>(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator <=(ByteAbsFunctionExpression a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression<byte>(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >=(ByteAbsFunctionExpression a, (string TableName, string FieldName) b) => new(new FilterExpression<bool?>(a, new AliasExpression<byte>(b), FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        #endregion
    }
}
