...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableByteAbsFunctionExpression
    {
        ...
        #region DBNull
        public static FilterExpression operator ==(NullableByteAbsFunctionExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<byte?>(b), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(NullableByteAbsFunctionExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<byte?>(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(DBNull a, NullableByteAbsFunctionExpression b) => new FilterExpression<bool?>(new LiteralExpression<byte?>(a), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(DBNull a, NullableByteAbsFunctionExpression b) => new FilterExpression<bool?>(new LiteralExpression<byte?>(a), b, FilterExpressionOperator.NotEqual);
        #endregion
