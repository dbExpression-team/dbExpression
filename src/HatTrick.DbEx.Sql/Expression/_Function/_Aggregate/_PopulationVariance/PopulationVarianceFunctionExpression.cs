...
namespace HatTrick.DbEx.Sql.Expression
{
        ...
        IEquatable<PopulationVarianceFunctionExpression>
    {
        ...
        #region constructors
        protected PopulationVarianceFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        public override bool Equals(object? obj)
            => obj is PopulationVarianceFunctionExpression exp && Equals(exp);
