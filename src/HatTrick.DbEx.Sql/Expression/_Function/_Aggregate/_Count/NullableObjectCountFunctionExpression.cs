...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region constructors
        public NullableObjectCountFunctionExpression(AnyElement expression) : base(expression)
        {
        ...
        #region equals
        public bool Equals(NullableObjectCountFunctionExpression? obj)
            => obj is not null && base.Equals(obj);

        public override bool Equals(object? obj)
            => obj is NullableObjectCountFunctionExpression exp && Equals(exp);
