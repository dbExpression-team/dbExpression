...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableObjectAverageFunctionExpression
    {
        ...
        #region DBNull
        public static FilterExpression operator ==(NullableObjectAverageFunctionExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<object?>(b), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(NullableObjectAverageFunctionExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<object?>(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(DBNull a, NullableObjectAverageFunctionExpression b) => new FilterExpression<bool?>(new LiteralExpression<object?>(a), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(DBNull a, NullableObjectAverageFunctionExpression b) => new FilterExpression<bool?>(new LiteralExpression<object?>(a), b, FilterExpressionOperator.NotEqual);
        #endregion
