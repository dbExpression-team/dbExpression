...
namespace HatTrick.DbEx.Sql.Expression
{
        ...
        IEquatable<VarianceFunctionExpression>
    {
        ...
        #region constructors
        protected VarianceFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        public override bool Equals(object? obj)
            => obj is VarianceFunctionExpression exp && Equals(exp);
