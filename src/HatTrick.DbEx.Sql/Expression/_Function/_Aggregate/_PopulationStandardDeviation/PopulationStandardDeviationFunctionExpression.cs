...
namespace HatTrick.DbEx.Sql.Expression
{
        ...
        IEquatable<PopulationStandardDeviationFunctionExpression>
    {
        ...
        #region constructors
        protected PopulationStandardDeviationFunctionExpression(IExpressionElement expression, Type declaredType, bool isDistinct) : this(expression, declaredType, isDistinct, null)
        {

        }

        protected PopulationStandardDeviationFunctionExpression(IExpressionElement expression, Type declaredType, bool isDistinct, string alias) : base(expression, declaredType, alias)
        {
