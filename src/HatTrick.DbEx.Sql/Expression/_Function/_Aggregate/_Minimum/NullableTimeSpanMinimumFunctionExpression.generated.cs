...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    public partial class NullableTimeSpanMinimumFunctionExpression
    {
        ...
        #region DBNull
        public static FilterExpression operator ==(NullableTimeSpanMinimumFunctionExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<TimeSpan?>(b), FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(NullableTimeSpanMinimumFunctionExpression a, DBNull b) => new FilterExpression<bool?>(a, new LiteralExpression<TimeSpan?>(b), FilterExpressionOperator.NotEqual);
        public static FilterExpression operator ==(DBNull a, NullableTimeSpanMinimumFunctionExpression b) => new FilterExpression<bool?>(new LiteralExpression<TimeSpan?>(a), b, FilterExpressionOperator.Equal);
        public static FilterExpression operator !=(DBNull a, NullableTimeSpanMinimumFunctionExpression b) => new FilterExpression<bool?>(new LiteralExpression<TimeSpan?>(a), b, FilterExpressionOperator.NotEqual);
        #endregion
