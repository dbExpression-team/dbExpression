...
{
    public abstract class LengthFunctionExpression : ConversionFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<LengthFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected LengthFunctionExpression(IExpressionElement expression, Type convertToType)
            : base(convertToType)
        {
