...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region constructors
        public NullableDateTimeOffsetCastFunctionExpression(ExpressionContainer expression, ExpressionContainer convertToDbType) : base(expression, convertToDbType)
        {
        }
        #endregion
