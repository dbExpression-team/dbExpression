...
namespace HatTrick.DbEx.Sql.Expression
{
    ...
    {
        #region constructors
        public NullableDoubleCastFunctionExpression(NullableExpressionMediator<double> expression, ExpressionContainer convertToDbType) : base(expression, convertToDbType)
        {
        }
        #endregion
