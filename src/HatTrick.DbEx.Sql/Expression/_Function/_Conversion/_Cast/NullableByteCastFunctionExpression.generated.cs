...
namespace HatTrick.DbEx.Sql.Expression
{
    public partial class NullableByteCastFunctionExpression
    {
        ...
        #region TValue
        #region byte
        public static FilterExpressionSet operator ==(NullableByteCastFunctionExpression a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteCastFunctionExpression a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteCastFunctionExpression a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteCastFunctionExpression a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteCastFunctionExpression a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteCastFunctionExpression a, byte b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new ByteExpressionMediator(new LiteralExpression<byte>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(byte a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(byte a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(byte a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(byte a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(byte a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(byte a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new ByteExpressionMediator(new LiteralExpression<byte>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(NullableByteCastFunctionExpression a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(NullableByteCastFunctionExpression a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(NullableByteCastFunctionExpression a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(NullableByteCastFunctionExpression a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(NullableByteCastFunctionExpression a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(NullableByteCastFunctionExpression a, byte? b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(a), new NullableByteExpressionMediator(new LiteralExpression<byte?>(b)), FilterExpressionOperator.GreaterThanOrEqual));

        public static FilterExpressionSet operator ==(byte? a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.Equal));
        public static FilterExpressionSet operator !=(byte? a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.NotEqual));
        public static FilterExpressionSet operator <(byte? a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThan));
        public static FilterExpressionSet operator <=(byte? a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.LessThanOrEqual));
        public static FilterExpressionSet operator >(byte? a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThan));
        public static FilterExpressionSet operator >=(byte? a, NullableByteCastFunctionExpression b) => new FilterExpressionSet(new FilterExpression<bool?>(new NullableByteExpressionMediator(new LiteralExpression<byte?>(a)), new NullableByteExpressionMediator(b), FilterExpressionOperator.GreaterThanOrEqual));
        #endregion
        #endregion
