...
{
    public abstract class NullableLengthFunctionExpression<TValue, TNullableValue> : LengthFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableLengthFunctionExpression(NullableStringElement expression)
