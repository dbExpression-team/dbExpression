...
{
    public abstract class LeftFunctionExpression : StringFunctionExpression,
        ...
        IEquatable<LeftFunctionExpression>
    {
        ...
        #region constructors
        protected LeftFunctionExpression(IExpressionElement expression, AnyElement characterCount, Type declaredType)
            : base(declaredType)
        {
