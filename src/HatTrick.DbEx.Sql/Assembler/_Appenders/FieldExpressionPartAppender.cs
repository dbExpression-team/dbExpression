...
{
    public class FieldExpressionPartAppender : PartAppender<FieldExpression>
    {
        public override void AppendPart(FieldExpression expression, ISqlStatementBuilder builder, AssemblyContext context)
        {
