...
namespace HatTrick.DbEx.Sql.Assembler
{
        ...
        IDbExpressionAssemblyPartAssembler<FilterExpressionSet>
    {
        ...
        {
            return expressionPart is FilterExpressionSet ?
                Assemble((FilterExpressionSet)expressionPart, builder, overrides)
                :
                Assemble((FilterExpression)expressionPart, builder, overrides);
        }

        public string Assemble(FilterExpressionSet expressionPart, ISqlStatementBuilder builder, AssemblerOverrides overrides)
        {
        ...
        public string Assemble(FilterExpression expressionPart, ISqlStatementBuilder builder, AssemblerOverrides overrides)
        {
