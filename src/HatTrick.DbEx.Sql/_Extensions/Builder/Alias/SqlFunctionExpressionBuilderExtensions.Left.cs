...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/string/left?version=0.9.5">read the docs on LEFT</see></para>
        /// </summary>
        ...
        public static NullableStringLeftFunctionExpression Left(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element, int characterCount)
        ...
        /// <returns><see cref="NullableStringLeftFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{String}"/>?.</returns>
        public static NullableStringLeftFunctionExpression Left(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element, AnyElement<int> characterCount)
        ...
        /// </summary>
        /// <param name="element">An alias of an expression to take the number of characters from.</param>
        /// <param name="characterCount">An alias of an expression providing the number of characters to return from the left of <paramref name="element"/>.</param>
        /// <returns><see cref="NullableStringLeftFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{String}"/>?.</returns>
        public static NullableStringLeftFunctionExpression Left(this SqlFunctionExpressionBuilder _, StringElement element, (string TableName, string FieldName) characterCount)
        ...
        /// <param name="characterCount">An alias of an expression providing the number of characters to return from the left of <paramref name="element"/>.</param>
        /// <returns><see cref="NullableStringLeftFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{String}"/>?.</returns>
        public static NullableStringLeftFunctionExpression Left(this SqlFunctionExpressionBuilder _, NullableStringElement element, (string TableName, string FieldName) characterCount)
            => new(element, new AliasExpression<int?>(characterCount));
    }
}
