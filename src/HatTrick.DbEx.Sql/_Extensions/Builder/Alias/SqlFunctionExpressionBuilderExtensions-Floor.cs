...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/mathematical/floor?version=0.9.5">read the docs on FLOOR</see></para>
        /// </summary>
        ...
        public static NullableObjectFloorFunctionExpression Floor(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
