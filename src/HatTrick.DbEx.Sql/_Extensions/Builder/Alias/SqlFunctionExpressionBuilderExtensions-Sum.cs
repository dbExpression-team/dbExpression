...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/aggregate/sum?version=0.9.4">read the docs on SUM</see></para>
        /// </summary>
        ...
        public static NullableObjectSumFunctionExpression Sum(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
