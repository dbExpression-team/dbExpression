...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/aggregate/varp?version=0.9.5">read the docs on VARP</see></para>
        /// </summary>
        ...
        public static NullableSinglePopulationVarianceFunctionExpression VarP(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
