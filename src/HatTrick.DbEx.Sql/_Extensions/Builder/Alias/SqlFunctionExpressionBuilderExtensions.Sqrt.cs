...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href=https://dbexpression.com/rtd/reference/mssql/functions/mathematical/sqrt?version=0.9.5">read the docs on SQRT</see></para>
        /// </summary>
        ...
        public static NullableSingleSqrtFunctionExpression Sqrt(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
