...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/aggregate/stdev?version=0.9.4">read the docs on STDEV</see></para>
        /// </summary>
        ...
        public static NullableSingleStandardDeviationFunctionExpression StDev(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
