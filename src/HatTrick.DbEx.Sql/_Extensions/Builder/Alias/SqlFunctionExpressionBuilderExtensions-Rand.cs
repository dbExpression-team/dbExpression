...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://docs.microsoft.com/en-us/sql/t-sql/functions/rand-transact-sql">Microsoft docs on RAND</see></para>
        /// </summary>
        ...
        public static NullableSingleRandFunctionExpression Rand(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) seed)
            => new(new AliasExpression<int?>(seed));
    }
}
