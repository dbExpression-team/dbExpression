...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <returns><see cref="NullableStringTrimFunctionExpression"/> for use with any operation accepting a <see cref="AnyNullableString"/>.</returns>
        public static NullableStringTrimFunctionExpression Trim(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
