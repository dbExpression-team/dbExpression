...
namespace HatTrick.DbEx.Sql.Builder.Alias
{
    public static partial class SqlFunctionExpressionBuilderExtensions
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/aggregate/min?version=0.9.4">read the docs on MIN</see></para>
        /// </summary>
        ...
        public static NullableObjectMinimumFunctionExpression Min(this SqlFunctionExpressionBuilder _, (string TableName, string FieldName) element)
