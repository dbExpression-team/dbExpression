...
{
    public class AfterUpdateCommandPipelineEventContext : AfterCommandPipelineEventContext, IPipelineEventContext
    {
        ...
        public AfterUpdateCommandPipelineEventContext(UpdateQueryExpression expression, IDbCommand command)
