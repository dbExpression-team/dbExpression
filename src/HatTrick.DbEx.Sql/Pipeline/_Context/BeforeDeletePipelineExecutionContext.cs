...
namespace HatTrick.DbEx.Sql.Pipeline
{
    public class BeforeDeletePipelineExecutionContext : PipelineExecutionContext, IPipelineExecutionContext
    {
        ...
        public BeforeDeletePipelineExecutionContext(DatabaseConfiguration database, DeleteQueryExpression expression, IAppender appender, ISqlParameterBuilder parameterBuilder)
