...
namespace HatTrick.DbEx.Sql.Pipeline
{
    public class BeforeExecutionPipelineExecutionContext : PipelineExecutionContext, IPipelineExecutionContext
    {
        ...
        public BeforeExecutionPipelineExecutionContext(RuntimeSqlDatabaseConfiguration database, QueryExpression expression, SqlStatement statement, DbCommand command)
