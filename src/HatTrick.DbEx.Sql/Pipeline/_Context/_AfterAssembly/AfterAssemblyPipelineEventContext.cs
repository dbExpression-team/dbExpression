...
{
    public class AfterAssemblyPipelineEventContext : PipelineEventContext, IPipelineEventContext
    {
        public ISqlParameterBuilder ParameterBuilder { get; private set; }
        public SqlStatement SqlStatement { get; private set; }

        public AfterAssemblyPipelineEventContext(QueryExpression expression, ISqlParameterBuilder parameterBuilder, SqlStatement statement)
            : base(expression)
        {
