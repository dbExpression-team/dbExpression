...
namespace HatTrick.DbEx.Sql.Pipeline
{
    public class ExecutionPipelineFactory : IExecutionPipelineFactory
    {
        ...
        public PipelineEventActions<Func<AfterSelectPipelineExecutionContext, CancellationToken, Task>, Action<AfterSelectPipelineExecutionContext>, AfterSelectPipelineExecutionContext> AfterSelect { get; set; } = new AfterSelectEntityPipelineEventActions();
