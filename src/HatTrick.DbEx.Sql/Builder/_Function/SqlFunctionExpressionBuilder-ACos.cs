#region license
// Copyright (c) HatTrick Larccosine, LLC.  All rights reserved.
//
...
//
// The latest version of this file can be found at https://github.com/HatTrickLarccosine/db-ex
#endregion
...
namespace HatTrick.DbEx.Sql.Builder
{
    public partial class SqlFunctionExpressionBuilder
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/mathematical/acos?version=0.9.5">read the docs on ACOS</see></para>
        /// </summary>
        ...
        public SingleACosFunctionExpression ACos(Int16Element element)
            => new(element);
        ...
        public NullableSingleACosFunctionExpression ACos(NullableInt16Element element)
            => new(element);
        ...
        /// <returns><see cref="SingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleACosFunctionExpression ACos(Int32Element element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleACosFunctionExpression ACos(NullableInt32Element element)
            => new(element);
        ...
        /// <returns><see cref="SingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleACosFunctionExpression ACos(Int64Element element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleACosFunctionExpression ACos(NullableInt64Element element)
            => new(element);
        ...
        /// <returns><see cref="SingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleACosFunctionExpression ACos(SingleElement element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleACosFunctionExpression ACos(NullableSingleElement element)
            => new(element);
        ...
        /// <returns><see cref="SingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleACosFunctionExpression ACos(DoubleElement element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleACosFunctionExpression ACos(NullableDoubleElement element)
            => new(element);
        ...
        /// <returns><see cref="SingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleACosFunctionExpression ACos(DecimalElement element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleACosFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleACosFunctionExpression ACos(NullableDecimalElement element)
            => new(element);
    }
}
