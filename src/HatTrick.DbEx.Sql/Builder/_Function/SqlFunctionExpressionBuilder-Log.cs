...
namespace HatTrick.DbEx.Sql.Builder
{
    public partial class SqlFunctionExpressionBuilder
    {
        ...
        /// <para><see href="https://docs.microsoft.com/en-us/sql/t-sql/functions/log-transact-sql">Microsoft docs on LOG</see></para>
        /// </summary>
        ...
        public SingleLogFunctionExpression Log(Int16Element element)
            => new(element);
        ...
        public NullableSingleLogFunctionExpression Log(NullableInt16Element element)
            => new(element);
        ...
        /// <returns><see cref="SingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleLogFunctionExpression Log(Int32Element element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleLogFunctionExpression Log(NullableInt32Element element)
            => new(element);
        ...
        /// <returns><see cref="SingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleLogFunctionExpression Log(Int64Element element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleLogFunctionExpression Log(NullableInt64Element element)
            => new(element);
        ...
        /// <returns><see cref="SingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleLogFunctionExpression Log(SingleElement element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleLogFunctionExpression Log(NullableSingleElement element)
            => new(element);
        ...
        /// <para><see href="https://docs.microsoft.com/en-us/sql/t-sql/functions/log-transact-sql">Microsoft docs on LOG</see></para>
        /// </summary>
        /// <param name="element">An expression of type <see cref="AnyElement{Double}"/>, the value to use for calculating the log value.</param>
        /// <returns><see cref="SingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleLogFunctionExpression Log(DoubleElement element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleLogFunctionExpression Log(NullableDoubleElement element)
            => new(element);
        ...
        /// <returns><see cref="SingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>.</returns>
        public SingleLogFunctionExpression Log(DecimalElement element)
            => new(element);
        ...
        /// <returns><see cref="NullableSingleLogFunctionExpression"/> for use with any operation accepting a <see cref="AnyElement{Single}"/>?.</returns>
        public NullableSingleLogFunctionExpression Log(NullableDecimalElement element)
            => new(element);
    }
}
