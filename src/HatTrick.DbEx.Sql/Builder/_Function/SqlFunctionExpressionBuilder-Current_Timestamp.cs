...
namespace HatTrick.DbEx.Sql.Builder
{
    public partial class SqlFunctionExpressionBuilder
    {
        ...
        /// <para><see href="https://dbexpression.com/rtd/reference/mssql/functions/date-and-time/current-timestamp?version=0.9.4">read the docs on CURRENT_TIMESTAMP</see></para>
        /// </summary>
