...
namespace HatTrick.DbEx.Sql.Builder
{
    public class SelectEntitiesJoinExpressionBuilder<TEntity> : SelectJoinExpressionBuilder<SelectEntitiesContinuation<TEntity>>,
        ...
        WithAlias<JoinOn<SelectEntitiesContinuation<TEntity>>>
        where TEntity : class, IDbEntity, new()
    {
        ...
        #region methods
        /// <inheritdoc />
        JoinOn<SelectEntitiesContinuation<TEntity>> WithAlias<JoinOn<SelectEntitiesContinuation<TEntity>>>.As(string alias)
        {
            As(alias);
            return this;
        }
        ...
        /// <inheritdoc />
        SelectEntitiesContinuation<TEntity> JoinOn<SelectEntitiesContinuation<TEntity>>.On(AnyJoinOnExpression joinOn)
        {
            On(joinOn);
            return caller;
        }
