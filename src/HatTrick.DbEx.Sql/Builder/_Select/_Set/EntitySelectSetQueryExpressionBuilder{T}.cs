...
{
    public class EntitySelectSetQueryExpressionBuilder<TEntity> : SelectSetQueryExpressionBuilder
       where TEntity : class, IDbEntity, new()
    {
        ...
        #region methods
        protected override SelectEntities<T> CreateSelectEntitiesBuilder<T>()
        {
        ...
        protected override SelectEntity<T> CreateSelectEntityBuilder<T>()
        {
            if (typeof(TEntity) != typeof(T))
                throw new DbExpressionException($"Expected {typeof(T)} to be of type {typeof(TEntity)}");
            ...
            return (new SelectEntitySelectQueryExpressionBuilder<TEntity>(
                SelectQueryExpressionExecutionPipelineFactory,
                this,
                table
            ) as SelectEntity<T>)!;
