...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectEntitiesContinuation<TEntity> :
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TEntity : class, IDbEntity, new()
    {
        ...
        SelectEntitiesContinuation<TEntity> Where(AnyWhereExpression? where);
        ...
        SelectEntitiesOrderByContinuation<TEntity> OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <returns><see cref="SelectEntitiesOrderByContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        SelectEntitiesOrderByContinuation<TEntity> OrderBy(IEnumerable<AnyOrderByExpression>? orderBy);
        ...
        /// <returns><see cref="SelectEntitiesContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        SelectEntitiesContinuation<TEntity> GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectEntitiesContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        SelectEntitiesContinuation<TEntity> GroupBy(IEnumerable<AnyGroupByExpression>? groupBy);
        ...
        /// <returns><see cref="SelectEntitiesContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        SelectEntitiesContinuation<TEntity> Having(AnyHavingExpression? having);
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<SelectEntitiesContinuation<TEntity>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<SelectEntitiesContinuation<TEntity>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<SelectEntitiesContinuation<TEntity>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<SelectEntitiesContinuation<TEntity>>> FullJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="SelectEntitiesContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
        SelectEntitiesContinuation<TEntity> CrossJoin(AnyEntity entity);
    }
}
