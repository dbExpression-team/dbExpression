...
#pragma warning restore IDE1006 // Naming Styles
        : SelectDynamicsTermination
    {
        ...
        /// <returns><see cref="SelectValuesOffsetContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        ...
        SelectDynamicsOrderByContinuation GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectDynamicsOrderByContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsOrderByContinuation GroupBy(IEnumerable<AnyGroupByExpression> groupBy);
        ...
        /// <returns><see cref="SelectDynamicsOrderByContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsOrderByContinuation Having(AnyHavingExpression having);
    }
}
