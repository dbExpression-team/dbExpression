...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectDynamics<TDatabase>
...
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        /// <returns><see cref="SelectDynamics{TDatabase}"/>, a fluent continuation for constructing a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamics<TDatabase> Top(int value);
        ...
        /// </summary>
        /// <returns><see cref="SelectDynamics{TDatabase}"/>, a fluent continuation for constructing a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamics<TDatabase> Distinct();
