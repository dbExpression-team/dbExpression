...
#pragma warning disable IDE1006 // Naming Styles   
    public interface UnionSelectDynamicsInitiation
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="UnionSelectDynamicsContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectDynamicsContinuation Union();
        ...
        /// </summary>
        /// <returns><see cref="UnionSelectDynamicsContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectDynamicsContinuation UnionAll();
    }
}
