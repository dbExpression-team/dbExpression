...
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TDatabase : class, ISqlDatabaseRuntime
    {
        ...
        SelectValueContinuation<TDatabase, TValue> Where(AnyWhereClause? where);
        ...
        /// <returns><see cref="SelectValueContinuation{TDatabase, TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TDatabase, TValue> OrderBy(params AnyOrderByClause[] orderBy);
        ...
        /// <param name="orderBy">A list of expressions of type <see cref="AnyOrderByClause"/> indicating the order and direction for sorting.</param>
        /// <returns><see cref="SelectValueContinuation{TDatabase, TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TDatabase, TValue> OrderBy(IEnumerable<AnyOrderByClause>? orderBy);
        ...
        /// <returns><see cref="SelectValueContinuation{TDatabase, TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TDatabase, TValue> GroupBy(params AnyGroupByClause[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByClause"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectValueContinuation{TDatabase, TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TDatabase, TValue> GroupBy(IEnumerable<AnyGroupByClause>? groupBy);
        ...
        /// <returns><see cref="SelectValueContinuation{TDatabase, TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TDatabase, TValue> Having(AnyHavingClause? having);
        ...
        /// <returns><see cref="JoinOnWithAlias{SelectValueContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        JoinOnWithAlias<SelectValueContinuation<TDatabase, TValue>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// </summary>
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectValueContinuation{TDatabase, TValue}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        JoinOnWithAlias<SelectValueContinuation<TDatabase, TValue>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectValueContinuation{TDatabase, TValue}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        JoinOnWithAlias<SelectValueContinuation<TDatabase, TValue>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectValueContinuation{TDatabase, TValue}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        JoinOnWithAlias<SelectValueContinuation<TDatabase, TValue>> FullJoin(AnySelectSubquery subquery);
