...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectObject<TObject>
#pragma warning restore IDE1006 // Naming Styles
        where TObject : class?
    {
        ...
        SelectObjectContinuation<TObject> From<TEntity>(Table<TEntity> entity)
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="WithAlias{SelectObjectContinuation{TObject}}"/>, a fluent continuation for providing an alias for the subquery.</returns>
        WithAlias<SelectObjectContinuation<TObject>> From(AnySelectSubquery query);
    }
}
