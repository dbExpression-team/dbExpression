...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectObjectContinuation<TObject> :
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TObject : class?
    {
        ...
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> Where(AnyWhereExpression? where);
        ...
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <param name="orderBy">A list of expressions of type <see cref="AnyOrderByExpression"/> indicating the order and direction for sorting.</param>
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> OrderBy(IEnumerable<AnyOrderByExpression>? orderBy);
        ...
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> GroupBy(IEnumerable<AnyGroupByExpression>? groupBy);
        ...
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> Having(AnyHavingExpression? having);
        ...
        /// <returns><see cref="JoinOn{SelectObjectContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        JoinOn<SelectObjectContinuation<TObject>> InnerJoin(AnyEntity entity);
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        WithAlias<JoinOn<SelectObjectContinuation<TObject>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        JoinOn<SelectObjectContinuation<TObject>> LeftJoin(AnyEntity entity);
        ...
        /// </summary>
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        WithAlias<JoinOn<SelectObjectContinuation<TObject>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        JoinOn<SelectObjectContinuation<TObject>> RightJoin(AnyEntity entity);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        WithAlias<JoinOn<SelectObjectContinuation<TObject>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        JoinOn<SelectObjectContinuation<TObject>> FullJoin(AnyEntity entity);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TObject"/> value.</returns>
        WithAlias<JoinOn<SelectObjectContinuation<TObject>>> FullJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="SelectObjectContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TObject"/> value.</returns>
        SelectObjectContinuation<TObject> CrossJoin(AnyEntity entity);
    }
}
