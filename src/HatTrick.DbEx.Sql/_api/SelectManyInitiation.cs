...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectManyInitiation
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        SelectEntities<TEntity> SelectMany<TEntity>()
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TEnum}"/>, a fluent builder for constructing a sql SELECT query expression for a list of <typeparamref name="TEnum"/> entities.</returns>
        SelectValues<TEnum> SelectMany<TEnum>(AnyElement<TEnum> element)
        ...
        SelectValues<object>? SelectMany(ObjectElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<object?> SelectMany(NullableObjectElement element);
        ...
        SelectObjects<T> SelectMany<T>(ObjectElement<T> element)
            where T : class?;
        #endregion
        ...
        /// <returns><see cref="SelectValues{T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        SelectValues<T> SelectMany<T>(AliasedElement<T> element);
        ...
        SelectValues<bool> SelectMany(AnyElement<bool> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<byte> SelectMany(AnyElement<byte> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<DateTime> SelectMany(AnyElement<DateTime> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<DateTimeOffset> SelectMany(AnyElement<DateTimeOffset> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<decimal> SelectMany(AnyElement<decimal> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<double> SelectMany(AnyElement<double> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<Guid> SelectMany(AnyElement<Guid> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<short> SelectMany(AnyElement<short> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<int> SelectMany(AnyElement<int> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<long> SelectMany(AnyElement<long> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<float> SelectMany(AnyElement<float> element);
        ...
        SelectValues<string> SelectMany(StringElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<string?> SelectMany(NullableStringElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectValues{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValues<TimeSpan> SelectMany(AnyElement<TimeSpan> element);
        ...
        SelectDynamics SelectMany(AnyElement element1, AnyElement element2, params AnyElement[] elements);
        ...
        /// <returns><see cref="SelectDynamics"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectDynamics SelectMany(IEnumerable<AnyElement> elements);
        ...
        /// <returns><see cref="SelectDynamics"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectDynamics SelectMany(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements);
        #endregion
    }
}
