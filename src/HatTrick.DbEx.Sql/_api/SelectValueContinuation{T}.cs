...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectValueContinuation<TValue> : 
#pragma warning restore IDE1006 // Naming Styles
        SelectValueTermination<TValue>,
        UnionSelectValuesInitiation<TValue>
    {
        /// <summary>
        ...
        SelectValueContinuation<TValue> Where(AnyWhereExpression? where);
        ...
        /// <returns><see cref="SelectValueContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TValue> OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <param name="orderBy">A list of expressions of type <see cref="AnyOrderByExpression"/> indicating the order and direction for sorting.</param>
        /// <returns><see cref="SelectValueContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TValue> OrderBy(IEnumerable<AnyOrderByExpression>? orderBy);
        ...
        /// <returns><see cref="SelectValueContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TValue> GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectValueContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TValue> GroupBy(IEnumerable<AnyGroupByExpression>? groupBy);
        ...
        /// <returns><see cref="SelectValueContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TValue> Having(AnyHavingExpression? having);
        ...
        /// <returns><see cref="JoinOn{SelectValueContinuation{TValue}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectValueContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        WithAlias<JoinOn<SelectValueContinuation<TValue>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// </summary>
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectValueContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        WithAlias<JoinOn<SelectValueContinuation<TValue>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectValueContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        WithAlias<JoinOn<SelectValueContinuation<TValue>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectValueContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        WithAlias<JoinOn<SelectValueContinuation<TValue>>> FullJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="SelectValueContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a single <typeparamref name="TValue"/> value.</returns>
        SelectValueContinuation<TValue> CrossJoin(AnyEntity entity);
    }
}
