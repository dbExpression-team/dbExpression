...
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        /// <returns><see cref="JoinOnWithAlias{SelectEntitiesContinuation{TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
        ...
        /// </summary>
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectValueContinuation{TValue}}"/>, a fluent continuation for the construction of a sql JOIN expression for a single <typeparamref name="TValue"/> value.</returns>
