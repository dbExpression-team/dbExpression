...
#pragma warning disable IDE1006 // Naming Styles   
    public interface UnionSelectEntitiesInitiation<TDatabase, TEntity>
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TEntity : class, IDbEntity, new()
    {
        ...
        UnionSelectEntitiesContinuation<TDatabase, TEntity> Union();
        ...
        /// </summary>
        /// <returns><see cref="UnionSelectEntitiesContinuation{TDatabase, TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectEntitiesContinuation<TDatabase, TEntity> UnionAll();
    }
}
