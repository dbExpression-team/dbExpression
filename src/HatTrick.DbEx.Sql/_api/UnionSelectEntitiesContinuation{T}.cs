...
#pragma warning disable IDE1006 // Naming Styles
    public interface UnionSelectEntitiesContinuation<TEntity> :
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TEntity : class, IDbEntity, new()
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="SelectEntities{TEntity}"/>, a fluent builder for constructing a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        SelectEntities<TEntity> SelectOne();
        ...
        /// <typeparam name="TEntity">The entity type to select.</typeparam>
        SelectEntities<TEntity> SelectMany();
    }
}
