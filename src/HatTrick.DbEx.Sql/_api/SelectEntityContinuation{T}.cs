...
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TEntity : class, IDbEntity, new()
    {
        ...
        SelectEntityContinuation<TEntity> Where(AnyWhereExpression where);
        ...
        /// <returns><see cref="SelectEntityContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TEntity> OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <param name="orderBy">A list of expressions of type <see cref="AnyOrderByExpression"/> indicating the order and direction for sorting.</param>
        /// <returns><see cref="SelectEntityContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TEntity> OrderBy(IEnumerable<AnyOrderByExpression> orderBy);
        ...
        /// <returns><see cref="SelectEntityContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TEntity> GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectEntityContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TEntity> GroupBy(IEnumerable<AnyGroupByExpression> groupBy);
        ...
        /// <returns><see cref="SelectEntityContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TEntity> Having(AnyHavingExpression having);
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectEntityContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        WithAlias<JoinOn<SelectEntityContinuation<TEntity>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectEntityContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        WithAlias<JoinOn<SelectEntityContinuation<TEntity>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectEntityContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        WithAlias<JoinOn<SelectEntityContinuation<TEntity>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectEntityContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        WithAlias<JoinOn<SelectEntityContinuation<TEntity>>> FullJoin(AnySelectSubquery subquery);
        ...
        /// </summary>
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="SelectEntityContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TEntity"/> entities.</returns>
