...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectDynamicsContinuation :
#pragma warning restore IDE1006 // Naming Styles
        ...
        SelectDynamicsTermination
    {
        ...
        /// <returns><see cref="SelectDynamicsContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsContinuation Where(AnyWhereExpression? where);
        ...
        /// <returns><see cref="SelectDynamicsOrderByContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsOrderByContinuation OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <returns><see cref="SelectDynamicsOrderByContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsOrderByContinuation OrderBy(IEnumerable<AnyOrderByExpression>? orderBy);
        ...
        /// <returns><see cref="SelectDynamicsContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsContinuation GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectDynamicsContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsContinuation GroupBy(IEnumerable<AnyGroupByExpression>? groupBy);
        ...
        /// <returns><see cref="SelectDynamicsContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="dynamic"/> values.</returns>
        SelectDynamicsContinuation Having(AnyHavingExpression? having);
        ...
        /// <returns><see cref="JoinOn{SelectDynamicsContinuation}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="dynamic"/> values.</returns>
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectDynamicsContinuation}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="dynamic"/> values.</returns>
        WithAlias<JoinOn<SelectDynamicsContinuation>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectDynamicsContinuation}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="dynamic"/> values.</returns>
        WithAlias<JoinOn<SelectDynamicsContinuation>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectDynamicsContinuation}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="dynamic"/> values.</returns>
        WithAlias<JoinOn<SelectDynamicsContinuation>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectDynamicsContinuation}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="dynamic"/> values.</returns>
        WithAlias<JoinOn<SelectDynamicsContinuation>> FullJoin(AnySelectSubquery subquery);
