...
#pragma warning disable IDE1006 // Naming Styles   
    public interface UnionSelectObjectsInitiation<TObject>
#pragma warning restore IDE1006 // Naming Styles
        where TObject : class?
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="UnionSelectObjectsContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectObjectsContinuation<TObject> Union();
        ...
        /// </summary>
        /// <returns><see cref="UnionSelectObjectsContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectObjectsContinuation<TObject> UnionAll();
    }
}
