...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectObjectsContinuation<TObject> :
#pragma warning restore IDE1006 // Naming Styles
        UnionSelectObjectsInitiation<TObject>,
        ...
        where TObject : class?
    {
        ...
        /// <returns><see cref="SelectObjectsContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsContinuation<TObject> Where(AnyWhereExpression? where);
        ...
        /// <returns><see cref="SelectObjectsOrderByContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsOrderByContinuation<TObject> OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <returns><see cref="SelectObjectsOrderByContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsOrderByContinuation<TObject> OrderBy(IEnumerable<AnyOrderByExpression>? orderBy);
        ...
        /// <returns><see cref="SelectObjectsContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsContinuation<TObject> GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectObjectsContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsContinuation<TObject> GroupBy(IEnumerable<AnyGroupByExpression>? groupBy);
        ...
        /// <returns><see cref="SelectObjectsContinuation{TObject}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsContinuation<TObject> Having(AnyHavingExpression? having);
        ...
        /// <returns><see cref="JoinOn{SelectObjectsContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        JoinOn<SelectObjectsContinuation<TObject>> InnerJoin(AnyEntity entity);
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectsContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        WithAlias<JoinOn<SelectObjectsContinuation<TObject>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectsContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        JoinOn<SelectObjectsContinuation<TObject>> LeftJoin(AnyEntity entity);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectsContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        WithAlias<JoinOn<SelectObjectsContinuation<TObject>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectsContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        JoinOn<SelectObjectsContinuation<TObject>> RightJoin(AnyEntity entity);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectsContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        WithAlias<JoinOn<SelectObjectsContinuation<TObject>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectsContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        JoinOn<SelectObjectsContinuation<TObject>> FullJoin(AnyEntity entity);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectObjectsContinuation{TObject}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        WithAlias<JoinOn<SelectObjectsContinuation<TObject>>> FullJoin(AnySelectSubquery subquery);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{SelectObjectsContinuation{TObject}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TObject"/> Objects.</returns>
        SelectObjectsContinuation<TObject> CrossJoin(AnyEntity entity);
    }
}
