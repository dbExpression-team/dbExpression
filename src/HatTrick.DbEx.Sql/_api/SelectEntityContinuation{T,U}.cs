...
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TEntity : class, IDbEntity, new()
    {
        ...
        SelectEntityContinuation<TDatabase, TEntity> Where(AnyWhereClause where);
        ...
        /// <returns><see cref="SelectEntityContinuation{TDatabase, TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TDatabase, TEntity> OrderBy(params AnyOrderByClause[] orderBy);
        ...
        /// <param name="orderBy">A list of expressions of type <see cref="AnyOrderByClause"/> indicating the order and direction for sorting.</param>
        /// <returns><see cref="SelectEntityContinuation{TDatabase, TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TDatabase, TEntity> OrderBy(IEnumerable<AnyOrderByClause> orderBy);
        ...
        /// <returns><see cref="SelectEntityContinuation{TDatabase, TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TDatabase, TEntity> GroupBy(params AnyGroupByClause[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByClause"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectEntityContinuation{TDatabase, TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TDatabase, TEntity> GroupBy(IEnumerable<AnyGroupByClause> groupBy);
        ...
        /// <returns><see cref="SelectEntityContinuation{TDatabase, TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression for a <typeparamref name="TEntity"/> entity.</returns>
        SelectEntityContinuation<TDatabase, TEntity> Having(AnyHavingClause having);
        ...
        /// <returns><see cref="JoinOnWithAlias{SelectEntityContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        JoinOnWithAlias<SelectEntityContinuation<TDatabase, TEntity>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectEntityContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        JoinOnWithAlias<SelectEntityContinuation<TDatabase, TEntity>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectEntityContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        JoinOnWithAlias<SelectEntityContinuation<TDatabase, TEntity>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="JoinOnWithAlias{SelectEntityContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for a <typeparamref name="TEntity"/> entity.</returns>
        JoinOnWithAlias<SelectEntityContinuation<TDatabase, TEntity>> FullJoin(AnySelectSubquery subquery);
