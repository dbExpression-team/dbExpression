...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectValuesContinuation<TValue> :
#pragma warning restore IDE1006 // Naming Styles
        ...
        UnionSelectValuesInitiation<TValue>
    {
        ...
        SelectValuesContinuation<TValue> Where(AnyWhereExpression? where);
        ...
        SelectValuesOrderByContinuation<TValue> OrderBy(params AnyOrderByExpression[] orderBy);
        ...
        /// <returns><see cref="SelectValuesOrderByContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TValue"/> values.</returns>
        SelectValuesOrderByContinuation<TValue> OrderBy(IEnumerable<AnyOrderByExpression>? orderBy);
        ...
        SelectValuesContinuation<TValue> GroupBy(params AnyGroupByExpression[] groupBy);
        ...
        /// <param name="groupBy">A list of expressions of type <see cref="AnyGroupByExpression"/> specifying how to group the selected results.</param>
        /// <returns><see cref="SelectValuesContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TValue"/> values.</returns>
        SelectValuesContinuation<TValue> GroupBy(IEnumerable<AnyGroupByExpression>? groupBy);
        ...
        /// <returns><see cref="SelectValuesContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TValue"/> values.</returns>
        SelectValuesContinuation<TValue> Having(AnyHavingExpression? having);
        ...
        /// <returns><see cref="WithAlias{JoinOn{SelectValuesContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TValue"/> values.</returns>
        WithAlias<JoinOn<SelectValuesContinuation<TValue>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectValuesContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TValue"/> values.</returns>
        WithAlias<JoinOn<SelectValuesContinuation<TValue>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectValuesContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TValue"/> values.</returns>
        WithAlias<JoinOn<SelectValuesContinuation<TValue>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{SelectValuesContinuation{TValue}}}"/>, a fluent continuation for the construction of a sql JOIN expression for a list of <typeparamref name="TValue"/> values.</returns>
        WithAlias<JoinOn<SelectValuesContinuation<TValue>>> FullJoin(AnySelectSubquery subquery);
