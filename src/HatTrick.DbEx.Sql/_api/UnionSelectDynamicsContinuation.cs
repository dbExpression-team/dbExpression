...
#pragma warning disable IDE1006 // Naming Styles
    public interface UnionSelectDynamicsContinuation :
#pragma warning restore IDE1006 // Naming Styles
        IExpressionBuilder 
    {
        ...
        SelectDynamics SelectOne(AnyElement element1, AnyElement element2, params AnyElement[] elements);
        ...
        /// <returns><see cref="SelectDynamics"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectDynamics SelectOne(IEnumerable<AnyElement> elements);
        ...
        /// <returns><see cref="SelectDynamics"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectDynamics SelectOne(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements);
