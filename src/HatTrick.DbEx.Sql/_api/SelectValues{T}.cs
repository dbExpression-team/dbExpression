...
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        SelectValuesContinuation<TValue> From<TEntity>(Table<TEntity> entity)
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="WithAlias{SelectValuesContinuation{TValue}}"/>, a fluent continuation for providing an alias for the subquery.</returns>
        WithAlias<SelectValuesContinuation<TValue>> From(AnySelectSubquery query);
    }
}
