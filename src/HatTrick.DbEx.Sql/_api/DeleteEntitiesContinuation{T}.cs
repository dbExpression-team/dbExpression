...
#pragma warning restore IDE1006 // Naming Styles
        where TEntity : class, IDbEntity
    {
        ...
        DeleteEntitiesContinuation<TEntity> Where(AnyWhereExpression where);
        ...
        /// <returns><see cref="WithAlias{JoinOn{DeleteEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for deleting <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<DeleteEntitiesContinuation<TEntity>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{DeleteEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for deleting <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<DeleteEntitiesContinuation<TEntity>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{DeleteEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for deleting <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<DeleteEntitiesContinuation<TEntity>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{DeleteEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for deleting <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<DeleteEntitiesContinuation<TEntity>>> FullJoin(AnySelectSubquery subquery);
