...
#pragma warning disable IDE1006 // Naming Styles
    public interface UpdateEntitiesContinuation<TDatabase, TEntity> : UpdateEntitiesTermination<TDatabase, TEntity>
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TEntity : class, IDbEntity
    {
        ...
        /// <returns><see cref="JoinOn{UpdateEntitiesContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        JoinOn<UpdateEntitiesContinuation<TDatabase, TEntity>> InnerJoin(AnyEntity entity);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{UpdateEntitiesContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        JoinOn<UpdateEntitiesContinuation<TDatabase, TEntity>> LeftJoin(AnyEntity entity);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{UpdateEntitiesContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        JoinOn<UpdateEntitiesContinuation<TDatabase, TEntity>> RightJoin(AnyEntity entity);
        ...
        /// <param name="entity">Any expression of type <see cref="AnyEntity"/> specifying the database entity to join to.</param>
        /// <returns><see cref="JoinOn{UpdateEntitiesContinuation{TDatabase, TEntity}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        JoinOn<UpdateEntitiesContinuation<TDatabase, TEntity>> FullJoin(AnyEntity entity);
        ...
        UpdateEntitiesContinuation<TDatabase, TEntity> CrossJoin(AnyEntity entity);
    }
}
