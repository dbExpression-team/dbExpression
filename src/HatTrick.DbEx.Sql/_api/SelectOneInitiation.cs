...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectOneInitiation
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        SelectEntity<TEntity> SelectOne<TEntity>()
        ...
        SelectValue<TEnum> SelectOne<TEnum>(AnyElement<TEnum> element)
        ...
        SelectValue<object>? SelectOne(ObjectElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{object}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<object?> SelectOne(NullableObjectElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectObject{T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        SelectObject<T> SelectOne<T>(ObjectElement<T> element)
            where T : class?;
        #endregion
        ...
        SelectValue<TValue> SelectOne<TValue>(AliasedElement<TValue> element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<bool> SelectOne(AnyElement<bool> element);
        ...
        ///</param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<byte> SelectOne(AnyElement<byte> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<DateTime> SelectOne(AnyElement<DateTime> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<DateTime?> SelectOne(AnyElement<DateTime?> field);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<DateTimeOffset> SelectOne(AnyElement<DateTimeOffset> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<decimal> SelectOne(AnyElement<decimal> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<double> SelectOne(AnyElement<double> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<Guid> SelectOne(AnyElement<Guid> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<short> SelectOne(AnyElement<short> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<int> SelectOne(AnyElement<int> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<long> SelectOne(AnyElement<long> element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<float> SelectOne(AnyElement<float> element);
        ...
        SelectValue<string> SelectOne(StringElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{String}"/>?, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<string?> SelectOne(NullableStringElement element);
        ...
        /// </param>
        /// <returns><see cref="SelectValue{TValue}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectValue<TimeSpan> SelectOne(AnyElement<TimeSpan> element);
        ...
        SelectDynamic SelectOne(AnyElement element1, AnyElement element2, params AnyElement[] elements);
        ...
        /// <returns><see cref="SelectDynamic{ TDatabase }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectDynamic SelectOne(IEnumerable<AnyElement> elements);
        ...
        /// <returns><see cref="SelectDynamic{ TDatabase }"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        SelectDynamic SelectOne(IEnumerable<AnyElement> elements, params AnyElement[] additionalElements);
        #endregion
    }
}
