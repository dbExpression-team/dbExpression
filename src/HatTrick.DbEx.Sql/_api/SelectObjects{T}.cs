...
#pragma warning disable IDE1006 // Naming Styles
    public interface SelectObjects<TObject>
#pragma warning restore IDE1006 // Naming Styles
        where TObject : class?
    {
        ...
        /// <returns><see cref="SelectObjects{TValue}"/>, a fluent continuation for constructing a sql SELECT query expression for a list of <typeparamref name="TObject"/> values.</returns>
        SelectObjects<TObject> Top(int value);
        ...
        /// </summary>
        /// <returns><see cref="SelectObjects{TValue}"/>, a fluent continuation for constructing a sql SELECT query expression for a list of <typeparamref name="TObject"/> values.</returns>
        SelectObjects<TObject> Distinct();
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="SelectEntitiesContinuation{TValue}"/>, a fluent continuation for the construction of a sql SELECT query expression for a list of <typeparamref name="TObject"/> values.</returns>
        SelectObjectsContinuation<TObject> From<TEntity>(Table<TEntity> entity)
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="WithAlias{SelectObjectsContinuation{TObject}}"/>, a fluent continuation for providing an alias for the subquery.</returns>
        WithAlias<SelectObjectsContinuation<TObject>> From(AnySelectSubquery query);
    }
}
