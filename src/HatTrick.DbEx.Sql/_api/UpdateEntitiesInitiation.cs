...
#pragma warning disable IDE1006 // Naming Styles
    public interface UpdateEntitiesInitiation
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        UpdateEntities Update(EntityFieldAssignment assignment, params EntityFieldAssignment[] assignments);
        ...
        ///</param>
        /// <returns><see cref="UpdateEntities"/>, a fluent builder for constructing a sql UPDATE statement.</returns>
        UpdateEntities Update(IEnumerable<EntityFieldAssignment> assignments);
    }
}
