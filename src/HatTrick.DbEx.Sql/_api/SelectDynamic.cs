...
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="WithAlias{SelectDynamicContinuation}"/>, a fluent continuation for providing an alias for the subquery.</returns>
        WithAlias<SelectDynamicContinuation> From(AnySelectSubquery query);
    }
}
