...
#pragma warning restore IDE1006 // Naming Styles
        where TEntity : class, IDbEntity
    {
        ...
        UpdateEntitiesContinuation<TEntity> Where(AnyWhereExpression where);
        ...
        /// <returns><see cref="WithAlias{JoinOn{UpdateEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<UpdateEntitiesContinuation<TEntity>>> InnerJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{UpdateEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<UpdateEntitiesContinuation<TEntity>>> LeftJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{UpdateEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<UpdateEntitiesContinuation<TEntity>>> RightJoin(AnySelectSubquery subquery);
        ...
        /// <param name="subquery">Any expression of type <see cref="AnySelectSubquery"/> specifying a SELECT query expression to join to.</param>
        /// <returns><see cref="WithAlias{JoinOn{UpdateEntitiesContinuation{TEntity}}}"/>, a fluent continuation for the construction of a sql JOIN expression for updating <typeparamref name="TEntity"/> entities.</returns>
        WithAlias<JoinOn<UpdateEntitiesContinuation<TEntity>>> FullJoin(AnySelectSubquery subquery);
