...
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="WithAlias{SelectValueContinuation{TValue}}"/>,  a fluent continuation for providing an alias for the subquery.</returns>
        WithAlias<SelectValueContinuation<TValue>> From(AnySelectSubquery query);
    }
}
