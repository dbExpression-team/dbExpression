...
#pragma warning disable IDE1006 // Naming Styles
    public interface UnionSelectObjectsContinuation<TObject> :
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TObject : class?
    {
        ...
        /// </param>
        /// <returns><see cref="SelectObjects{T}"/>, a fluent builder for constructing a sql SELECT query expression.</returns>
        /// <typeparam name="T">The type of the object to select.</typeparam>
        SelectObjects<TObject> SelectOne(ObjectElement<TObject> element);
        ...
        /// <typeparam name="T">The type of the object to select.</typeparam>
        SelectObjects<TObject> SelectMany(ObjectElement<TObject> element);
    }
}
