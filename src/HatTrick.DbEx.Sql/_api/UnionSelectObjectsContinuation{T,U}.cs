...
#pragma warning disable IDE1006 // Naming Styles
    public interface UnionSelectObjectsContinuation<TDatabase, TObject> :
#pragma warning restore IDE1006 // Naming Styles
        ...
        where TObject : class?
    {
        ...
        SelectObjects<TDatabase, TObject> SelectOne(ObjectElement<TObject> element);
        ...
        /// <typeparam name="T">The type of the object to select.</typeparam>
        SelectObjects<TDatabase, TObject> SelectMany(ObjectElement<TObject> element);
    }
}
