...
#pragma warning disable IDE1006 // Naming Styles   
    public interface UnionSelectEntitiesInitiation<TEntity>
#pragma warning restore IDE1006 // Naming Styles
        where TEntity : class, IDbEntity, new()
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="UnionSelectEntitiesContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectEntitiesContinuation<TEntity> Union();
        ...
        /// </summary>
        /// <returns><see cref="UnionSelectEntitiesContinuation{TEntity}"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectEntitiesContinuation<TEntity> UnionAll();
    }
}
