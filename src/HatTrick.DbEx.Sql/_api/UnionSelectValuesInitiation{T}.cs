...
#pragma warning disable IDE1006 // Naming Styles   
    public interface UnionSelectValuesInitiation<TValue>
#pragma warning restore IDE1006 // Naming Styles
    {
        ...
        /// </para>
        /// </summary>
        /// <returns><see cref="UnionSelectValuesContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectValuesContinuation<TValue> Union();
        ...
        /// </summary>
        /// <returns><see cref="UnionSelectValuesContinuation"/>, a fluent continuation for the construction of a sql SELECT query expression.</returns>
        UnionSelectValuesContinuation<TValue> UnionAll();
    }
}
