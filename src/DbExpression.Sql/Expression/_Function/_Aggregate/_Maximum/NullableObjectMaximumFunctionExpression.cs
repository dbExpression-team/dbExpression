...
namespace DbExpression.Sql.Expression
{
    ...
    {
        #region constructors
        public NullableObjectMaximumFunctionExpression(AnyElement expression) : base(expression)
        {
        ...
        #region equals
        public bool Equals(NullableObjectMaximumFunctionExpression? obj)
            => obj is not null && base.Equals(obj);

        public override bool Equals(object? obj)
            => obj is NullableObjectMaximumFunctionExpression exp && Equals(exp);
