...
namespace DbExpression.Sql.Expression
{
        ...
        IEquatable<PopulationStandardDeviationFunctionExpression>
    {
        ...
        #region constructors
        protected PopulationStandardDeviationFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        public override bool Equals(object? obj)
            => obj is PopulationStandardDeviationFunctionExpression exp && Equals(exp);
