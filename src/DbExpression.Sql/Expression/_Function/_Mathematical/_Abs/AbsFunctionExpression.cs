...
{
    public abstract class AbsFunctionExpression : MathematicalFunctionExpression,
        ...
        IEquatable<AbsFunctionExpression>
    {
        ...
        #region constructors
        protected AbsFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(AbsFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is AbsFunctionExpression exp && Equals(exp);
