...
{
    public abstract class NullableAbsFunctionExpression<TValue, TNullableValue> : AbsFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableAbsFunctionExpression(IExpressionElement expression)
