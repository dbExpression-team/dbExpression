...
{
    public abstract class NullableASinFunctionExpression<TValue, TNullableValue> : ASinFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableASinFunctionExpression(IExpressionElement expression)
