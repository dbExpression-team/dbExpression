...
namespace DbExpression.Sql.Expression
{
    ...
    {
        #region constructors
        protected NullableLogFunctionExpression(IExpressionElement expression)
            : base(expression, typeof(TNullableValue))
        {

        }

        protected NullableLogFunctionExpression(AnyElement expression, AnyElement<int> @base)
            : base(expression, @base, typeof(TNullableValue))
        {
