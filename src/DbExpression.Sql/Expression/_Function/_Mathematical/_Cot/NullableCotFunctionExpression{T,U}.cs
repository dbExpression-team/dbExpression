...
{
    public abstract class NullableCotFunctionExpression<TValue, TNullableValue> : CotFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableCotFunctionExpression(IExpressionElement expression)
