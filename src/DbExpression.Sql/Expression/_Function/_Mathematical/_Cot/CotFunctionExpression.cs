...
{
    public abstract class CotFunctionExpression : MathematicalFunctionExpression,
        IExpressionProvider<IExpressionElement>,
        IEquatable<CotFunctionExpression>
    {
        #region internals
        ...
        #region constructors
        protected CotFunctionExpression(IExpressionElement expression, Type declaredType) : base(declaredType)
        {
        ...
        #region equals
        public bool Equals(CotFunctionExpression? obj)
        {
        ...
        public override bool Equals(object? obj)
            => obj is CotFunctionExpression exp && Equals(exp);
