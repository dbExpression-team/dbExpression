...
{
    public abstract class NullableCosFunctionExpression<TValue, TNullableValue> : CosFunctionExpression,
        IExpressionElement<TValue, TNullableValue>,
        AnyElement<TNullableValue>
        where TValue : IComparable
    {
        #region constructors
        protected NullableCosFunctionExpression(IExpressionElement expression)
