...
{
    public class PipelineEventStageSubscription<TAsyncDelegate, TSyncDelegate, TPredicate>
    {
        ...
        public PipelineEventStageSubscription(TAsyncDelegate asyncDelegate, TSyncDelegate syncDelegate)
        {
        ...
        public PipelineEventStageSubscription(TAsyncDelegate asyncDelegate, TSyncDelegate syncDelegate, Predicate<TPredicate> predicate)
        {
            AsyncDelegate = asyncDelegate ?? throw new ArgumentNullException(nameof(asyncDelegate));
            SyncDelegate = syncDelegate ?? throw new ArgumentNullException(nameof(syncDelegate));
