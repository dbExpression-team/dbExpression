...
{
    public class BeforeInsertCommandPipelineEventContext : BeforeCommandPipelineEventContext, IPipelineEventContext
    {
        #region internals
        ...
        #region constructors
        public BeforeInsertCommandPipelineEventContext(InsertQueryExpression expression, IDbCommand command, SqlStatement statement, IDbEntity entity)
