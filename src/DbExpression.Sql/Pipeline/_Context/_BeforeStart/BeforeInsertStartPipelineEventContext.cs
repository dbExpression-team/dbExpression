...
{
    public class BeforeInsertStartPipelineEventContext : BeforeStartPipelineEventContext, IPipelineEventContext
    {
        #region internals
        ...
        #region constructors
        public BeforeInsertStartPipelineEventContext(InsertQueryExpression expression, ISqlParameterBuilder parameterBuilder, IDbEntity entity)
