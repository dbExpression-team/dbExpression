...
{
    public class BeforeStartPipelineEventContext : PipelineEventContext, IPipelineEventContext
    {
        public ISqlParameterBuilder ParameterBuilder { get; private set; }
        
        public BeforeStartPipelineEventContext(QueryExpression expression, ISqlParameterBuilder parameterBuilder)
            : base(expression)
        {
