...
namespace DbEx.dboDataService
{
    ...
    public sealed partial class AddressEntity : EntityExpression<Address>
    {
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.AddressType"/>?.  The <see cref="DbEx.dboDataService.AddressEntity.AddressTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.AddressType?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.StateType"/>.  The <see cref="DbEx.dboDataService.AddressEntity.StateField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.StateType}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        private List<SelectExpression> GetInclusiveSelectExpressions()
        {
            return _inclusiveSelectExpressions ?? (_inclusiveSelectExpressions = new List<SelectExpression>()
                {
                    new SelectExpression<int>(Id)
                    ,new SelectExpression<MsSql.DocumentationExamples.AddressType?>(AddressType)
                    ,new SelectExpression<string>(Line1)
                    ,new SelectExpression<string?>(Line2)
                    ,new SelectExpression<string>(City)
                    ,new SelectExpression<MsSql.DocumentationExamples.StateType>(State)
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(AddressType) ? new SelectExpression<MsSql.DocumentationExamples.AddressType?>(AddressType, aliased) : GetInclusiveSelectExpressions()[1];
            ...
            set &= aliased != nameof(State) ? new SelectExpression<MsSql.DocumentationExamples.StateType>(State, aliased) : GetInclusiveSelectExpressions()[5];
        ...
        protected override InsertExpressionSet<Address> GetInclusiveInsertExpression(Address entity)
        {
            return new InsertExpressionSet<Address>(entity 
                ,new InsertExpression<MsSql.DocumentationExamples.AddressType?>(entity.AddressType, AddressType)
                ...
                ,new InsertExpression<MsSql.DocumentationExamples.StateType>(entity.State, State)
        ...
        {
            entity.Id = reader.ReadField()!.GetValue<int>();
            entity.AddressType = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.AddressType?>();
            ...
            entity.State = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.StateType>();
        ...
        public sealed partial class AddressTypeField : NullableEnumFieldExpression<Address,MsSql.DocumentationExamples.AddressType>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.AddressType?>(value));
            public AssignmentExpression Set(NullElement value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.AddressType?>(value, this));
            public AssignmentExpression Set(MsSql.DocumentationExamples.AddressType value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.AddressType>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.AddressType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(MsSql.DocumentationExamples.AddressType? value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.AddressType?>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.AddressType?> value) => new AssignmentExpression(this, value);
            #endregion
        }
        ...
        public sealed partial class StateField : EnumFieldExpression<Address,MsSql.DocumentationExamples.StateType>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.StateType>(value));
            public AssignmentExpression Set(MsSql.DocumentationExamples.StateType value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.StateType>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.StateType> value) => new AssignmentExpression(this, value);
            #endregion
        }
        #endregion
    ...
    public sealed partial class PersonEntity : EntityExpression<Person>
    {
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.GenderType"/>.  The <see cref="DbEx.dboDataService.PersonEntity.GenderTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.GenderType}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
            ...
            return _inclusiveSelectExpressions ?? (_inclusiveSelectExpressions = new List<SelectExpression>()
                {
                    ...
                    ,new SelectExpression<MsSql.DocumentationExamples.GenderType>(GenderType)
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(GenderType) ? new SelectExpression<MsSql.DocumentationExamples.GenderType>(GenderType, aliased) : GetInclusiveSelectExpressions()[4];
        ...
        protected override InsertExpressionSet<Person> GetInclusiveInsertExpression(Person entity)
        {
            return new InsertExpressionSet<Person>(entity 
                ...
                ,new InsertExpression<MsSql.DocumentationExamples.GenderType>(entity.GenderType, GenderType)
        ...
        protected override void HydrateEntity(ISqlFieldReader reader, Person entity)
        {
            ...
            entity.GenderType = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.GenderType>();
        ...
        public sealed partial class GenderTypeField : EnumFieldExpression<Person,MsSql.DocumentationExamples.GenderType>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.GenderType>(value));
            public AssignmentExpression Set(MsSql.DocumentationExamples.GenderType value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.GenderType>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.GenderType> value) => new AssignmentExpression(this, value);
            #endregion
        }
        #endregion
    ...
    public sealed partial class ProductEntity : EntityExpression<Product>
    {
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.ProductCategoryType"/>?.  The <see cref="DbEx.dboDataService.ProductEntity.ProductCategoryTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.ProductCategoryType?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.ProductDescription"/>?.  The <see cref="DbEx.dboDataService.ProductEntity.DescriptionField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.ProductDescription?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// with a .NET type of <see cref="double"/>.  The <see cref="DbEx.dboDataService.ProductEntity.QuantityField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{double}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        private List<SelectExpression> GetInclusiveSelectExpressions()
        {
            return _inclusiveSelectExpressions ?? (_inclusiveSelectExpressions = new List<SelectExpression>()
                {
                    new SelectExpression<int>(Id)
                    ,new SelectExpression<MsSql.DocumentationExamples.ProductCategoryType?>(ProductCategoryType)
                    ,new SelectExpression<string>(Name)
                    ,new SelectExpression<MsSql.DocumentationExamples.ProductDescription?>(Description)
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(ProductCategoryType) ? new SelectExpression<MsSql.DocumentationExamples.ProductCategoryType?>(ProductCategoryType, aliased) : GetInclusiveSelectExpressions()[1];
            ...
            set &= aliased != nameof(Description) ? new SelectExpression<MsSql.DocumentationExamples.ProductDescription?>(Description, aliased) : GetInclusiveSelectExpressions()[3];
        ...
        protected override InsertExpressionSet<Product> GetInclusiveInsertExpression(Product entity)
        {
            return new InsertExpressionSet<Product>(entity 
                ,new InsertExpression<MsSql.DocumentationExamples.ProductCategoryType?>(entity.ProductCategoryType, ProductCategoryType)
                ,new InsertExpression<string>(entity.Name, Name)
                ,new InsertExpression<MsSql.DocumentationExamples.ProductDescription?>(entity.Description, Description)
        ...
        {
            entity.Id = reader.ReadField()!.GetValue<int>();
            entity.ProductCategoryType = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.ProductCategoryType?>();
            entity.Name = reader.ReadField()!.GetValue<string>();
            entity.Description = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.ProductDescription?>();
        ...
        public sealed partial class ProductCategoryTypeField : NullableEnumFieldExpression<Product,MsSql.DocumentationExamples.ProductCategoryType>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.ProductCategoryType?>(value));
            public AssignmentExpression Set(NullElement value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.ProductCategoryType?>(value, this));
            public AssignmentExpression Set(MsSql.DocumentationExamples.ProductCategoryType value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.ProductCategoryType>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.ProductCategoryType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(MsSql.DocumentationExamples.ProductCategoryType? value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.ProductCategoryType?>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.ProductCategoryType?> value) => new AssignmentExpression(this, value);
            #endregion
        }
        ...
        public sealed partial class DescriptionField : ObjectFieldExpression<Product,MsSql.DocumentationExamples.ProductDescription?>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.ProductDescription?>(value));
            public AssignmentExpression Set(NullElement value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.ProductDescription?>(value, this));
            public AssignmentExpression Set(MsSql.DocumentationExamples.ProductDescription? value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.ProductDescription?>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.ProductDescription?> value) => new AssignmentExpression(this, value);
            #endregion
        }
        #endregion
    ...
    public sealed partial class PurchaseEntity : EntityExpression<Purchase>
    {
        ...
        /// with a .NET type of <see cref="int"/>.  The <see cref="DbEx.dboDataService.PurchaseEntity.TotalPurchaseQuantityField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{int}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.PaymentMethodType"/>.  The <see cref="DbEx.dboDataService.PurchaseEntity.PaymentMethodTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.PaymentMethodType}"/>.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
        ...
        /// with a .NET type of <see cref="MsSql.DocumentationExamples.PaymentSourceType"/>?.  The <see cref="DbEx.dboDataService.PurchaseEntity.PaymentSourceTypeField"/> can be 
        /// used with any operation accepting a <see cref="HatTrick.DbEx.Sql.AnyElement{MsSql.DocumentationExamples.PaymentSourceType?}"/>?.
        /// <para>Database Properties:
        /// <list type="table">
        /// <item>
            ...
            return _inclusiveSelectExpressions ?? (_inclusiveSelectExpressions = new List<SelectExpression>()
                {
                    ...
                    ,new SelectExpression<MsSql.DocumentationExamples.PaymentMethodType>(PaymentMethodType)
                    ,new SelectExpression<MsSql.DocumentationExamples.PaymentSourceType?>(PaymentSourceType)
                    ,new SelectExpression<DateTime>(DateCreated)
                    ,new SelectExpression<DateTime>(DateUpdated)
                }
            );
        ...
        protected override SelectExpressionSet GetInclusiveSelectExpression(Func<string, string> alias)
        {
            ...
            set &= aliased != nameof(PaymentMethodType) ? new SelectExpression<MsSql.DocumentationExamples.PaymentMethodType>(PaymentMethodType, aliased) : GetInclusiveSelectExpressions()[9];
            aliased = alias(nameof(PaymentSourceType));
            set &= aliased != nameof(PaymentSourceType) ? new SelectExpression<MsSql.DocumentationExamples.PaymentSourceType?>(PaymentSourceType, aliased) : GetInclusiveSelectExpressions()[10];
            aliased = alias(nameof(DateCreated));
        ...
        protected override InsertExpressionSet<Purchase> GetInclusiveInsertExpression(Purchase entity)
        {
            return new InsertExpressionSet<Purchase>(entity 
                ...
                ,new InsertExpression<MsSql.DocumentationExamples.PaymentMethodType>(entity.PaymentMethodType, PaymentMethodType)
                ,new InsertExpression<MsSql.DocumentationExamples.PaymentSourceType?>(entity.PaymentSourceType, PaymentSourceType)
            );
        }
        ...
        protected override void HydrateEntity(ISqlFieldReader reader, Purchase entity)
        {
            ...
            entity.PaymentMethodType = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.PaymentMethodType>();
            entity.PaymentSourceType = reader.ReadField()!.GetValue<MsSql.DocumentationExamples.PaymentSourceType?>();
            entity.DateCreated = reader.ReadField()!.GetValue<DateTime>();
            entity.DateUpdated = reader.ReadField()!.GetValue<DateTime>();
        }
		#endregion
        ...
        public sealed partial class PaymentMethodTypeField : EnumFieldExpression<Purchase,MsSql.DocumentationExamples.PaymentMethodType>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.PaymentMethodType>(value));
            public AssignmentExpression Set(MsSql.DocumentationExamples.PaymentMethodType value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.PaymentMethodType>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.PaymentMethodType> value) => new AssignmentExpression(this, value);
            #endregion
        }
        #endregion

        #region payment source type field expression
        public sealed partial class PaymentSourceTypeField : NullableEnumFieldExpression<Purchase,MsSql.DocumentationExamples.PaymentSourceType>
        {
            #region constructors
            ...
            #region set
            public AssignmentExpression Set((string TableName, string FieldName) value) => new AssignmentExpression(this, new AliasExpression<MsSql.DocumentationExamples.PaymentSourceType?>(value));
            public AssignmentExpression Set(NullElement value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.PaymentSourceType?>(value, this));
            public AssignmentExpression Set(MsSql.DocumentationExamples.PaymentSourceType value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.PaymentSourceType>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.PaymentSourceType> value) => new AssignmentExpression(this, value);
            public AssignmentExpression Set(MsSql.DocumentationExamples.PaymentSourceType? value) => new AssignmentExpression(this, new LiteralExpression<MsSql.DocumentationExamples.PaymentSourceType?>(value, this));
            public AssignmentExpression Set(AnyElement<MsSql.DocumentationExamples.PaymentSourceType?> value) => new AssignmentExpression(this, value);
            #endregion
        }
